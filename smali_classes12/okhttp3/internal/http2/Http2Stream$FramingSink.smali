...
.method private final emitFrame(Z)V
    ...
    iget-object v5, v1, Lokhttp3/internal/http2/Http2Stream$FramingSink;->this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 545
    .local v7, "$i$a$-synchronized-Http2Stream$FramingSink$emitFrame$1":I
    :try_start_0
    ...
    invoke-virtual {v6, v2, v3}, Lokhttp3/internal/http2/Http2Stream;->setWriteBytesTotal$okhttp(J)V
    ...
    .local v12, "outFinished":Z
    nop

    .end local v7    # "$i$a$-synchronized-Http2Stream$FramingSink$emitFrame$1":I
    :try_start_4
    ...
    iget-object v13, v1, Lokhttp3/internal/http2/Http2Stream$FramingSink;->sendBuffer:Lokio/Buffer;

    invoke-virtual/range {v10 .. v15}, Lokhttp3/internal/http2/Http2Connection;->writeData(IZLokio/Buffer;J)V
    :try_end_5
    ...
    iget-object v2, v1, Lokhttp3/internal/http2/Http2Stream$FramingSink;->this$0:Lokhttp3/internal/http2/Http2Stream;
    ...
    .line 554
    .end local v14    # "toWrite":J
    .restart local v2    # "toWrite":J
    .restart local v7    # "$i$a$-synchronized-Http2Stream$FramingSink$emitFrame$1":I
    :catchall_3
    move-exception v0
...
.method public close()V
    ...
    .line 622
    .local v0, "$i$a$-synchronized-Http2Stream$FramingSink$close$2":I
    :try_start_2
    ...
    .end local v0    # "$i$a$-synchronized-Http2Stream$FramingSink$close$2":I
    sget-object v0, Lkotlin/Unit;->INSTANCE:Lkotlin/Unit;
    :try_end_2
