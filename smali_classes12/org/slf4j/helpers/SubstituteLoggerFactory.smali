...
.method public declared-synchronized getLogger(Ljava/lang/String;)Lorg/slf4j/Logger;
    ...
    .line 54
    new-instance v1, Lorg/slf4j/helpers/SubstituteLogger;

    iget-object v2, p0, Lorg/slf4j/helpers/SubstituteLoggerFactory;->eventQueue:Ljava/util/concurrent/LinkedBlockingQueue;

    iget-boolean v3, p0, Lorg/slf4j/helpers/SubstituteLoggerFactory;->postInitialization:Z

    invoke-direct {v1, p1, v2, v3}, Lorg/slf4j/helpers/SubstituteLogger;-><init>(Ljava/lang/String;Ljava/util/Queue;Z)V
    ...
    .line 57
    .end local p0    # "this":Lorg/slf4j/helpers/SubstituteLoggerFactory;
    :cond_0
    monitor-exit p0
