...
public final class HttpUrl {
    ...
    public final URL m8982deprecated_url() {
        return url();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to toUri()", replaceWith = @ReplaceWith(expression = "toUri()", imports = {}))
    /* renamed from: -deprecated_uri  reason: not valid java name */
    public final URI m8981deprecated_uri() {
        return uri();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "scheme", imports = {}))
    /* renamed from: -deprecated_scheme  reason: not valid java name */
    public final String m8980deprecated_scheme() {
        return this.scheme;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedUsername", imports = {}))
    /* renamed from: -deprecated_encodedUsername  reason: not valid java name */
    public final String m8970deprecated_encodedUsername() {
    ...
    public final String m8983deprecated_username() {
        return this.username;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPassword", imports = {}))
    /* renamed from: -deprecated_encodedPassword  reason: not valid java name */
    public final String m8966deprecated_encodedPassword() {
    ...
    public final String m8973deprecated_password() {
        return this.password;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "host", imports = {}))
    /* renamed from: -deprecated_host  reason: not valid java name */
    public final String m8972deprecated_host() {
        return this.host;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "port", imports = {}))
    /* renamed from: -deprecated_port  reason: not valid java name */
    public final int m8976deprecated_port() {
        return this.port;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "pathSize", imports = {}))
    /* renamed from: -deprecated_pathSize  reason: not valid java name */
    public final int m8975deprecated_pathSize() {
        return pathSize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPath", imports = {}))
    /* renamed from: -deprecated_encodedPath  reason: not valid java name */
    public final String m8967deprecated_encodedPath() {
        return encodedPath();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedPathSegments", imports = {}))
    /* renamed from: -deprecated_encodedPathSegments  reason: not valid java name */
    public final List<String> m8968deprecated_encodedPathSegments() {
        return encodedPathSegments();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "pathSegments", imports = {}))
    /* renamed from: -deprecated_pathSegments  reason: not valid java name */
    public final List<String> m8974deprecated_pathSegments() {
        return this.pathSegments;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedQuery", imports = {}))
    /* renamed from: -deprecated_encodedQuery  reason: not valid java name */
    public final String m8969deprecated_encodedQuery() {
        return encodedQuery();
    }
    ...
    public final String m8977deprecated_query() {
        return query();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "querySize", imports = {}))
    /* renamed from: -deprecated_querySize  reason: not valid java name */
    public final int m8979deprecated_querySize() {
        return querySize();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "queryParameterNames", imports = {}))
    /* renamed from: -deprecated_queryParameterNames  reason: not valid java name */
    public final Set<String> m8978deprecated_queryParameterNames() {
        return queryParameterNames();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "encodedFragment", imports = {}))
    /* renamed from: -deprecated_encodedFragment  reason: not valid java name */
    public final String m8965deprecated_encodedFragment() {
        return encodedFragment();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "fragment", imports = {}))
    /* renamed from: -deprecated_fragment  reason: not valid java name */
    public final String m8971deprecated_fragment() {
        return this.fragment;
    }
    ...
    public static final class Builder {
        ...
        public final Builder query(String query) {
            ...
            if (query != null && (query2 = Companion.canonicalize$okhttp$default(HttpUrl.Companion, query, 0, 0, HttpUrl.QUERY_ENCODE_SET, false, false, true, false, null, 219, null)) != null) {
                list = HttpUrl.Companion.toQueryNamesAndValues$okhttp(query2);
        ...
        public final Builder encodedQuery(String encodedQuery) {
            ...
            if (encodedQuery != null && (encodedQuery2 = Companion.canonicalize$okhttp$default(HttpUrl.Companion, encodedQuery, 0, 0, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, 211, null)) != null) {
                list = HttpUrl.Companion.toQueryNamesAndValues$okhttp(encodedQuery2);
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            for (int i = 0; i < size; i++) {
                $this$reencodeForUri_u24lambda_u2428.encodedPathSegments.set(i, Companion.canonicalize$okhttp$default(HttpUrl.Companion, $this$reencodeForUri_u24lambda_u2428.encodedPathSegments.get(i), 0, 0, "[]", true, true, false, false, null, 227, null));
            }
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            int schemeDelimiterOffset2 = Companion.schemeDelimiterOffset(input2, pos3, limit4);
            ...
            if (schemeDelimiterOffset2 != -1) {
                if (StringsKt.startsWith(input2, "https:", pos3, true)) {
                    this.scheme = "https";
                    pos3 += 6;
                } else if (StringsKt.startsWith(input2, "http:", pos3, true)) {
                    this.scheme = "http";
                    pos3 += 5;
                } else {
                    StringBuilder append = new StringBuilder().append("Expected URL scheme 'http' or 'https' but was '");
                    String substring = input2.substring(0, schemeDelimiterOffset2);
                    Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
            ...
            int slashCount2 = Companion.slashCount(input2, pos3, limit4);
            char c = '#';
            if (slashCount2 >= 2 || base == null || !Intrinsics.areEqual(base.scheme(), this.scheme)) {
                ...
                while (true) {
                    ...
                    if (componentDelimiterOffset3 != limit4) {
                        i = input2.charAt(componentDelimiterOffset3);
                    } else {
                        i = i2;
                    }
                    int c2 = i;
                    switch (c2) {
                        ...
                        case Property.OPACITY /* 92 */:
                            ...
                            limit = limit4;
                            int limit5 = i2;
                            int portColonOffset = Companion.portColonOffset(input2, pos4, componentDelimiterOffset3);
                            if (portColonOffset + 1 < componentDelimiterOffset3) {
                                this.host = HostnamesKt.toCanonicalHost(Companion.percentDecode$okhttp$default(HttpUrl.Companion, input2, pos4, portColonOffset, false, 4, null));
                                this.port = Companion.parsePort(input2, portColonOffset + 1, componentDelimiterOffset3);
                                if (!(this.port != limit5 ? z3 : false)) {
                                    StringBuilder append2 = new StringBuilder().append("Invalid URL port: \"");
                                    String substring2 = input2.substring(portColonOffset + 1, componentDelimiterOffset3);
                            ...
                            if (!(this.host != null ? z3 : false)) {
                                ...
                                String substring3 = input2.substring(pos4, portColonOffset);
                        ...
                        case 64:
                            if (!hasPassword) {
                                ...
                                String canonicalUsername = Companion.canonicalize$okhttp$default(HttpUrl.Companion, input2, pos4, passwordColonOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                                if (hasUsername) {
                                ...
                                this.encodedPassword += "%40" + Companion.canonicalize$okhttp$default(HttpUrl.Companion, input2, pos4, componentDelimiterOffset3, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, 240, null);
                            }
            ...
            if (pathDelimiterOffset < limit6 && input2.charAt(pathDelimiterOffset) == '?') {
                ...
                pos = 35;
                this.encodedQueryNamesAndValues = HttpUrl.Companion.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.Companion, input2, pathDelimiterOffset + 1, queryDelimiterOffset, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, 208, null));
            ...
            if (pos2 < limit6 && input2.charAt(pos2) == pos) {
                this.encodedFragment = Companion.canonicalize$okhttp$default(HttpUrl.Companion, input2, pos2 + 1, limit6, "", true, false, false, true, null, 176, null);
            }
            return this;
        }
        ...
        public static final class Companion {
            ...
            public final int schemeDelimiterOffset(String input, int pos, int limit) {
                ...
                if ((Intrinsics.compare((int) c0, 97) < 0 || Intrinsics.compare((int) c0, (int) Property.WIDOWS_CONTROL) > 0) && (Intrinsics.compare((int) c0, 65) < 0 || Intrinsics.compare((int) c0, 90) > 0)) {
                    return -1;
                }
    ...
    public static final class Companion {
        ...
        public final HttpUrl m8984deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m8987deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m8986deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* renamed from: -deprecated_get  reason: not valid java name */
        public final HttpUrl m8985deprecated_get(URI uri) {
