    ...
    */
    ...
    public final boolean addAcquireToQueue(Waiter waiter) {
        ...
        while (true) {
            ...
            Segment to$iv$iv = SegmentOrClosed.m8907getSegmentimpl(s$iv);
            while (true) {
        ...
        SemaphoreSegment segment = (SemaphoreSegment) SegmentOrClosed.m8907getSegmentimpl(s$iv);
        i2 = SemaphoreKt.SEGMENT_SIZE;
        int i3 = (int) (enqIdx % i2);
        if (!AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i3, null, waiter)) {
            expected$iv = SemaphoreKt.PERMIT;
            value$iv = SemaphoreKt.TAKEN;
            if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i3, expected$iv, value$iv)) {
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        if (value$iv2 == null) {
            ...
            return !AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(segment.getAcquirers(), i4, expected$iv, value$iv);
        }
        symbol2 = SemaphoreKt.CANCELLED;
        return value$iv2 == symbol2 ? z : tryResumeAcquire(value$iv2);
    }
