    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m7341constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    */
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.Companion;
                resume.resumeWith(Result.m7341constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
    ...
    public final Continuation<Unit>[] findSlotsToResumeLocked(Continuation<Unit>[] continuationArr) {
        ...
        int resumeCount3 = continuationArr.length;
            ...
            while (i < length) {
                ...
                if (element$iv$iv != null) {
                    ...
                    if (cont == null) {
                        ...
                        if (resumeCount3 >= continuationArr2.length) {
                            resumeCount2 = resumeCount3;
                            int resumeCount4 = continuationArr2.length * 2;
                            ?? copyOf = Arrays.copyOf(continuationArr2, Math.max(2, resumeCount4));
                        ...
                        continuationArr2[resumeCount2] = cont;
                        slot.cont = null;
                    }
