...
public final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (state == symbol2) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, state, symbol3)) {
                    return;
                }
            } else {
                symbol4 = StateFlowKt.NONE;
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, state, symbol4)) {
                    Result.Companion companion = Result.Companion;
                    ((CancellableContinuationImpl) state).resumeWith(Result.m7341constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        symbol = StateFlowKt.NONE;
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, symbol, cont)) {
