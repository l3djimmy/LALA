...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m8872catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m8885catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m8873debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m8877debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m8874sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m8878sampleHG0u8IE(flow, period);
    }
    ...
    public static final <T> Flow<T> m8875timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m8879timeoutHG0u8IE(flow, timeout);
    }
