...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m8881invokeWpGqRn0(channelResult.m8864unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m8881invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m8852boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                ?? m8864unboximpl = ((ChannelResult) this.L$0).m8864unboximpl();
                Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
                if (!(m8864unboximpl instanceof ChannelResult.Failed)) {
                    objectRef2.element = m8864unboximpl;
                }
                objectRef = this.$lastValue;
                FlowCollector<T> flowCollector = this.$downstream;
                if (m8864unboximpl instanceof ChannelResult.Failed) {
                    Throwable it = ChannelResult.m8856exceptionOrNullimpl(m8864unboximpl);
                    if (it != null) {
                        throw it;
                    }
