...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m8877debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m8828toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 $timeout, Object emittedItem) {
        return DelayKt.m8828toDelayMillisLRDsOJo(((Duration) $timeout.invoke(emittedItem)).m8733unboximpl());
    }
    ...
    public static final <T> Flow<T> m8878sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m8828toDelayMillisLRDsOJo(period));
    }

    /* renamed from: timeout-HG0u8IE  reason: not valid java name */
    public static final <T> Flow<T> m8879timeoutHG0u8IE(Flow<? extends T> flow, long timeout) {
        return m8880timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, timeout);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt  reason: not valid java name */
    private static final <T> Flow<T> m8880timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long timeout) {
