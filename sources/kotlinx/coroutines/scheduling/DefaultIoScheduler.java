...
public final class DefaultIoScheduler extends ExecutorCoroutineDispatcher implements Executor {
    ...
    private static final CoroutineDispatcher f99default;
    ...
    static {
        ...
        f99default = CoroutineDispatcher.limitedParallelism$default(UnlimitedIoScheduler.INSTANCE, systemProp$default, null, 2, null);
    }
    ...
    public void execute(Runnable command) {
        mo8901dispatch(EmptyCoroutineContext.INSTANCE, command);
    }
    ...
    public void mo8901dispatch(CoroutineContext context, Runnable block) {
        f99default.mo8901dispatch(context, block);
    }

    @Override // kotlinx.coroutines.CoroutineDispatcher
    public void dispatchYield(CoroutineContext context, Runnable block) {
        f99default.dispatchYield(context, block);
    }
