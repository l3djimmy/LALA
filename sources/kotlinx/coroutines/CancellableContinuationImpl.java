...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public final <R> void callOnCancellation(Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3, Throwable cause, R r) {
        try {
            function3.invoke(cause, r, getContext());
        } catch (Throwable ex) {
    ...
    public void resume(T t, final Function1<? super Throwable, Unit> function1) {
        resumeImpl$kotlinx_coroutines_core(t, this.resumeMode, function1 != null ? new Function3() { // from class: kotlinx.coroutines.CancellableContinuationImpl$$ExternalSyntheticLambda1
    ...
    public final <R> void resumeImpl$kotlinx_coroutines_core(R r, int resumeMode, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3) {
        ...
        while (true) {
            ...
            if (state instanceof NotCompleted) {
                ...
                Object update = resumedState((NotCompleted) state, r2, resumeMode2, function32, null);
                if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, state, update)) {
                    r = r2;
                ...
                R r3 = r;
                Function3 onCancellation = function3;
                if ((state instanceof CancelledContinuation) && ((CancelledContinuation) state).makeResumed()) {
                    if (onCancellation != null) {
                        callOnCancellation(onCancellation, ((CancelledContinuation) state).cause, r3);
                        return;
                    }
                    return;
                }
    ...
    private final <R> Symbol tryResumeImpl(R r, Object idempotent, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3) {
        ...
        while (true) {
            ...
            if (state instanceof NotCompleted) {
                ...
                Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function32 = function3;
                Object update = resumedState((NotCompleted) state, r2, this.resumeMode, function32, idempotent2);
                if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, state, update)) {
                    r = r2;
                    function3 = function32;
