...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m8871trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m8856exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m8871trySendImplMj0NB7M(e, true);
    ...
    public Object mo8838trySendJP2dKIU(E e) {
        return m8871trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m8871trySendImplMj0NB7M(E e, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8870trySendDropLatestMj0NB7M(e, isSendOp) : m8846trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m8870trySendDropLatestMj0NB7M(E e, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo8838trySendJP2dKIU(e);
        if (ChannelResult.m8862isSuccessimpl(result) || ChannelResult.m8860isClosedimpl(result)) {
            return result;
        }
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object element) {
        Object it = mo8838trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m8856exceptionOrNullimpl(it);
