...
public final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        try {
            ...
            r = Result.m7341constructorimpl(Unit.INSTANCE);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            r = Result.m7341constructorimpl(ResultKt.createFailure(th));
        }
        return ChannelResult.m8852boximpl(Result.m7348isSuccessimpl(r) ? ChannelResult.Companion.m8867successJP2dKIU(Unit.INSTANCE) : ChannelResult.Companion.m8865closedJP2dKIU(Result.m7344exceptionOrNullimpl(r)));
    }
}
