...
public interface ReceiveChannel<E> {
    ...
    Object mo8844receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo8845tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.mo8845tryReceivePtdJZtk();
            if (ChannelResult.m8862isSuccessimpl(result)) {
                return (E) ChannelResult.m8858getOrThrowimpl(result);
            }
            Throwable m8856exceptionOrNullimpl = ChannelResult.m8856exceptionOrNullimpl(result);
            if (m8856exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m8856exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L2c:
                ...
                java.lang.Object r4 = r4.m8864unboximpl()
                goto L44
            L37:
                kotlin.ResultKt.throwOnFailure(r1)
                r3 = 1
                r0.label = r3
                java.lang.Object r4 = r4.mo8844receiveCatchingJP2dKIU(r0)
                if (r4 != r2) goto L44
                return r2
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m8857getOrNullimpl(r4)
                return r4
            */
