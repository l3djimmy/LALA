...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m7341constructorimpl = Result.m7341constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 $block, Throwable e) {
        ...
        try {
            ...
            m7341constructorimpl = Result.m7341constructorimpl(result);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m7341constructorimpl = Result.m7341constructorimpl(ResultKt.createFailure(th));
        }
        return Result.m7347isFailureimpl(m7341constructorimpl) ? null : m7341constructorimpl;
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        Integer m7341constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m7341constructorimpl = Result.m7341constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m7341constructorimpl = Result.m7341constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m7347isFailureimpl(m7341constructorimpl)) {
            m7341constructorimpl = valueOf;
        }
        return ((Number) m7341constructorimpl).intValue();
    }
