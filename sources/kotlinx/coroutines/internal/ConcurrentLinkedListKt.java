...
public final class ConcurrentLinkedListKt {
    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(S s, long id, Function2<? super Long, ? super S, ? extends S> function2) {
        ...
        while (true) {
            if (cur.id < id || cur.isRemoved()) {
                ...
                if (it$iv == CLOSED) {
                    return SegmentOrClosed.m8904constructorimpl(CLOSED);
                }
                ...
                return SegmentOrClosed.m8904constructorimpl(cur);
            }
        }
    }
    ...
    public static final /* synthetic */ <S extends Segment<S>> boolean moveForward$atomicfu$BOXED_ATOMIC$Any(AtomicReference handler$atomicfu, S s) {
        while (true) {
            ...
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(handler$atomicfu, cur, s)) {
                if (cur.decPointers$kotlinx_coroutines_core()) {
                    cur.remove();
                }
                return true;
    ...
    public static final /* synthetic */ <S extends Segment<S>> Object findSegmentAndMoveForward$atomicfu$ATOMIC_ARRAY$Any(AtomicReferenceArray handler$atomicfu, int index$atomicfu, long id, S s, Function2<? super Long, ? super S, ? extends S> function2) {
        ...
        do {
            ...
            if (SegmentOrClosed.m8909isClosedimpl(s2)) {
                break;
            }
            Segment to$iv = SegmentOrClosed.m8907getSegmentimpl(s2);
            while (true) {
                ...
                if (cur$iv.id < to$iv.id) {
                    if (!to$iv.tryIncPointers$kotlinx_coroutines_core()) {
                        ...
                        continue;
                        break;
                    } else if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(handler$atomicfu, index$atomicfu, cur$iv, to$iv)) {
            ...
            while (true) {
                ...
                if (cur$iv.id < to$iv.id) {
                    if (!to$iv.tryIncPointers$kotlinx_coroutines_core()) {
                        ...
                        continue;
                        break;
                    } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(handler$atomicfu, obj$atomicfu, cur$iv, to$iv)) {
                        if (cur$iv.decPointers$kotlinx_coroutines_core()) {
                            cur$iv.remove();
                            continue;
                        } else {
            ...
            while (true) {
                ...
                if (cur$iv.id < to$iv.id) {
                    if (!to$iv.tryIncPointers$kotlinx_coroutines_core()) {
                        ...
                        continue;
                        break;
                    } else if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(handler$atomicfu, cur$iv, to$iv)) {
                        if (cur$iv.decPointers$kotlinx_coroutines_core()) {
                            cur$iv.remove();
                            continue;
                        } else {
