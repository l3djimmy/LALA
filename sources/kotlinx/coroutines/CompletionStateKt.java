...
public final class CompletionStateKt {
    public static final <T> Object toState(Object $this$toState) {
        Throwable it = Result.m7344exceptionOrNullimpl($this$toState);
    ...
    public static final <T> Object recoverResult(Object state, Continuation<? super T> continuation) {
        if (state instanceof CompletedExceptionally) {
            ...
            return Result.m7341constructorimpl(ResultKt.createFailure(exception$iv));
        }
        Result.Companion companion2 = Result.Companion;
        return Result.m7341constructorimpl(state);
    }
}
