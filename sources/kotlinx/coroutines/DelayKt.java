    ...
    */
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> continuation) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cont.getContext()).mo8902scheduleResumeAfterDelay(timeMillis, cont);
        }
    ...
    public static final Object m8827delayVtjQ1oo(long duration, Continuation<? super Unit> continuation) {
        Object delay = delay(m8828toDelayMillisLRDsOJo(duration), continuation);
    ...
    public static final long m8828toDelayMillisLRDsOJo(long $this$toDelayMillis_u2dLRDsOJo) {
        boolean m8714isPositiveimpl = Duration.m8714isPositiveimpl($this$toDelayMillis_u2dLRDsOJo);
        if (m8714isPositiveimpl) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m8698getInWholeMillisecondsimpl(Duration.m8716plusLRDsOJo($this$toDelayMillis_u2dLRDsOJo, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        } else if (m8714isPositiveimpl) {
