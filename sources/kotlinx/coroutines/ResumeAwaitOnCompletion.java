...
public final class ResumeAwaitOnCompletion<T> extends JobNode {
    ...
    public void invoke(Throwable cause) {
        ...
        if (z) {
            ...
            cancellableContinuationImpl.resumeWith(Result.m7341constructorimpl(ResultKt.createFailure(((CompletedExceptionally) state).cause)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        cancellableContinuationImpl.resumeWith(Result.m7341constructorimpl(JobSupportKt.unboxState(state)));
    }
}
