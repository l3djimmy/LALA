...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V put(K k, V v) {
        Object obj;
        Object key = Core.putImpl$default((Core) core$volatile$FU.get(this), k, v, null, 4, null);
        Object oldValue = (V) key;
    ...
    private final synchronized V putSynchronized(K k, V v) {
        ...
        while (true) {
            K k2 = k;
            V v3 = v;
            Object key = Core.putImpl$default(curCore, k2, v3, null, 4, null);
            v2 = (V) key;
    ...
    public final class Core {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:34:0x0086, code lost:
            if (kotlin.concurrent.atomics.AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(getValues(), r0, r1, r13) == false) goto L19;
         */
        ...
        */
        public final java.lang.Object putImpl(K r12, V r13, kotlinx.coroutines.debug.internal.HashedWeakRef<K> r14) {
            ...
            L48:
                ...
                boolean r4 = kotlin.concurrent.atomics.AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(r5, r0, r4, r2)
                if (r4 != 0) goto L53
                goto La
            L53:
                r5 = r1
            ...
            L7e:
                java.util.concurrent.atomic.AtomicReferenceArray r2 = r11.getValues()
                boolean r2 = kotlin.concurrent.atomics.AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(r2, r0, r1, r13)
                if (r2 == 0) goto L6c
                return r1
            L89:
                if (r4 != 0) goto L8e
            ...
            while (true) {
                ...
                for (int index = 0; index < i; index++) {
                    ...
                    while (true) {
                        ...
                        if (AtomicArraysKt__AtomicArrays_jvmKt$$ExternalSyntheticBackportWithForwarding0.m(values, index, value, mark)) {
                            break;
                        }
                    }
