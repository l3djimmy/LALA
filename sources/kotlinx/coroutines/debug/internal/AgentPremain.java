...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m7341constructorimpl = Result.m7341constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m7341constructorimpl = Result.m7341constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m7347isFailureimpl(m7341constructorimpl) ? null : m7341constructorimpl;
