...
public final class UndispatchedKt {
    public static final <R, T> void startCoroutineUndispatched(Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, Continuation<? super T> continuation) {
        ...
        try {
            ...
            if (value != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                ...
                actualCompletion.resumeWith(Result.m7341constructorimpl(value));
            }
        } catch (Throwable e) {
            Throwable reportException = e instanceof DispatchException ? ((DispatchException) e).getCause() : e;
            Result.Companion companion2 = Result.Companion;
            actualCompletion.resumeWith(Result.m7341constructorimpl(ResultKt.createFailure(reportException)));
        }
    }
    ...
    public static final <T, R> Object startUndispatchedOrReturn(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        if (completedExceptionally != IntrinsicsKt.getCOROUTINE_SUSPENDED() && (state$iv = scopeCoroutine.makeCompletingOnce$kotlinx_coroutines_core(completedExceptionally)) != JobSupportKt.COMPLETING_WAITING_CHILDREN) {
        ...
        if (completedExceptionally != IntrinsicsKt.getCOROUTINE_SUSPENDED() && (state$iv = scopeCoroutine.makeCompletingOnce$kotlinx_coroutines_core(completedExceptionally)) != JobSupportKt.COMPLETING_WAITING_CHILDREN) {
            ...
            if (state$iv instanceof CompletedExceptionally) {
                ...
                if (((e instanceof TimeoutCancellationException) && ((TimeoutCancellationException) e).coroutine == scopeCoroutine) ? true : true) {
                    ...
                    Throwable exception$iv$iv2 = completedExceptionally.cause;
                    ...
                    state$iv2 = completedExceptionally;
                }
            } else {
