    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            ...
            if (Intrinsics.areEqual(name, ".")) {
                ...
                Comparable comparable = (Comparable) ((list2.isEmpty() || Intrinsics.areEqual(((File) CollectionsKt.last((List<? extends Object>) list2)).getName(), "..")) ? Boolean.valueOf(list2.add(file)) : list2.remove(list2.size() - 1));
            } else {
