...
public final class UStringsKt {
    ...
    public static final String m8674toStringLxnNnR4(byte b, int radix) {
    ...
    public static final String m8676toStringolVBNx4(short s, int radix) {
    ...
    public static final String m8675toStringV7xB4Y4(int i, int radix) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(radix));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m8673toStringJSWoG40(long j, int radix) {
    ...
    public static final byte toUByte(String $this$toUByte) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m7409unboximpl();
        }
    ...
    public static final short toUShort(String $this$toUShort) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m7672unboximpl();
        }
    ...
    public static final int toUInt(String $this$toUInt) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m7488unboximpl();
        }
    ...
    public static final long toULong(String $this$toULong) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m7567unboximpl();
        }
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m7488unboximpl = uIntOrNull.m7488unboximpl();
            if (Integer.compareUnsigned(m7488unboximpl, UInt.m7436constructorimpl(255)) > 0) {
                return null;
            }
            return UByte.m7353boximpl(UByte.m7359constructorimpl((byte) m7488unboximpl));
        }
        return null;
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        if (uIntOrNull != null) {
            int m7488unboximpl = uIntOrNull.m7488unboximpl();
            if (Integer.compareUnsigned(m7488unboximpl, UInt.m7436constructorimpl(65535)) > 0) {
                return null;
            }
            return UShort.m7616boximpl(UShort.m7622constructorimpl((short) m7488unboximpl));
        }
        return null;
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m7436constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m7436constructorimpl(result * uradix);
            result = UInt.m7436constructorimpl(UInt.m7436constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m7430boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m7515constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m7515constructorimpl(result * uradix);
            result = ULong.m7515constructorimpl(ULong.m7515constructorimpl(UInt.m7436constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m7509boximpl(result);
    }
}
