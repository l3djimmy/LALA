        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m7917contentEqualskV0jMPg(((UByteArray) t).m7426unboximpl(), ((UByteArray) t2).m7426unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m7915contentEqualsFGO6Aew(((UShortArray) t).m7689unboximpl(), ((UShortArray) t2).m7689unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m7916contentEqualsKJPZfPQ(((UIntArray) t).m7505unboximpl(), ((UIntArray) t2).m7505unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m7918contentEqualslec5QzE(((ULongArray) t).m7584unboximpl(), ((ULongArray) t2).m7584unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m7923contentToString2csIQuQ(uByteArray != null ? uByteArray.m7426unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m7925contentToStringd6D3K8(uShortArray != null ? uShortArray.m7689unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m7924contentToStringXUkPCBk(uIntArray != null ? uIntArray.m7505unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m7926contentToStringuLth9ew(uLongArray != null ? uLongArray.m7584unboximpl() : null));
            } else {
