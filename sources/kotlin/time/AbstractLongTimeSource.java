...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class LongTimeMark implements ComparableTimeMark {
        ...
        public long mo8677elapsedNowUwyO8pc() {
            return Duration.m8715minusLRDsOJo(LongSaturatedMathKt.saturatingOriginsDiff(this.timeSource.adjustedRead(), this.startedAt, this.timeSource.getUnit()), this.offset);
        }
        ...
        public ComparableTimeMark mo8680plusLRDsOJo(long j) {
            ...
            if (Duration.m8712isInfiniteimpl(j)) {
                return new LongTimeMark(LongSaturatedMathKt.m8789saturatingAddNuflL3o(this.startedAt, unit, j), this.timeSource, Duration.Companion.m8778getZEROUwyO8pc(), null);
            }
            long durationInUnit = Duration.m8730truncateToUwyO8pc$kotlin_stdlib(j, unit);
            long rest = Duration.m8716plusLRDsOJo(Duration.m8715minusLRDsOJo(j, durationInUnit), this.offset);
            long sum = LongSaturatedMathKt.m8789saturatingAddNuflL3o(this.startedAt, unit, durationInUnit);
            long restInUnit = Duration.m8730truncateToUwyO8pc$kotlin_stdlib(rest, unit);
            long sum2 = LongSaturatedMathKt.m8789saturatingAddNuflL3o(sum, unit, restInUnit);
            long restUnderUnit = Duration.m8715minusLRDsOJo(rest, restInUnit);
            long restUnderUnitNs = Duration.m8700getInWholeNanosecondsimpl(restUnderUnit);
            if (sum2 != 0 && restUnderUnitNs != 0 && (sum2 ^ restUnderUnitNs) < 0) {
                ...
                sum2 = LongSaturatedMathKt.m8789saturatingAddNuflL3o(sum2, unit, correction);
                restUnderUnit = Duration.m8715minusLRDsOJo(restUnderUnit, correction);
            }
            long newValue = sum2;
            long newOffset = (((newValue - 1) | 1) > Long.MAX_VALUE ? 1 : (((newValue - 1) | 1) == Long.MAX_VALUE ? 0 : -1)) == 0 ? Duration.Companion.m8778getZEROUwyO8pc() : restUnderUnit;
        ...
        public long mo8679minusUwyO8pc(ComparableTimeMark other) {
            ...
            return Duration.m8716plusLRDsOJo(startedAtDiff, Duration.m8715minusLRDsOJo(this.offset, ((LongTimeMark) other).offset));
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof LongTimeMark) && Intrinsics.areEqual(this.timeSource, ((LongTimeMark) other).timeSource) && Duration.m8692equalsimpl0(mo8679minusUwyO8pc((ComparableTimeMark) other), Duration.Companion.m8778getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return (Duration.m8708hashCodeimpl(this.offset) * 37) + Long.hashCode(this.startedAt);
        }

        public String toString() {
            return "LongTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m8727toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new LongTimeMark(adjustedRead(), this, Duration.Companion.m8778getZEROUwyO8pc(), null);
    }
}
