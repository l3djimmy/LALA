...
public final class DurationKt {
    ...
    private static final long m8784timesmvk6XK0(int $this$times_u2dmvk6XK0, long j) {
        return Duration.m8718timesUwyO8pc(j, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m8783timeskIfJnKk(double $this$times_u2dkIfJnKk, long j) {
        return Duration.m8717timesUwyO8pc(j, $this$times_u2dkIfJnKk);
    }

    /* JADX WARN: Removed duplicated region for block: B:268:0x00ba A[LOOP:1: B:252:0x0079->B:268:0x00ba, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:353:0x029c A[LOOP:4: B:337:0x026d->B:353:0x029c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:415:0x00d5 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:430:0x02a9 A[SYNTHETIC] */
    /*
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m8687constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m8687constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m8687constructorimpl((normalValue << 1) + unitDiscriminator);
    }
