...
public interface TimeMark {
    ...
    TimeMark mo8678minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo8680plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m8798plusLRDsOJo(TimeMark $this, long j) {
            return new AdjustedTimeMark($this, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m8797minusLRDsOJo(TimeMark $this, long j) {
            return $this.mo8680plusLRDsOJo(Duration.m8731unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m8713isNegativeimpl($this.mo8677elapsedNowUwyO8pc());
        }
