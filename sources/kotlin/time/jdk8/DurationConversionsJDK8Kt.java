...
public final class DurationConversionsJDK8Kt {
    private static final long toKotlinDuration(Duration $this$toKotlinDuration) {
        ...
        return kotlin.time.Duration.m8716plusLRDsOJo(DurationKt.toDuration($this$toKotlinDuration.getSeconds(), DurationUnit.SECONDS), DurationKt.toDuration($this$toKotlinDuration.getNano(), DurationUnit.NANOSECONDS));
    }

    /* renamed from: toJavaDuration-LRDsOJo  reason: not valid java name */
    private static final Duration m8822toJavaDurationLRDsOJo(long j) {
        long seconds = kotlin.time.Duration.m8701getInWholeSecondsimpl(j);
        int nanoseconds = kotlin.time.Duration.m8703getNanosecondsComponentimpl(j);
