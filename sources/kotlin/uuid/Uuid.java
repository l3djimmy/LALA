...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m7509boximpl(ULong.m7515constructorimpl(getMostSignificantBits())), ULong.m7509boximpl(ULong.m7515constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m8823toUByteArrayTcUX1vc() {
        return UByteArray.m7412constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (this.mostSignificantBits != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m7515constructorimpl(this.mostSignificantBits), ULong.m7515constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m7515constructorimpl(this.leastSignificantBits), ULong.m7515constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m8825fromULongseb3DHEI(long j, long j2) {
        ...
        public final Uuid m8824fromUByteArrayGBYM_sE(byte[] bArr) {
