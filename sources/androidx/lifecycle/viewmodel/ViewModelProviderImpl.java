...
public final class ViewModelProviderImpl {
    ...
    public final <T extends ViewModel> T getViewModel$lifecycle_viewmodel_release(KClass<T> modelClass, String key) {
        ...
        MutableCreationExtras extras = new MutableCreationExtras(this.extras);
        extras.set(ViewModelProviders.ViewModelKey.INSTANCE, key);
        T t2 = (T) ViewModelProviderImpl_androidKt.createViewModel(this.factory, modelClass, extras);
