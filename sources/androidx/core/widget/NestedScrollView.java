...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        if (!canScroll) {
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, Property.ALIGN_CONTENT);
            return (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(Property.ALIGN_CONTENT)) ? false : true;
            ...
            switch (event.getKeyCode()) {
                ...
                case 20:
                    if (event.isAltPressed()) {
                        boolean handled3 = fullScroll(Property.ALIGN_CONTENT);
                        return handled3;
                    }
                    boolean handled4 = arrowScroll(Property.ALIGN_CONTENT);
                    return handled4;
                case 62:
                ...
                case Property.TABLE_LAYOUT /* 93 */:
                    boolean handled6 = fullScroll(Property.ALIGN_CONTENT);
                    return handled6;
                case Property.WIDOWS_CONTROL /* 122 */:
                    pageScroll(33);
                    return false;
                case Property.RENDERING_MODE /* 123 */:
                    pageScroll(Property.ALIGN_CONTENT);
                    return false;
                default:
                    return false;
            }
    ...
    private int scrollBy(int verticalScrollDistance, int x, int touchType, boolean isSourceMouseOrKeyboard) {
        ...
        int unconsumedY = verticalScrollDistance3 - scrollYDelta;
    ...
    protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        View nextFocus;
        if (direction == 2) {
            direction = Property.ALIGN_CONTENT;
        } else if (direction == 1) {
            direction = 33;
        }
