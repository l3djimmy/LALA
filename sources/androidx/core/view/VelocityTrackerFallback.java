...
class VelocityTrackerFallback {
    ...
    private float getCurrentVelocity() {
        ...
        while (true) {
            int i2 = ((lastEventTime - this.mEventTimes[firstValidIndex]) > RANGE_MS ? 1 : ((lastEventTime - this.mEventTimes[firstValidIndex]) == RANGE_MS ? 0 : -1));
        ...
        for (int i3 = 0; i3 < this.mDataPointsBufferSize - 1; i3++) {
            int currentIndex = i3 + firstValidIndex;
