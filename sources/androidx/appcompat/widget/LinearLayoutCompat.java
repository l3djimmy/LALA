...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (majorGravity = this.mGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) != 48) {
            switch (majorGravity) {
                case 16:
    ...
    */
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int count = getVirtualChildCount();
        int majorGravity = this.mGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS;
    ...
    */
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS;
        if ((this.mGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) != gravity) {
