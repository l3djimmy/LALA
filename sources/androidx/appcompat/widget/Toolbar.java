...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = (this.mButtonGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) | GravityCompat.END;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = (this.mButtonGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) | GravityCompat.START;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:59:0x0161, code lost:
        if (r33.mTitleTextView.getMeasuredWidth() <= 0) goto L115;
     */
    ...
    */
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & Property.BORDER_BOTTOM_RIGHT_RADIUS;
        switch (vgrav) {
            case 16:
            case 48:
            case Property.MIN_WIDTH /* 80 */:
                return vgrav;
            default:
                return this.mGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS;
        }
    }
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != Toolbar.this) {
                ...
                lp.gravity = (Toolbar.this.mButtonGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) | GravityCompat.START;
                lp.mViewType = 2;
