...
public final class NavInflater {
    ...
    private final NavArgument inflateArgument(TypedArray a, Resources res, int graphResId) throws XmlPullParserException {
        ...
        if (argType == null) {
            ...
            NavType navType2 = NavType.Companion.fromArgType(argType, res.getResourcePackageName(graphResId));
            navType = navType2;
        }
            ...
            if (navType == NavType.ReferenceType) {
                ...
                switch (value.type) {
                    case 3:
                        ...
                        break;
                    case 4:
                        navType = Companion.checkNavType$navigation_runtime_release(value, navType, NavType.FloatType, argType, TypedValues.Custom.S_FLOAT);
                        defaultValue = Float.valueOf(value.getFloat());
                        break;
                    case 5:
                        navType = Companion.checkNavType$navigation_runtime_release(value, navType, NavType.IntType, argType, TypedValues.Custom.S_DIMENSION);
                        defaultValue = Integer.valueOf((int) value.getDimension(res.getDisplayMetrics()));
                        break;
                    case 18:
                        navType = Companion.checkNavType$navigation_runtime_release(value, navType, NavType.BoolType, argType, TypedValues.Custom.S_BOOLEAN);
                    ...
                    default:
                        if (value.type >= 16 && value.type <= 31) {
                            if (navType == NavType.FloatType) {
                                ...
                                navType = Companion.checkNavType$navigation_runtime_release(value, navType, NavType.IntType, argType, TypedValues.Custom.S_INT);
