...
public final class NavOptions {
    ...
    public NavOptions(boolean singleTop, boolean restoreState, String popUpToRoute, boolean popUpToInclusive, boolean popUpToSaveState, int enterAnim, int exitAnim, int popEnterAnim, int popExitAnim) {
        this(singleTop, restoreState, NavDestination.Companion.createRoute(popUpToRoute).hashCode(), popUpToInclusive, popUpToSaveState, enterAnim, exitAnim, popEnterAnim, popExitAnim);
    ...
    public int hashCode() {
        ...
        int result2 = ((((result * 31) + (shouldRestoreState() ? 1 : 0)) * 31) + this.popUpToId) * 31;
        String str = this.popUpToRoute;
        return ((((((((((((result2 + (str != null ? str.hashCode() : 0)) * 31) + (isPopUpToInclusive() ? 1 : 0)) * 31) + (shouldPopUpToSaveState() ? 1 : 0)) * 31) + this.enterAnim) * 31) + this.exitAnim) * 31) + this.popEnterAnim) * 31) + this.popExitAnim;
    }
