...
public abstract class NavigatorState {
    ...
    public void pushWithTransition(NavBackStackEntry backStackEntry) {
        ...
        if (!($this$any$iv2 instanceof Collection) || !((Collection) $this$any$iv2).isEmpty()) {
            ...
            while (true) {
                if (it3.hasNext()) {
                    ...
                    NavBackStackEntry it4 = (NavBackStackEntry) element$iv;
            ...
            if (!($this$any$iv3 instanceof Collection) || !((Collection) $this$any$iv3).isEmpty()) {
                ...
                while (true) {
                    if (it5.hasNext()) {
                        ...
                        NavBackStackEntry it6 = (NavBackStackEntry) element$iv2;
                        if (it6 == backStackEntry) {
                            it2 = 1;
                            continue;
                        } else {
                            it2 = null;
        ...
        NavBackStackEntry previousEntry = (NavBackStackEntry) CollectionsKt.lastOrNull((List<? extends Object>) this.backStack.getValue());
    ...
    public void popWithTransition(NavBackStackEntry popUpTo, boolean saveState) {
        ...
        if ($this$any$iv != null) {
            ...
            if (!($this$none$iv2 instanceof Collection) || !((Collection) $this$none$iv2).isEmpty()) {
                Iterator<T> it5 = $this$none$iv2.iterator();
                while (true) {
                    if (it5.hasNext()) {
                        Object element$iv2 = it5.next();
                        NavBackStackEntry it6 = (NavBackStackEntry) element$iv2;
        ...
        NavBackStackEntry incomingEntry = navBackStackEntry;
    ...
    public void onLaunchSingleTopWithTransition(NavBackStackEntry backStackEntry) {
        ...
        while (iterator$iv.hasPrevious()) {
            ...
            if (Intrinsics.areEqual(it.getId(), backStackEntry.getId())) {
                ...
                this._transitionsInProgress.setValue(SetsKt.plus(SetsKt.plus(this._transitionsInProgress.getValue(), oldEntry), backStackEntry));
