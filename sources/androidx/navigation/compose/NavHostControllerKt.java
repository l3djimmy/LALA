...
public final class NavHostControllerKt {
    ...
    public static final NavHostController rememberNavController(Navigator<? extends NavDestination>[] navigatorArr, Composer $composer, int $changed) {
        ...
        Object m3846rememberSaveable = RememberSaveableKt.m3846rememberSaveable(Arrays.copyOf(navigatorArr, navigatorArr.length), (Saver<Object, ? extends Object>) NavControllerSaver(context), (String) null, (Function0<? extends Object>) new Function0<NavHostController>() { // from class: androidx.navigation.compose.NavHostControllerKt$rememberNavController$1
        ...
        NavHostController $this$rememberNavController_u24lambda_u240 = (NavHostController) m3846rememberSaveable;
        for (Navigator<? extends NavDestination> navigator : navigatorArr) {
            $this$rememberNavController_u24lambda_u240.getNavigatorProvider().addNavigator(navigator);
        }
        NavHostController navHostController = (NavHostController) m3846rememberSaveable;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceableGroup();
    ...
    public static final NavHostController createNavController(Context context) {
        ...
        $this$createNavController_u24lambda_u241.getNavigatorProvider().addNavigator(new ComposeNavGraphNavigator($this$createNavController_u24lambda_u241.getNavigatorProvider()));
        $this$createNavController_u24lambda_u241.getNavigatorProvider().addNavigator(new ComposeNavigator());
        $this$createNavController_u24lambda_u241.getNavigatorProvider().addNavigator(new DialogNavigator());
