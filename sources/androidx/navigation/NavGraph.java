...
public class NavGraph extends NavDestination implements Iterable<NavDestination>, KMappedMarker {
    ...
    public NavDestination.DeepLinkMatch matchDeepLink(NavDeepLinkRequest navDeepLinkRequest) {
        ...
        NavDestination.DeepLinkMatch bestChildMatch = (NavDestination.DeepLinkMatch) CollectionsKt.maxOrNull((Iterable<? extends Comparable>) ((List) destination$iv$iv));
        return (NavDestination.DeepLinkMatch) CollectionsKt.maxOrNull((Iterable<? extends Comparable>) CollectionsKt.listOfNotNull((Object[]) new NavDestination.DeepLinkMatch[]{bestMatch, bestChildMatch}));
    }
    ...
    private final void setStartDestinationRoute(String startDestRoute) {
        ...
        if (startDestRoute == null) {
            hashCode = 0;
        } else if (Intrinsics.areEqual(startDestRoute, getRoute())) {
    ...
    public boolean equals(Object other) {
        ...
        if (super.equals(other)) {
            ...
            if (size == $receiver$iv2.size() && getStartDestinationId() == ((NavGraph) other).getStartDestinationId()) {
    ...
    public static final class Companion {
        ...
        public final NavDestination findStartDestination(NavGraph $this$findStartDestination) {
            ...
            return (NavDestination) SequencesKt.last(SequencesKt.generateSequence($this$findStartDestination.findNode($this$findStartDestination.getStartDestinationId()), new Function1<NavDestination, NavDestination>() { // from class: androidx.navigation.NavGraph$Companion$findStartDestination$1
