...
public final class NavDeepLink {
    ...
    public NavDeepLink(String uriPattern, String action, String mimeType) {
        ...
        this.fragPattern$delegate = LazyKt.lazy(new Function0<Pattern>() { // from class: androidx.navigation.NavDeepLink$fragPattern$2
            ...
            public final Pattern invoke() {
                String it;
                it = NavDeepLink.this.getFragRegex();
                if (it != null) {
                    return Pattern.compile(it, 2);
                }
                return null;
        ...
        this.mimeTypePattern$delegate = LazyKt.lazy(new Function0<Pattern>() { // from class: androidx.navigation.NavDeepLink$mimeTypePattern$2
            ...
            public final Pattern invoke() {
                String it;
                it = NavDeepLink.this.mimeTypeRegex;
                if (it != null) {
    ...
    public final List<String> getArgumentsNames$navigation_common_release() {
        ...
        return CollectionsKt.plus((Collection) CollectionsKt.plus((Collection) list, (Iterable) ((List) destination$iv$iv)), (Iterable) getFragArgs());
    }
    ...
    private final void buildRegex(String uri, List<String> list, StringBuilder uriRegex) {
    ...
    private final void getMatchingUriFragment(String fragment, Bundle bundle, Map<String, NavArgument> map) {
    ...
    private final boolean getMatchingQueryArguments(Uri deepLink, Bundle bundle, Map<String, NavArgument> map) {
        String argValue;
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            if (!parseInputParams(inputParams, storedParam, bundle, map)) {
                return false;
            }
        }
        return true;
    ...
    private final boolean parseInputParams(List<String> list, ParamQuery storedParam, Bundle bundle, Map<String, NavArgument> map) {
        Iterable $this$forEach$iv;
        boolean z;
        Iterator it;
        Object element$iv;
        if (list != null) {
            List<String> $this$forEach$iv2 = list;
            boolean z2 = false;
            ...
            while (it2.hasNext()) {
                ...
                Matcher argMatcher = it3 != null ? Pattern.compile(it3, 32).matcher(inputParam) : null;
                if (argMatcher != null && argMatcher.matches()) {
                    ...
                    try {
                        ...
                        for (Object item$iv$iv : $this$mapIndexed$iv) {
                            ...
                            String argName = (String) item$iv$iv;
                            ...
                            try {
                                ...
                                if (parseArgumentForRepeatedParam(bundle, argName, value, argument)) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            if (!Intrinsics.areEqual(value, '{' + argName + '}') && parseArgument(queryParamBundle, argName, value, argument)) {
                                                return false;
                                            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: NavDeepLink.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u000f\n\u0000\n\u0002\u0010\u000e\n\u0002\b\t\n\u0002\u0010\b\n\u0002\b\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0011\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u0000H\u0096\u0002R\u001a\u0010\u0005\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\u0004R\u001a\u0010\t\u001a\u00020\u0003X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\n\u0010\u0007\"\u0004\b\u000b\u0010\u0004¨\u0006\u000f"}, d2 = {"Landroidx/navigation/NavDeepLink$MimeType;", "", "mimeType", "", "(Ljava/lang/String;)V", "subType", "getSubType", "()Ljava/lang/String;", "setSubType", PdfConst.Type, "getType", "setType", "compareTo", "", "other", "navigation-common_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* loaded from: classes11.dex */
        ...
        if (isParameterizedQuery()) {
            ...
            for (String paramName : uri.getQueryParameterNames()) {
                ...
                while (matcher.find()) {
                    ...
                    String substring = queryParam.substring(appendPos, matcher.start());
                    Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
                ...
                if (appendPos < queryParam.length()) {
                    Intrinsics.checkNotNullExpressionValue(queryParam, "queryParam");
                    String substring2 = queryParam.substring(appendPos);
                    Intrinsics.checkNotNullExpressionValue(substring2, "this as java.lang.String).substring(startIndex)");
