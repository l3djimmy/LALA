    ...
    private NavBackStackEntry(Context context, NavDestination destination, Bundle immutableArgs, Lifecycle.State hostLifecycleState, NavViewModelStoreProvider viewModelStoreProvider, String id, Bundle savedState) {
        ...
        this.defaultFactory$delegate = LazyKt.lazy(new Function0<SavedStateViewModelFactory>() { // from class: androidx.navigation.NavBackStackEntry$defaultFactory$2
            ...
            public final SavedStateViewModelFactory invoke() {
                ...
                return new SavedStateViewModelFactory(applicationContext instanceof Application ? (Application) applicationContext : null, NavBackStackEntry.this, NavBackStackEntry.this.getArguments());
            }
        });
