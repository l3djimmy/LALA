...
public class ConstraintLayoutStates {
    ...
    private void load(Context context, int resourceId) {
        ...
        try {
                ...
                if (eventType != 1) {
                    switch (eventType) {
                        case 2:
                            ...
                            switch (c) {
                                case 2:
                                    State state2 = new State(context, parser);
            ...
            Log.e("ConstraintLayoutStates", "Error parsing resource: " + resourceId, e);
        } catch (XmlPullParserException e2) {
            Log.e("ConstraintLayoutStates", "Error parsing resource: " + resourceId, e2);
        }
    }
