...
public class MotionScene {
    ...
    private int mDefaultDuration = FontWeights.NORMAL;
    ...
    public static class Transition {
        ...
        Transition(MotionScene motionScene, Transition global) {
            ...
            this.mDuration = FontWeights.NORMAL;
            this.mStagger = 0.0f;
    ...
    public int parseInclude(Context context, int resourceId) {
        String str = "Error parsing resource: ";
        Resources res = context.getResources();
        ...
        try {
            for (int eventType = includeParser.getEventType(); eventType != 1; eventType = includeParser.next()) {
                ...
                if (2 == eventType && CONSTRAINTSET_TAG.equals(tagName)) {
                    str = parseConstraintSet(context, includeParser);
                    return str;
                }
            }
            return -1;
        } catch (IOException e) {
            Log.e(TypedValues.MotionScene.NAME, str + resourceId, e);
            return -1;
        } catch (XmlPullParserException e2) {
            Log.e(TypedValues.MotionScene.NAME, str + resourceId, e2);
            return -1;
        }
    }
            ...
            switch (event.getAction()) {
                ...
                case 2:
                    if (!this.mIgnoreTouch) {
                        ...
                        if ((dx == AudioStats.AUDIO_AMPLITUDE_NONE && dy == AudioStats.AUDIO_AMPLITUDE_NONE) || this.mLastTouchDown == null) {
                            return;
                        }
