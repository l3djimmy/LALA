...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setupMotionViews() {
        ...
        if (stagger != 0.0f) {
            boolean flip2 = ((double) stagger) < AudioStats.AUDIO_AMPLITUDE_NONE;
    ...
    class DecelerateInterpolator extends MotionInterpolator {
        ...
        public float getInterpolation(float time) {
            int i = (this.mInitialV > 0.0f ? 1 : (this.mInitialV == 0.0f ? 0 : -1));
            float f = this.mInitialV;
            if (i > 0) {
                if (f / this.mMaxA < time) {
    ...
    public class Model {
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mLeft.mTarget != null) {
                str4 = StandardRoles.L + (child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? StandardRoles.L : "R");
            } else {
                str4 = "__";
            }
            ...
            if (child.mRight.mTarget != null) {
                str5 = "R" + (child.mRight.mTarget.mType == ConstraintAnchor.Type.LEFT ? StandardRoles.L : "R");
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String a2 = ((a + (child.mBottom.mTarget != null ? "B" : "_")) + (child.mLeft.mTarget != null ? StandardRoles.L : "_")) + (child.mRight.mTarget != null ? "R" : "_");
            ...
            if (this.mInterpolator != null && !done) {
                if (this.mTemporalInterpolator) {
                    ...
                    if (this.mInterpolator != this.mStopLogic) {
                        ...
                        boolean dp2 = this.mStopLogic.isStopped();
                        if (!dp2) {
                            z2 = true;
                        } else {
                            z2 = true;
                    ...
                    float p2 = position;
                    position = this.mInterpolator.getInterpolation(position);
                    boolean z3 = this.mInterpolator instanceof MotionInterpolator;
