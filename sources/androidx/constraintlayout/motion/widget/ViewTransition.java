...
public class ViewTransition {
                        ...
                        case 2:
                            ...
                            switch (c) {
                                ...
                                case 4:
                                    ...
                                    break;
                                default:
                                    Log.e("ViewTransition", Debug.getLoc() + " unknown tag " + tagName);
                                    Log.e("ViewTransition", ".xml:" + parser.getLineNumber());
                                    break;
                            }
                            break;
                        case 3:
                            if ("ViewTransition".equals(parser.getName())) {
                                return;
                            }
                            break;
                    }
    ...
    public void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        layout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.ViewTransition$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ViewTransition.this.m7135x14d7500(views);
            }
        });
    }
    ...
    public /* synthetic */ void m7135x14d7500(View[] views) {
        if (this.mSetsTag != -1) {
            for (View view : views) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (this.mKeyFrames != null) {
            ...
            while (it.hasNext()) {
                Key key = it.next();
                keyFrames.addKey(key.mo7134clone().setViewId(id));
            }
