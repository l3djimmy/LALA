...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
        ...
        if (!this.mDimension.resolved && this.mDimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.mWidget.mMatchConstraintDefaultWidth == 0 && !this.mWidget.isInHorizontalChain()) {
            int startPos = this.start.mTargets.get(0).value + this.start.mMargin;
            int endPos = this.end.mTargets.get(0).value + this.end.mMargin;
        ...
        int startPos3 = startTarget.value + this.start.mMargin;
        int endPos3 = endTarget.value + this.end.mMargin;
