...
public class ConstraintSetParser {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x00c1, code lost:
        if (r4.equals("barrier") != false) goto L58;
     */
    /*
    ...
    */
            ...
            switch (c) {
                case 0:
                    ...
                    while (j < elements2.size()) {
                        ...
                        String type = designElement.getStringOrNull(PdfConst.Type);
                        if (type != null) {
    ...
    private static void parseChainType(String orientation, State state, String chainName, LayoutVariables margins, CLObject object) throws CLParsingException {
        ...
        ChainReference chain = verticalChain;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00b7, code lost:
        if (r6.equals("left") != false) goto L38;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:101:0x01bf, code lost:
        if (r0.equals("invisible") != false) goto L33;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    ...
    */
    ...
    static String lookForType(CLObject element) throws CLParsingException {
        ...
        while (it.hasNext()) {
            String constraintName = it.next();
            if (constraintName.equals(PdfConst.Type)) {
                return element.getString(PdfConst.Type);
            }
        }
        return null;
    }
