...
public class GridCore extends VirtualLayout {
    ...
    private void initVariables() {
        ...
        if (this.mWidgetsCount > 0) {
            this.mConstraintMatrix = (int[][]) Array.newInstance(Integer.TYPE, this.mWidgetsCount, 4);
    ...
    public static /* synthetic */ int lambda$parseSpans$0(String span1, String span2) {
