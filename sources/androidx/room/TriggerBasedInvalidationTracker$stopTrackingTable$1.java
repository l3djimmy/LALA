...
@DebugMetadata(c = "androidx.room.TriggerBasedInvalidationTracker", f = "InvalidationTracker.kt", i = {0, 0}, l = {TIFFConstants.TIFFTAG_JPEGTABLES}, m = "stopTrackingTable", n = {"connection", "tableName"}, s = {"L$0", "L$1"})
