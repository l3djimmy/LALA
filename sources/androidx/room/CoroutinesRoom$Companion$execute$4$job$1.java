        ...
        switch (this.label) {
            case 0:
                ...
                try {
                    ...
                    this.$continuation.resumeWith(Result.m7341constructorimpl(result));
                } catch (Throwable exception) {
                    Result.Companion companion2 = Result.Companion;
                    this.$continuation.resumeWith(Result.m7341constructorimpl(ResultKt.createFailure(exception)));
                }
