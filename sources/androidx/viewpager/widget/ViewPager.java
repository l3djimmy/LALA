        ...
        while (i < size) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    ...
                    int vgrav = lp2.gravity & Property.BORDER_BOTTOM_RIGHT_RADIUS;
            ...
            if (i < count2) {
                ...
                if (child.getVisibility() == 8) {
                    ...
                    if (!lp.isDecor) {
                        ...
                        int vgrav2 = width3 & Property.BORDER_BOTTOM_RIGHT_RADIUS;
                        switch (hgrav) {
                            case 1:
                                vgrav = vgrav2;
                        ...
                        child.layout(childLeft2, childTop, child.getMeasuredWidth() + childLeft2, height3);
                        decorCount++;
                    }
                }
                i++;
            ...
            case 2:
                ...
                if (activePointerId != -1) {
                    ...
                    if (xDiff > this.mTouchSlop && 0.5f * xDiff > yDiff) {
                        ...
                        requestParentDisallowInterceptTouchEvent(true);
                        setScrollState(1);
                        int i = (dx > 0.0f ? 1 : (dx == 0.0f ? 0 : -1));
                        float f = this.mInitialMotionX;
                        this.mLastMotionX = i > 0 ? f + this.mTouchSlop : f - this.mTouchSlop;
                        this.mLastMotionY = y2;
                        setScrollingCacheEnabled(true);
                ...
                if (!this.mIsBeingDragged) {
                    ...
                    if (pointerIndex == -1) {
                        ...
                        if (xDiff > this.mTouchSlop && xDiff > yDiff) {
                            this.mIsBeingDragged = true;
                            requestParentDisallowInterceptTouchEvent(true);
                            int i = ((x3 - this.mInitialMotionX) > 0.0f ? 1 : ((x3 - this.mInitialMotionX) == 0.0f ? 0 : -1));
                            float f = this.mInitialMotionX;
                            this.mLastMotionX = i > 0 ? f + this.mTouchSlop : f - this.mTouchSlop;
                            this.mLastMotionY = y2;
                            setScrollState(1);
