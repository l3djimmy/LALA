...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    /* renamed from: clone */
    public SparseArrayCompat<E> m294clone() {
    ...
    public E get(int key, E e) {
        return (E) SparseArrayCompatKt.commonGet(this, key, e);
    }
    ...
    public E putIfAbsent(int key, E e) {
        ...
        if (e2 == null) {
            ...
            if (i$iv$iv >= 0) {
                this.values[i$iv$iv] = e;
            } else {
                int i$iv$iv2 = ~i$iv$iv;
                if (i$iv$iv2 < this.size && this.values[i$iv$iv2] == SparseArrayCompatKt.DELETED) {
                    this.keys[i$iv$iv2] = key;
                    this.values[i$iv$iv2] = e;
                } else {
                    if (this.garbage && this.size >= this.keys.length) {
                        SparseArrayCompatKt.gc(this);
