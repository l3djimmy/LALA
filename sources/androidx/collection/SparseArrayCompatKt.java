...
public final class SparseArrayCompatKt {
    ...
    private static final <E, T extends E> T internalGet(SparseArrayCompat<E> sparseArrayCompat, int key, T t) {
        ...
        return (T) sparseArrayCompat.values[i];
    }

    public static final <E> E commonGet(SparseArrayCompat<E> sparseArrayCompat, int key) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        int i$iv = ContainerHelpersKt.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
        if (i$iv < 0 || sparseArrayCompat.values[i$iv] == DELETED) {
            return null;
        }
        return (E) sparseArrayCompat.values[i$iv];
    }

    public static final <E> E commonGet(SparseArrayCompat<E> sparseArrayCompat, int key, E e) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        int i$iv = ContainerHelpersKt.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
        if (i$iv < 0 || sparseArrayCompat.values[i$iv] == DELETED) {
            return e;
    ...
    public static final <E> E commonReplace(SparseArrayCompat<E> sparseArrayCompat, int key, E e) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        int index = sparseArrayCompat.indexOfKey(key);
        if (index >= 0) {
            E e2 = (E) sparseArrayCompat.values[index];
    ...
    public static final <E> E commonPutIfAbsent(SparseArrayCompat<E> sparseArrayCompat, int key, E e) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        E e2 = (E) commonGet(sparseArrayCompat, key);
        if (e2 == null) {
            int i$iv = ContainerHelpersKt.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
            if (i$iv >= 0) {
                sparseArrayCompat.values[i$iv] = e;
            } else {
                int i$iv2 = ~i$iv;
                if (i$iv2 < sparseArrayCompat.size && sparseArrayCompat.values[i$iv2] == DELETED) {
                    sparseArrayCompat.keys[i$iv2] = key;
                    sparseArrayCompat.values[i$iv2] = e;
                } else {
                    if (sparseArrayCompat.garbage && sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        gc(sparseArrayCompat);
                        i$iv2 = ~ContainerHelpersKt.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
                    }
                    if (sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        int n$iv = ContainerHelpersKt.idealIntArraySize(sparseArrayCompat.size + 1);
                        int[] copyOf = Arrays.copyOf(sparseArrayCompat.keys, n$iv);
    ...
    public static final <E> E commonValueAt(SparseArrayCompat<E> sparseArrayCompat, int index) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        if (sparseArrayCompat.garbage) {
            gc(sparseArrayCompat);
        }
        if (index >= sparseArrayCompat.values.length) {
            CollectionPlatformUtils collectionPlatformUtils = CollectionPlatformUtils.INSTANCE;
            throw new ArrayIndexOutOfBoundsException();
        }
        return (E) sparseArrayCompat.values[index];
    }
