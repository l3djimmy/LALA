...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final void set(K k, float value) {
    ...
    public final void put(K k, float value) {
        set(k, value);
    }

    public final float put(K k, float value, float f) {
        int index = findIndex(k);
        float previous = f;
        if (index < 0) {
            index = ~index;
    ...
    public final boolean remove(K k, float value) {
        int index = findKeyIndex(k);
        if (index >= 0) {
