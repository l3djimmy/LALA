...
public final class ArraySet<E> implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
    ...
    public final E valueAt(int index) {
        return (E) getArray$collection()[index];
    }
    ...
    public boolean add(E e) {
        ...
        if (oSize$iv >= getHashes$collection().length) {
            ...
            if (!(getHashes$collection().length == 0)) {
                ...
                ArraysKt.copyInto$default(oarray$iv, getArray$collection(), 0, 0, oarray$iv.length, 6, (Object) null);
            }
        }
        if (index$iv2 < oSize$iv) {
            ArraysKt.copyInto(getHashes$collection(), getHashes$collection(), index$iv2 + 1, index$iv2, oSize$iv);
            ArraysKt.copyInto(getArray$collection(), getArray$collection(), index$iv2 + 1, index$iv2, oSize$iv);
        }
    ...
    public final void addAll(ArraySet<? extends E> array) {
        ...
        if (get_size$collection() == 0) {
            if (n$iv > 0) {
                ArraysKt.copyInto$default(array.getHashes$collection(), getHashes$collection(), 0, 0, n$iv, 6, (Object) null);
                ArraysKt.copyInto$default(array.getArray$collection(), getArray$collection(), 0, 0, n$iv, 6, (Object) null);
                if (get_size$collection() != 0) {
                    throw new ConcurrentModificationException();
                }
    ...
    public final E removeAt(int index) {
        ...
        Object[] oarray$iv;
        int oSize$iv = get_size$collection();
        E e = (E) getArray$collection()[index];
        if (oSize$iv <= 1) {
            clear();
        } else {
            int nSize$iv = oSize$iv - 1;
            if (getHashes$collection().length > 8 && get_size$collection() < getHashes$collection().length / 3) {
                int n$iv = get_size$collection() > 8 ? get_size$collection() + (get_size$collection() >> 1) : 8;
                ...
                if (i < nSize$iv) {
                    ...
                    ArraysKt.copyInto(oarray$iv, getArray$collection(), i, i + 1, nSize$iv + 1);
                }
            } else {
                if (index < nSize$iv) {
                    ArraysKt.copyInto(getHashes$collection(), getHashes$collection(), index, index + 1, nSize$iv + 1);
                    ArraysKt.copyInto(getArray$collection(), getArray$collection(), index, index + 1, nSize$iv + 1);
                }
