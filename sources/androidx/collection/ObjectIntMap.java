...
public abstract class ObjectIntMap<K> {
    ...
    public final int getOrDefault(K k, int defaultValue) {
        int index = findKeyIndex(k);
        if (index >= 0) {
            return this.values[index];
        }
    ...
    public boolean equals(Object other) {
        ...
        boolean z3 = false;
        if ((other instanceof ObjectIntMap) && ((ObjectIntMap) other).getSize() == getSize()) {
            ObjectIntMap o = (ObjectIntMap) other;
            ObjectIntMap this_$iv = this;
            Object[] k$iv = this_$iv.keys;
            int[] v$iv = this_$iv.values;
            long[] m$iv$iv = this_$iv.metadata;
