...
public abstract class DoubleList {
    ...
    public final <R> R fold(R r, Function2<? super R, ? super Double, ? extends R> operation) {
        ...
        for (int i$iv = 0; i$iv < i; i$iv++) {
            double item = content$iv[i$iv];
            acc2 = (R) operation.invoke(acc2, Double.valueOf(item));
        }
        return (R) acc2;
    }

    public final <R> R foldIndexed(R r, Function3<? super Integer, ? super R, ? super Double, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        Object acc = r;
        Object acc2 = (R) acc;
        double[] content$iv = this.content;
        ...
        for (int i$iv = 0; i$iv < i; i$iv++) {
            double item = content$iv[i$iv];
            int i2 = i$iv;
            acc2 = (R) operation.invoke(Integer.valueOf(i2), acc2, Double.valueOf(item));
        }
        return (R) acc2;
    }

    public final <R> R foldRight(R r, Function2<? super Double, ? super R, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        Object acc = r;
        Object acc2 = (R) acc;
        double[] content$iv = this.content;
        ...
        while (true) {
            ...
            double item = content$iv[i$iv];
            acc2 = (R) operation.invoke(Double.valueOf(item), acc2);
        }
    }

    public final <R> R foldRightIndexed(R r, Function3<? super Integer, ? super Double, ? super R, ? extends R> operation) {
        Intrinsics.checkNotNullParameter(operation, "operation");
        Object acc = r;
        Object acc2 = (R) acc;
        double[] content$iv = this.content;
        ...
        while (true) {
            ...
            double item = content$iv[i$iv];
            acc2 = (R) operation.invoke(Integer.valueOf(i$iv), Double.valueOf(item), acc2);
        }
    }
