...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    public final void set(K k, long value) {
    ...
    public final void put(K k, long value) {
        set(k, value);
    }

    public final long put(K k, long value, long j) {
        int index = findIndex(k);
        long previous = j;
        if (index < 0) {
            index = ~index;
    ...
    public final boolean remove(K k, long value) {
        int index = findKeyIndex(k);
