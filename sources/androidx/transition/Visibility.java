        ...
        if ((this.mMode & 2) == 2 && startValues != null) {
                ...
                if (!needOverlayForStartView) {
                    ...
                    if (!parentVisibilityInfo.mVisibilityChange) {
                        ...
                        if (startParent.getParent() == null) {
                            ...
                            if (id != -1) {
                                r17 = z;
                                if (sceneRoot.findViewById(id) != null) {
                                    r17 = z;
            ...
            if (overlayView != null) {
                if (!reusingOverlayView) {
                    ...
                    int screenY = screenLoc[r17];
                    int[] loc = new int[2];
                    sceneRoot.getLocationOnScreen(loc);
                    overlayView.offsetLeftAndRight((screenX - loc[0]) - overlayView.getLeft());
                    overlayView.offsetTopAndBottom((screenY - loc[r17]) - overlayView.getTop());
                ...
                if (animator3 != null) {
                    DisappearListener disappearListener = new DisappearListener(viewToKeep, endVisibility, r17);
