...
public final class ComposedModifierKt {
    ...
    public static final Modifier materializeImpl(final Composer $this$materializeImpl, Modifier modifier) {
        ...
        Modifier result = (Modifier) modifier.foldIn(Modifier.Companion, new Function2<Modifier, Modifier.Element, Modifier>() { // from class: androidx.compose.ui.ComposedModifierKt$materializeImpl$result$1
    ...
    public static final Modifier materializeWithCompositionLocalInjectionInternal(Composer $this$materializeWithCompositionLocalInjectionInternal, Modifier modifier) {
        return modifier == Modifier.Companion ? modifier : materializeModifier($this$materializeWithCompositionLocalInjectionInternal, new CompositionLocalMapInjectionElement($this$materializeWithCompositionLocalInjectionInternal.getCurrentCompositionLocalMap()).then(modifier));
    }
}
