...
public interface SemanticsModifier extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static <R> R foldIn(SemanticsModifier $this, R r, Function2<? super R, ? super Modifier.Element, ? extends R> function2) {
            return (R) SemanticsModifier.super.foldIn(r, function2);
        }

        @Deprecated
        public static <R> R foldOut(SemanticsModifier $this, R r, Function2<? super Modifier.Element, ? super R, ? extends R> function2) {
