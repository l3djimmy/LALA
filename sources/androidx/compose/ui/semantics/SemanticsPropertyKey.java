...
public final class SemanticsPropertyKey<T> {
    ...
    public final T getValue(SemanticsPropertyReceiver thisRef, KProperty<?> kProperty) {
        return (T) SemanticsPropertiesKt.access$throwSemanticsGetNotSupported();
    }

    public final void setValue(SemanticsPropertyReceiver thisRef, KProperty<?> kProperty, T t) {
        thisRef.set(this, t);
    }
