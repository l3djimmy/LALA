...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    public void mo6033setCompositingStrategyaDBOjCE(int value) {
        ...
        } else if (CompositingStrategy.m4373equalsimpl0(value, CompositingStrategy.Companion.m4378getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> function1) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m4260clipPathmtrdDE$default($this$record_u24lambda_u241, clipPath, 0, 2, null);
        }
        function1.invoke($this$record_u24lambda_u241);
        if (clipPath != null) {
