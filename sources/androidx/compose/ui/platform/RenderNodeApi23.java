...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public int mo6032getCompositingStrategyNrFUSI() {
        return this.internalCompositingStrategy;
    }

    @Override // androidx.compose.ui.platform.DeviceRenderNode
    /* renamed from: setCompositingStrategy-aDBOjCE */
    public void mo6033setCompositingStrategyaDBOjCE(int value) {
        if (CompositingStrategy.m4373equalsimpl0(value, CompositingStrategy.Companion.m4379getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else {
            boolean m4373equalsimpl0 = CompositingStrategy.m4373equalsimpl0(value, CompositingStrategy.Companion.m4378getModulateAlphaNrFUSI());
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m4373equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m4379getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    @Override // androidx.compose.ui.platform.DeviceRenderNode
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> function1) {
        ...
        if (clipPath != null) {
            ...
            Canvas.m4260clipPathmtrdDE$default($this$record_u24lambda_u240, clipPath, 0, 2, null);
        }
        function1.invoke($this$record_u24lambda_u240);
        if (clipPath != null) {
