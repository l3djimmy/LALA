...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo1071onPreScrollOzD1aCk(long available, int source) {
        int m6073getScrollAxesk4lQ0M;
        int m6075toViewTypeGyEprt8;
        int m6075toViewTypeGyEprt82;
        long m6074toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m6073getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m6073getScrollAxesk4lQ0M(available);
        m6075toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m6075toViewTypeGyEprt8(source);
        if (nestedScrollingChildHelper.startNestedScroll(m6073getScrollAxesk4lQ0M, m6075toViewTypeGyEprt8)) {
            ...
            m6075toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m6075toViewTypeGyEprt8(source);
            nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m6075toViewTypeGyEprt82);
            m6074toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m6074toOffsetUv8p0NA(this.consumedScrollCache, available);
            return m6074toOffsetUv8p0NA;
        }
    ...
    public long mo765onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (nestedScrollingChildHelper.startNestedScroll(m6073getScrollAxesk4lQ0M, m6075toViewTypeGyEprt8)) {
            ...
            m6075toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m6075toViewTypeGyEprt8(source);
            nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m6075toViewTypeGyEprt82, this.consumedScrollCache);
            m6074toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m6074toOffsetUv8p0NA(this.consumedScrollCache, available);
            return m6074toOffsetUv8p0NA;
        }
        return Offset.Companion.m4064getZeroF1C5BW0();
    ...
    public Object mo1070onPreFlingQWom1Mo(long available, Continuation<? super Velocity> continuation) {
        ...
        long result;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7111getXimpl(available));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7112getYimpl(available));
        if (nestedScrollingChildHelper.dispatchNestedPreFling(viewVelocity, viewVelocity2)) {
            result = available;
        } else {
            result = Velocity.Companion.m7122getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m7102boximpl(result);
    }
