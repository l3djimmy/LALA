...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte == 1) {
                ...
                mutableSpanStyle.m6065setColor8_81llA(m6028decodeColor0d7_KjU());
            } else if (decodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m6066setFontSizeR2X_6o(m6031decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m6067setFontStylemLjRB2g(FontStyle.m6447boximpl(m6029decodeFontStyle_LCdwA()));
            } else if (decodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m6068setFontSynthesistDdu0R4(FontSynthesis.m6458boximpl(m6030decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m6069setLetterSpacingR2X_6o(m6031decodeTextUnitXSAIIZE());
            } else if (decodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m6064setBaselineShift_isdbwI(BaselineShift.m6629boximpl(m6026decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m6063setBackground8_81llA(m6028decodeColor0d7_KjU());
    ...
    public final long m6028decodeColor0d7_KjU() {
        return Color.m4285constructorimpl(m6027decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m6031decodeTextUnitXSAIIZE() {
        long type;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
    ...
    public final int m6029decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
    ...
    public final int m6030decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
    ...
    private final float m6026decodeBaselineShifty9eOQZs() {
    ...
    private final Shadow decodeShadow() {
        long m6028decodeColor0d7_KjU = m6028decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(m6028decodeColor0d7_KjU, Offset.m4040constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m6027decodeULongsVKNKU() {
