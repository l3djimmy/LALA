...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00152\u00020\u0001:\u0001\u0015B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\u000b\u0010\fJ\u0010\u0010\r\u001a\u00020\u000eHÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0010J\u000f\u0010\u0011\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0013\u0010\u0014R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u0016"}, d2 = {"Landroidx/compose/ui/input/key/Key;", "", "keyCode", "", "constructor-impl", "(J)J", "getKeyCode", "()J", "equals", "", "other", "equals-impl", "(JLjava/lang/Object;)Z", "hashCode", "", "hashCode-impl", "(J)I", "toString", "", "toString-impl", "(J)Ljava/lang/String;", "Companion", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@JvmInline
...
public final class Key {
    ...
    private static final long NavigatePrevious = Key_androidKt.Key(MetaDo.META_SETROP2);
    private static final long NavigateNext = Key_androidKt.Key(MetaDo.META_SETRELABS);
    private static final long NavigateIn = Key_androidKt.Key(262);
    private static final long NavigateOut = Key_androidKt.Key(263);
    private static final long SystemNavigationUp = Key_androidKt.Key(TIFFConstants.TIFFTAG_MINSAMPLEVALUE);
    private static final long SystemNavigationDown = Key_androidKt.Key(TIFFConstants.TIFFTAG_MAXSAMPLEVALUE);
    private static final long SystemNavigationLeft = Key_androidKt.Key(TIFFConstants.TIFFTAG_XRESOLUTION);
    private static final long SystemNavigationRight = Key_androidKt.Key(TIFFConstants.TIFFTAG_YRESOLUTION);
    ...
    private static final long DirectionDownLeft = Key_androidKt.Key(TIFFConstants.TIFFTAG_DOCUMENTNAME);
    private static final long DirectionUpRight = Key_androidKt.Key(TIFFConstants.TIFFTAG_IMAGEDESCRIPTION);
    private static final long DirectionDownRight = Key_androidKt.Key(TIFFConstants.TIFFTAG_MAKE);
    ...
    private static final long Delete = Key_androidKt.Key(Property.BORDER_BOTTOM_RIGHT_RADIUS);
    private static final long Escape = Key_androidKt.Key(Property.BORDER_TOP_RIGHT_RADIUS);
    private static final long CtrlLeft = Key_androidKt.Key(Property.BORDER_BOTTOM_LEFT_RADIUS);
    private static final long CtrlRight = Key_androidKt.Key(Property.BORDER_COLLAPSE);
    private static final long CapsLock = Key_androidKt.Key(Property.HORIZONTAL_BORDER_SPACING);
    private static final long ScrollLock = Key_androidKt.Key(Property.VERTICAL_BORDER_SPACING);
    private static final long MetaLeft = Key_androidKt.Key(Property.TYPOGRAPHY_CONFIG);
    private static final long MetaRight = Key_androidKt.Key(Property.NO_SOFT_WRAP_INLINE);
    private static final long Function = Key_androidKt.Key(Property.CAPTION_SIDE);
    private static final long PrintScreen = Key_androidKt.Key(120);
    private static final long Break = Key_androidKt.Key(Property.ORPHANS_CONTROL);
    private static final long MoveHome = Key_androidKt.Key(Property.WIDOWS_CONTROL);
    private static final long MoveEnd = Key_androidKt.Key(Property.RENDERING_MODE);
    private static final long Insert = Key_androidKt.Key(Property.LINE_HEIGHT);
    private static final long Cut = Key_androidKt.Key(TIFFConstants.TIFFTAG_SAMPLESPERPIXEL);
    private static final long Copy = Key_androidKt.Key(TIFFConstants.TIFFTAG_ROWSPERSTRIP);
    private static final long Paste = Key_androidKt.Key(TIFFConstants.TIFFTAG_STRIPBYTECOUNTS);
    ...
    private static final long ButtonThumbLeft = Key_androidKt.Key(Property.OUTLINE);
    ...
    private static final long ButtonMode = Key_androidKt.Key(Property.BORDER_TOP_LEFT_RADIUS);
    ...
    private static final long Forward = Key_androidKt.Key(Property.OBJECT_FIT);
    private static final long F1 = Key_androidKt.Key(Property.FLEX_BASIS);
    private static final long F2 = Key_androidKt.Key(Property.FLEX_GROW);
    private static final long F3 = Key_androidKt.Key(Property.JUSTIFY_CONTENT);
    private static final long F4 = Key_androidKt.Key(Property.ALIGN_ITEMS);
    private static final long F5 = Key_androidKt.Key(Property.META_INFO);
    private static final long F6 = Key_androidKt.Key(Property.INLINE_VERTICAL_ALIGNMENT);
    private static final long F7 = Key_androidKt.Key(Property.ADD_MARKED_CONTENT_TEXT);
    private static final long F8 = Key_androidKt.Key(Property.COLUMN_COUNT);
    private static final long F9 = Key_androidKt.Key(Property.FLEX_DIRECTION);
    private static final long F10 = Key_androidKt.Key(Property.TREAT_AS_CONTINUOUS_CONTAINER);
    private static final long F11 = Key_androidKt.Key(Property.TREAT_AS_CONTINUOUS_CONTAINER_RESULT);
    private static final long F12 = Key_androidKt.Key(Property.COLUMN_WIDTH);
    private static final long NumLock = Key_androidKt.Key(Property.COLUMN_GAP);
    private static final long NumPad0 = Key_androidKt.Key(Property.COLUMN_GAP_BORDER);
    ...
    private static final long MediaRecord = Key_androidKt.Key(Property.ALIGN_CONTENT);
    ...
    private static final long MediaEject = Key_androidKt.Key(Property.ALIGN_SELF);
    private static final long MediaTopMenu = Key_androidKt.Key(226);
    private static final long MediaSkipForward = Key_androidKt.Key(TIFFConstants.TIFFTAG_MODEL);
    private static final long MediaSkipBackward = Key_androidKt.Key(TIFFConstants.TIFFTAG_STRIPOFFSETS);
    private static final long MediaStepForward = Key_androidKt.Key(TIFFConstants.TIFFTAG_ORIENTATION);
    ...
    private static final long TvInputComposite1 = Key_androidKt.Key(MetaDo.META_CREATEPALETTE);
    ...
    private static final long TvAudioDescriptionMixingVolumeDown = Key_androidKt.Key(TIFFConstants.TIFFTAG_SUBFILETYPE);
    ...
    public static String m5062toStringimpl(long arg0) {
        return "Key code: " + arg0;
    }

    public String toString() {
        return m5062toStringimpl(this.keyCode);
    }
}
