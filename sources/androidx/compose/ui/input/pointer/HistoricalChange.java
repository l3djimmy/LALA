...
public final class HistoricalChange {
    ...
    public final long m5436getPositionF1C5BW0() {
    ...
    public final long m5435getOriginalEventPositionF1C5BW0$ui_release() {
    ...
    public String toString() {
        return "HistoricalChange(uptimeMillis=" + this.uptimeMillis + ", position=" + ((Object) Offset.m4056toStringimpl(this.position)) + ')';
    }
}
