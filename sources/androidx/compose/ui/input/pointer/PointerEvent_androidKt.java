...
public final class PointerEvent_androidKt {
    ...
    public static final boolean m5472getAreAnyPressedaHzCxE(int $this$areAnyPressed) {
        return $this$areAnyPressed != 0;
    }

    /* renamed from: indexOfFirstPressed-aHzCx-E  reason: not valid java name */
    public static final int m5473indexOfFirstPressedaHzCxE(int $this$indexOfFirstPressed_u2daHzCx_u2dE) {
    ...
    public static final int m5474indexOfLastPressedaHzCxE(int $this$indexOfLastPressed_u2daHzCx_u2dE) {
        int index = -1;
