...
public final class InternalPointerEvent {
    ...
    public final boolean m5440activeHoverEvent0FcD4WY(long pointerId) {
        Object it$iv;
        ...
        while (true) {
            if (index$iv$iv < size) {
                ...
                if (PointerId.m5494equalsimpl0(it.m5526getIdJ3iCeTQ(), pointerId)) {
                    break;
                }
                index$iv$iv++;
            } else {
