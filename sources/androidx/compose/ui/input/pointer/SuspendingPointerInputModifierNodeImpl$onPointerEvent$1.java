    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                if (function2 == null) {
                    PointerInputEventHandler $this$invokeSuspend_u24lambda_u240 = suspendingPointerInputModifierNodeImpl.getPointerInputEventHandler();
                    this.label = 2;
                    if ($this$invokeSuspend_u24lambda_u240.invoke(this.this$0, this) != coroutine_suspended) {
                        break;
                    } else {
                    ...
                    this.label = 1;
                    if (function22.invoke(suspendingPointerInputModifierNodeImpl2, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
                break;
