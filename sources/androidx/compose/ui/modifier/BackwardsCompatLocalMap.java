...
public final class BackwardsCompatLocalMap extends ModifierLocalMap {
    ...
    public <T> T get$ui_release(ModifierLocal<T> modifierLocal) {
        boolean value$iv = modifierLocal == this.element.getKey();
        if (!value$iv) {
