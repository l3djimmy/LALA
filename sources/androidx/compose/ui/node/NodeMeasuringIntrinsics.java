...
public final class NodeMeasuringIntrinsics {
    ...
    public interface ApproachMeasureBlock {
        ...
        MeasureResult mo5615measure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j);
    }
    ...
    public interface MeasureBlock {
        /* renamed from: measure-3p2s80s */
        MeasureResult mo5804measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j);
    }
    ...
    public final int minWidth$ui_release(ApproachMeasureBlock measureBlock, ApproachIntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        ...
        MeasureResult layoutResult = measureBlock.mo5615measure3p2s80s(new ApproachIntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
    ...
    public final int minWidth$ui_release(MeasureBlock measureBlock, IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int h) {
        DefaultIntrinsicMeasurable measurable = new DefaultIntrinsicMeasurable(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width);
        long constraints = ConstraintsKt.Constraints$default(0, 0, 0, h, 7, null);
        MeasureResult layoutResult = measureBlock.mo5804measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), measurable, constraints);
        return layoutResult.getWidth();
    }
        ...
        public Placeable mo5637measureBRTryo0(long constraints) {
            ...
            if (intrinsicWidthHeight == intrinsicWidthHeight2) {
                ...
                if (intrinsicMinMax == intrinsicMinMax2) {
                    width = intrinsicMeasurable.maxIntrinsicWidth(Constraints.m6825getMaxHeightimpl(constraints));
                } else {
                    width = intrinsicMeasurable.minIntrinsicWidth(Constraints.m6825getMaxHeightimpl(constraints));
                }
                height2 = Constraints.m6821getHasBoundedHeightimpl(constraints) ? Constraints.m6825getMaxHeightimpl(constraints) : 32767;
            ...
            if (intrinsicMinMax == intrinsicMinMax3) {
                height = intrinsicMeasurable2.maxIntrinsicHeight(Constraints.m6826getMaxWidthimpl(constraints));
            } else {
                height = intrinsicMeasurable2.minIntrinsicHeight(Constraints.m6826getMaxWidthimpl(constraints));
            }
            height2 = Constraints.m6822getHasBoundedWidthimpl(constraints) ? Constraints.m6826getMaxWidthimpl(constraints) : 32767;
    ...
    private static final class EmptyPlaceable extends Placeable {
        public EmptyPlaceable(int width, int height) {
            m5699setMeasuredSizeozmzZPI(IntSize.m7039constructorimpl((width << 32) | (height & 4294967295L)));
        }
