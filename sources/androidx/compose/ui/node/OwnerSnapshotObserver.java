...
public final class OwnerSnapshotObserver {
    ...
    public final void observeLayoutSnapshotReads$ui_release(LayoutNode node, boolean affectsLookahead, Function0<Unit> function0) {
        if (affectsLookahead && node.getLookaheadRoot$ui_release() != null) {
            observeReads$ui_release(node, this.onCommitAffectingLookahead, function0);
        } else {
    ...
    public final void observeLayoutModifierSnapshotReads$ui_release(LayoutNode node, boolean affectsLookahead, Function0<Unit> function0) {
        if (affectsLookahead && node.getLookaheadRoot$ui_release() != null) {
            observeReads$ui_release(node, this.onCommitAffectingLayoutModifierInLookahead, function0);
        } else {
    ...
    public final void observeMeasureSnapshotReads$ui_release(LayoutNode node, boolean affectsLookahead, Function0<Unit> function0) {
        if (affectsLookahead && node.getLookaheadRoot$ui_release() != null) {
            observeReads$ui_release(node, this.onCommitAffectingLookaheadMeasure, function0);
        } else {
            observeReads$ui_release(node, this.onCommitAffectingMeasure, function0);
        }
    }

    public final void observeSemanticsReads$ui_release(LayoutNode node, Function0<Unit> function0) {
        observeReads$ui_release(node, this.onCommitAffectingSemantics, function0);
    }
