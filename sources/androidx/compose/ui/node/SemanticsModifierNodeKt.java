    ...
    public static final Rect touchBoundsInRoot(Modifier.Node $this$touchBoundsInRoot, boolean useMinimumTouchTarget) {
        if ($this$touchBoundsInRoot.getNode().isAttached()) {
            if (!useMinimumTouchTarget) {
                return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5759requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5898constructorimpl(8)));
            }
            return DelegatableNodeKt.m5759requireCoordinator64DMado($this$touchBoundsInRoot, NodeKind.m5898constructorimpl(8)).touchBoundsInRoot();
        }
