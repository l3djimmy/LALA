...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(ShaderBrush shaderBrush, float alpha) {
        ...
        this.alpha = alpha;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4105boximpl(Size.Companion.m4125getUnspecifiedNHjbRc()), null, 2, null);
        ...
        this.shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
            ...
            public final Shader invoke() {
                long $this$isUnspecified$iv = ShaderBrushSpan.this.m6627getSizeNHjbRc();
                if (($this$isUnspecified$iv == InlineClassHelperKt.UnspecifiedPackedFloats) || Size.m4119isEmptyimpl(ShaderBrushSpan.this.m6627getSizeNHjbRc())) {
                    return null;
                }
                return ShaderBrushSpan.this.getShaderBrush().mo4258createShaderuvyYCjk(ShaderBrushSpan.this.m6627getSizeNHjbRc());
            }
        });
    }

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    public final long m6627getSizeNHjbRc() {
        State $this$getValue$iv = this.size$delegate;
        return ((Size) $this$getValue$iv.getValue()).m4122unboximpl();
    }

    /* renamed from: setSize-uvyYCjk  reason: not valid java name */
    public final void m6628setSizeuvyYCjk(long j) {
