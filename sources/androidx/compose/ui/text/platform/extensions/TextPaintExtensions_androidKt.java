...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint $this$applySpanStyle, SpanStyle style, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean requiresLetterSpacing) {
        long m7066getTypeUIouoOA = TextUnit.m7066getTypeUIouoOA(style.m6281getFontSizeXSAIIZE());
        if (TextUnitType.m7095equalsimpl0(m7066getTypeUIouoOA, TextUnitType.Companion.m7100getSpUIouoOA())) {
            $this$applySpanStyle.setTextSize(density.mo643toPxR2X_6o(style.m6281getFontSizeXSAIIZE()));
        } else if (TextUnitType.m7095equalsimpl0(m7066getTypeUIouoOA, TextUnitType.Companion.m7099getEmUIouoOA())) {
            $this$applySpanStyle.setTextSize($this$applySpanStyle.getTextSize() * TextUnit.m7067getValueimpl(style.m6281getFontSizeXSAIIZE()));
        }
        if (hasFontAttributes(style)) {
            ...
            $this$applySpanStyle.setTypeface(function4.invoke(fontFamily, fontWeight, m6447boximpl, FontSynthesis.m6458boximpl(m6283getFontSynthesisZQGJjVo != null ? m6283getFontSynthesisZQGJjVo.m6466unboximpl() : FontSynthesis.Companion.m6467getAllGVVA2EU())));
        }
        ...
        $this$applySpanStyle.m6607setColor8_81llA(style.m6280getColor0d7_KjU());
        $this$applySpanStyle.m6605setBrush12SF9DM(style.getBrush(), Size.Companion.m4125getUnspecifiedNHjbRc(), style.getAlpha());
        ...
        if (TextUnitType.m7095equalsimpl0(TextUnit.m7066getTypeUIouoOA(style.m6284getLetterSpacingXSAIIZE()), TextUnitType.Companion.m7100getSpUIouoOA())) {
            if (!(TextUnit.m7067getValueimpl(style.m6284getLetterSpacingXSAIIZE()) == 0.0f)) {
                float emWidth = $this$applySpanStyle.getTextSize() * $this$applySpanStyle.getTextScaleX();
                float letterSpacingPx = density.mo643toPxR2X_6o(style.m6284getLetterSpacingXSAIIZE());
                if (!(emWidth == 0.0f)) {
                    $this$applySpanStyle.setLetterSpacing(letterSpacingPx / emWidth);
                }
                return m6622generateFallbackSpanStyle62GTOB8(style.m6284getLetterSpacingXSAIIZE(), requiresLetterSpacing, style.m6278getBackground0d7_KjU(), style.m6279getBaselineShift5SSeXJ0());
            }
        }
        if (TextUnitType.m7095equalsimpl0(TextUnit.m7066getTypeUIouoOA(style.m6284getLetterSpacingXSAIIZE()), TextUnitType.Companion.m7099getEmUIouoOA())) {
            $this$applySpanStyle.setLetterSpacing(TextUnit.m7067getValueimpl(style.m6284getLetterSpacingXSAIIZE()));
        }
        return m6622generateFallbackSpanStyle62GTOB8(style.m6284getLetterSpacingXSAIIZE(), requiresLetterSpacing, style.m6278getBackground0d7_KjU(), style.m6279getBaselineShift5SSeXJ0());
    }

    /* JADX WARN: Code restructure failed: missing block: B:21:0x0053, code lost:
        if (androidx.compose.ui.text.style.BaselineShift.m6632equalsimpl0(r36.m6635unboximpl(), androidx.compose.ui.text.style.BaselineShift.Companion.m6639getNoney9eOQZs()) == false) goto L18;
     */
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m6622generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L26
            long r4 = androidx.compose.ui.unit.TextUnit.m7066getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.Companion
            long r6 = r6.m7100getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m7095equalsimpl0(r4, r6)
            if (r4 == 0) goto L26
            float r4 = androidx.compose.ui.unit.TextUnit.m7067getValueimpl(r31)
            r5 = 0
        ...
        L27:
            ...
            long r5 = r5.m4325getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4290equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.Companion
            long r5 = r5.m4324getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m4290equalsimpl0(r0, r5)
            if (r5 != 0) goto L42
            r5 = r2
            goto L43
        ...
        L43:
            ...
            float r6 = r6.m6639getNoney9eOQZs()
            float r7 = r36.m6635unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m6632equalsimpl0(r7, r6)
            if (r6 != 0) goto L56
            goto L57
        L56:
            r2 = r3
        ...
        L64:
            ...
            long r6 = r6.m7078getUnspecifiedXSAIIZE()
            r18 = r6
        L6c:
            if (r5 == 0) goto L72
            r23 = r0
        ...
        L72:
            ...
            long r6 = r6.m4325getUnspecified0d7_KjU()
            r23 = r6
        L7a:
            if (r2 == 0) goto L80
            r20 = r36
        ...
        La9:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m6622generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint $this$setTextMotion, TextMotion textMotion) {
        ...
        int m6785getLinearity4e0Vf04$ui_text_release = finalTextMotion.m6785getLinearity4e0Vf04$ui_text_release();
        if (TextMotion.Linearity.m6789equalsimpl0(m6785getLinearity4e0Vf04$ui_text_release, TextMotion.Linearity.Companion.m6794getLinear4e0Vf04())) {
            $this$setTextMotion.setFlags($this$setTextMotion.getFlags() | 64);
            $this$setTextMotion.setHinting(0);
        } else if (TextMotion.Linearity.m6789equalsimpl0(m6785getLinearity4e0Vf04$ui_text_release, TextMotion.Linearity.Companion.m6793getFontHinting4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(1);
        } else if (TextMotion.Linearity.m6789equalsimpl0(m6785getLinearity4e0Vf04$ui_text_release, TextMotion.Linearity.Companion.m6795getNone4e0Vf04())) {
            $this$setTextMotion.getFlags();
            $this$setTextMotion.setHinting(0);
        } else {
            $this$setTextMotion.getFlags();
    ...
    public static final boolean hasFontAttributes(SpanStyle $this$hasFontAttributes) {
        return ($this$hasFontAttributes.getFontFamily() == null && $this$hasFontAttributes.m6282getFontStyle4Lr2A7w() == null && $this$hasFontAttributes.getFontWeight() == null) ? false : true;
    }
