...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6402getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int fontStyle) {
        boolean isBold = fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0;
        boolean isItalic = FontStyle.m6450equalsimpl0(fontStyle, FontStyle.Companion.m6456getItalic_LCdwA());
