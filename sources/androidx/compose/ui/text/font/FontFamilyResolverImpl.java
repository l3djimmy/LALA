...
public final class FontFamilyResolverImpl implements FontFamily.Resolver {
    ...
    public FontFamilyResolverImpl(PlatformFontLoader platformFontLoader, PlatformResolveInterceptor platformResolveInterceptor, TypefaceRequestCache typefaceRequestCache, FontListFontFamilyTypefaceAdapter fontListFontFamilyTypefaceAdapter, PlatformFontFamilyTypefaceAdapter platformFamilyTypefaceAdapter) {
        ...
        this.createDefaultTypeface = new Function1<TypefaceRequest, Object>() { // from class: androidx.compose.ui.text.font.FontFamilyResolverImpl$createDefaultTypeface$1
            ...
            public final Object invoke(TypefaceRequest it) {
                State resolve;
                resolve = FontFamilyResolverImpl.this.resolve(TypefaceRequest.m6491copye1PVR60$default(it, null, null, 0, 0, null, 30, null));
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0080 A[LOOP:0: B:22:0x007e->B:23:0x0080, LOOP_END] */
    ...
    */
    ...
    public State<Object> mo6423resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        return resolve(new TypefaceRequest(this.platformResolveInterceptor.interceptFontFamily(fontFamily), this.platformResolveInterceptor.interceptFontWeight(fontWeight), this.platformResolveInterceptor.m6475interceptFontStyleT2F_aPo(fontStyle), this.platformResolveInterceptor.m6476interceptFontSynthesisMscr08Y(fontSynthesis), this.platformFontLoader.getCacheKey(), null));
    }
