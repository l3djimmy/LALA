...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public final int mo6403getStyle_LCdwA() {
        return this.style;
    }

    private AndroidPreloadedFont(FontWeight weight, int style, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.Companion.m6442getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, variationSettings, null);
        this.weight = weight;
        this.style = style;
    }
