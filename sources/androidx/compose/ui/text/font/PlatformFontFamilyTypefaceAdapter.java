...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            result = this.platformTypefaceResolver.mo6477createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m6495getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            result = this.platformTypefaceResolver.mo6478createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m6495getFontStyle_LCdwA());
            ...
            result = ((AndroidTypeface) typeface).mo6590getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m6495getFontStyle_LCdwA(), typefaceRequest.m6496getFontSynthesisGVVA2EU());
        }
