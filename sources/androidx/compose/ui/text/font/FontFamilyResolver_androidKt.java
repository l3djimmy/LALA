...
public final class FontFamilyResolver_androidKt {
    ...
    public static /* synthetic */ State m6425resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.Companion.m6467getAllGVVA2EU();
        }
        return m6424resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* renamed from: resolveAsTypeface-Wqqsr6A  reason: not valid java name */
    public static final State<android.graphics.Typeface> m6424resolveAsTypefaceWqqsr6A(FontFamily.Resolver $this$resolveAsTypeface_u2dWqqsr6A, FontFamily fontFamily, FontWeight fontWeight, int fontStyle, int fontSynthesis) {
        State mo6423resolveDPcqOEQ = $this$resolveAsTypeface_u2dWqqsr6A.mo6423resolveDPcqOEQ(fontFamily, fontWeight, fontStyle, fontSynthesis);
        Intrinsics.checkNotNull(mo6423resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return mo6423resolveDPcqOEQ;
    }
}
