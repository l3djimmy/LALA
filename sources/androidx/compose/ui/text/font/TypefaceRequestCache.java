...
public final class TypefaceRequestCache {
    ...
    public final State<Object> runCached(final TypefaceRequest typefaceRequest, Function1<? super Function1<? super TypefaceResult, Unit>, ? extends TypefaceResult> function1) {
        ...
        synchronized (lock$iv) {
            ...
            try {
                TypefaceResult currentTypefaceResult = function1.invoke(new Function1<TypefaceResult, Unit>() { // from class: androidx.compose.ui.text.font.TypefaceRequestCache$runCached$currentTypefaceResult$1
    ...
    public final void preWarmCache(List<TypefaceRequest> list, Function1<? super TypefaceRequest, ? extends TypefaceResult> function1) {
        ...
        for (int i = 0; i < size; i++) {
            TypefaceRequest typeRequest = list.get(i);
            SynchronizedObject lock$iv = this.lock;
            synchronized (lock$iv) {
            ...
            if (prior == null) {
                try {
                    TypefaceResult next = function1.invoke(typeRequest);
