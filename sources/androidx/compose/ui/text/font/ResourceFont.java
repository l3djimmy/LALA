...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m6488getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    */
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        Ld:
            ...
            int r10 = r9.m6457getNormal_LCdwA()
            r3 = r10
            goto L1a
        L19:
            r3 = r10
        L1a:
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m6472Settings6EWAqTQ(r2, r3, r10)
            r4 = r11
            goto L2a
        L29:
            r4 = r11
        L2a:
            ...
            int r12 = r9.m6441getAsyncPKNRLFQ()
            r5 = r12
            goto L37
        L36:
            r5 = r12
    ...
    public int mo6395getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m6487copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.mo6403getStyle_LCdwA();
        }
        return resourceFont.m6490copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m6490copyRetOiIg(int resId, FontWeight weight, int style) {
        return m6486copyF3nL8kk$default(this, resId, weight, style, mo6395getLoadingStrategyPKNRLFQ(), null, 16, null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m6486copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = resourceFont.mo6395getLoadingStrategyPKNRLFQ();
        }
        return resourceFont.m6489copyF3nL8kk(i, fontWeight, i2, i3, (i4 & 16) != 0 ? resourceFont.variationSettings : settings);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m6489copyF3nL8kk(int resId, FontWeight weight, int style, int loadingStrategy, FontVariation.Settings variationSettings) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ResourceFont) && this.resId == ((ResourceFont) other).resId && Intrinsics.areEqual(getWeight(), ((ResourceFont) other).getWeight()) && FontStyle.m6450equalsimpl0(mo6403getStyle_LCdwA(), ((ResourceFont) other).mo6403getStyle_LCdwA()) && Intrinsics.areEqual(this.variationSettings, ((ResourceFont) other).variationSettings) && FontLoadingStrategy.m6437equalsimpl0(mo6395getLoadingStrategyPKNRLFQ(), ((ResourceFont) other).mo6395getLoadingStrategyPKNRLFQ());
    }

    public int hashCode() {
        int result = this.resId;
        return (((((((result * 31) + getWeight().hashCode()) * 31) + FontStyle.m6451hashCodeimpl(mo6403getStyle_LCdwA())) * 31) + FontLoadingStrategy.m6438hashCodeimpl(mo6395getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m6452toStringimpl(mo6403getStyle_LCdwA())) + ", loadingStrategy=" + ((Object) FontLoadingStrategy.m6439toStringimpl(mo6395getLoadingStrategyPKNRLFQ())) + ')';
    }
}
