...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m6491copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i4 = i;
        return typefaceRequest.m6494copye1PVR60(fontFamily, fontWeight, i4, i2, obj3);
    }
    ...
    public final int m6492component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m6493component4GVVA2EU() {
    ...
    public final TypefaceRequest m6494copye1PVR60(FontFamily fontFamily, FontWeight fontWeight, int i, int i2, Object obj) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TypefaceRequest) {
            ...
            return Intrinsics.areEqual(this.fontFamily, typefaceRequest.fontFamily) && Intrinsics.areEqual(this.fontWeight, typefaceRequest.fontWeight) && FontStyle.m6450equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m6461equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
        }
        return false;
    }

    public int hashCode() {
        return ((((((((this.fontFamily == null ? 0 : this.fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m6451hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m6462hashCodeimpl(this.fontSynthesis)) * 31) + (this.resourceLoaderCacheKey != null ? this.resourceLoaderCacheKey.hashCode() : 0);
    }

    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m6452toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m6465toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m6495getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m6496getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
