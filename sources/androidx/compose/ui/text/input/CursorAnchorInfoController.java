...
public final class CursorAnchorInfoController {
    ...
    private Function1<? super Matrix, Unit> textFieldToRootTransform = new Function1<Matrix, Unit>() { // from class: androidx.compose.ui.text.input.CursorAnchorInfoController$textFieldToRootTransform$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
            m6498invoke58bKbWc(matrix.m4542unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-58bKbWc  reason: not valid java name */
        public final void m6498invoke58bKbWc(float[] it) {
        }
    };
    ...
    public final void updateTextLayoutResult(TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Function1<? super Matrix, Unit> function1, Rect innerTextFieldBounds, Rect decorationBoxBounds) {
        synchronized (this.lock) {
    ...
    public final void invalidate() {
        synchronized (this.lock) {
            ...
            this.textFieldToRootTransform = new Function1<Matrix, Unit>() { // from class: androidx.compose.ui.text.input.CursorAnchorInfoController$invalidate$1$1
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                    m6497invoke58bKbWc(matrix.m4542unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-58bKbWc  reason: not valid java name */
                public final void m6497invoke58bKbWc(float[] it) {
                }
            };
    ...
    private final void updateCursorAnchorInfo() {
        if (this.inputMethodManager.isActive()) {
            this.textFieldToRootTransform.invoke(Matrix.m4517boximpl(this.matrix));
            this.rootPositionCalculator.mo5441localToScreen58bKbWc(this.matrix);
