...
public final class TextGranularity {
    ...
    private static final int Character = m6295constructorimpl(0);
    private static final int Word = m6295constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextGranularity m6294boximpl(int i) {
        return new TextGranularity(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m6295constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6296equalsimpl(int i, Object obj) {
        return (obj instanceof TextGranularity) && i == ((TextGranularity) obj).m6300unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m6297equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m6298hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6299toStringimpl(int i) {
        return "TextGranularity(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m6296equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m6298hashCodeimpl(this.value);
    }

    public String toString() {
        return m6299toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m6300unboximpl() {
        return this.value;
    }
