...
public final class TextLayoutInput {
    ...
    public final int m6306getOverflowgIe3tQ8() {
    ...
    public final long m6305getConstraintsmsEJaDk() {
    ...
    public static /* synthetic */ TextLayoutInput m6303copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        boolean z2 = z;
        return textLayoutInput.m6304copyhu1Yfo(annotatedString, textStyle, list2, i, z2, i2, density2, layoutDirection2, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m6304copyhu1Yfo(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int maxLines, boolean softWrap, int overflow, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long constraints) {
        return new TextLayoutInput(text, style, list, maxLines, softWrap, overflow, density, layoutDirection, resourceLoader, this.fontFamilyResolver, constraints);
    }
