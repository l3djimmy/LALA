...
public final class TextMotion {
    ...
    private static final TextMotion Static = new TextMotion(Linearity.Companion.m6793getFontHinting4e0Vf04(), false, null);
    private static final TextMotion Animated = new TextMotion(Linearity.Companion.m6794getLinear4e0Vf04(), true, null);
    ...
    public final int m6785getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m6783copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m6784copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m6784copyJdDtMQo$ui_text_release(int linearity, boolean subpixelTextPositioning) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TextMotion) && Linearity.m6789equalsimpl0(this.linearity, ((TextMotion) other).linearity) && this.subpixelTextPositioning == ((TextMotion) other).subpixelTextPositioning;
    }

    public int hashCode() {
        int result = Linearity.m6790hashCodeimpl(this.linearity);
    ...
    public static final class Linearity {
        ...
        public static final Companion Companion = new Companion(null);
        private static final int Linear = m6787constructorimpl(1);
        private static final int FontHinting = m6787constructorimpl(2);
        private static final int None = m6787constructorimpl(3);

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m6786boximpl(int i) {
            return new Linearity(i);
        }

        /* renamed from: constructor-impl  reason: not valid java name */
        private static int m6787constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl  reason: not valid java name */
        public static boolean m6788equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m6792unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m6789equalsimpl0(int i, int i2) {
            return i == i2;
        }

        /* renamed from: hashCode-impl  reason: not valid java name */
        public static int m6790hashCodeimpl(int i) {
        ...
        public int hashCode() {
            return m6790hashCodeimpl(this.value);
        }

        /* renamed from: unbox-impl  reason: not valid java name */
        public final /* synthetic */ int m6792unboximpl() {
            return this.value;
        }
        ...
        public static final class Companion {
            ...
            public final int m6794getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m6793getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m6795getNone4e0Vf04() {
        ...
        public String toString() {
            return m6791toStringimpl(this.value);
        }

        /* renamed from: toString-impl  reason: not valid java name */
        public static String m6791toStringimpl(int arg0) {
            return m6789equalsimpl0(arg0, Linear) ? "Linearity.Linear" : m6789equalsimpl0(arg0, FontHinting) ? "Linearity.FontHinting" : m6789equalsimpl0(arg0, None) ? "Linearity.None" : "Invalid";
        }
    }
}
