...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6985toSp0xMU5do(FontScaling $this, float $receiver) {
            return FontScaling.super.mo646toSp0xMU5do($receiver);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m6984toDpGaN1DYA(FontScaling $this, long $receiver) {
            return FontScaling.super.mo639toDpGaN1DYA($receiver);
        }
    }
    ...
    default float mo639toDpGaN1DYA(long $this$toDp_u2dGaN1DYA) {
        ...
        FontScaleConverter converter = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        float m7067getValueimpl = TextUnit.m7067getValueimpl($this$toDp_u2dGaN1DYA);
        return Dp.m6873constructorimpl(converter == null ? m7067getValueimpl * getFontScale() : converter.convertSpToDp(m7067getValueimpl));
    }
}
