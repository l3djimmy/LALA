...
public abstract class ColorSpace {
    ...
    public final long m4705getModelxdoWZVw() {
        return this.model;
    }
    ...
    public final int getComponentCount() {
        return ColorModel.m4697getComponentCountimpl(this.model);
    }
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] xyz = new float[ColorModel.m4697getComponentCountimpl(this.model)];
        xyz[0] = x;
        xyz[1] = y;
        xyz[2] = z;
        return fromXyz(xyz);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m4699toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == that.id && Intrinsics.areEqual(this.name, that.name)) {
            return ColorModel.m4696equalsimpl0(this.model, that.model);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((result * 31) + ColorModel.m4698hashCodeimpl(this.model)) * 31) + this.id;
    }

    /* compiled from: ColorSpace.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0080T¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"Landroidx/compose/ui/graphics/colorspace/ColorSpace$Companion;", "", "()V", "MaxId", "", "MinId", "ui-graphics_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes11.dex */
