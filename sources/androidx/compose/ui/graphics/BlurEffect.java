    ...
    */
    public /* synthetic */ BlurEffect(androidx.compose.ui.graphics.RenderEffect r7, float r8, float r9, int r10, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        Lc:
            ...
            int r10 = r9.m4662getClamp3opZhB0()
            r4 = r10
            goto L15
        L14:
            r4 = r10
    ...
    protected android.graphics.RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m4599createBlurEffect8A3gB4(this.renderEffect, this.radiusX, this.radiusY, this.edgeTreatment);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof BlurEffect) {
            if (this.radiusX == ((BlurEffect) other).radiusX) {
                return ((this.radiusY > ((BlurEffect) other).radiusY ? 1 : (this.radiusY == ((BlurEffect) other).radiusY ? 0 : -1)) == 0) && TileMode.m4658equalsimpl0(this.edgeTreatment, ((BlurEffect) other).edgeTreatment) && Intrinsics.areEqual(this.renderEffect, ((BlurEffect) other).renderEffect);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + Float.hashCode(this.radiusX)) * 31) + Float.hashCode(this.radiusY)) * 31) + TileMode.m4659hashCodeimpl(this.edgeTreatment);
    }

    public String toString() {
        return "BlurEffect(renderEffect=" + this.renderEffect + ", radiusX=" + this.radiusX + ", radiusY=" + this.radiusY + ", edgeTreatment=" + ((Object) TileMode.m4660toStringimpl(this.edgeTreatment)) + ')';
    }
}
