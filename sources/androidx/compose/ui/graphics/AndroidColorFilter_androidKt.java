...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m4155actualTintColorFilterxETnrds(long color, int blendMode) {
        if (Build.VERSION.SDK_INT >= 29) {
            android.graphics.ColorFilter androidColorFilter = BlendModeColorFilterHelper.INSTANCE.m4235BlendModeColorFilterxETnrds(color, blendMode);
            return androidColorFilter;
        }
        android.graphics.ColorFilter androidColorFilter2 = new PorterDuffColorFilter(ColorKt.m4343toArgb8_81llA(color), AndroidBlendMode_androidKt.m4141toPorterDuffModes9anfk8(blendMode));
        return androidColorFilter2;
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final android.graphics.ColorFilter m4153actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        return new android.graphics.ColorMatrixColorFilter(colorMatrix);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final android.graphics.ColorFilter m4154actualLightingColorFilterOWjLjI(long multiply, long add) {
        return new android.graphics.LightingColorFilter(ColorKt.m4343toArgb8_81llA(multiply), ColorKt.m4343toArgb8_81llA(add));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter filter) {
        if ((filter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4368getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) filter);
        }
