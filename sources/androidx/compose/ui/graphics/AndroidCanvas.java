...
public final class AndroidCanvas implements Canvas {
    ...
    public void mo4144concat58bKbWc(float[] matrix) {
        if (!MatrixKt.m4544isIdentity58bKbWc(matrix)) {
            android.graphics.Matrix frameworkMatrix = new android.graphics.Matrix();
            AndroidMatrixConversions_androidKt.m4159setFromEL8BTi8(frameworkMatrix, matrix);
    ...
    public void mo4143clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m4152toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void mo4142clipPathmtrdDE(Path path, int clipOp) {
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m4152toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m4152toRegionOp7u2Bmg(int $this$toRegionOp_u2d_u2d7u2Bmg) {
        return ClipOp.m4273equalsimpl0($this$toRegionOp_u2d_u2d7u2Bmg, ClipOp.Companion.m4277getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g  reason: not valid java name */
    public void mo4148drawLineWko1d7g(long p1, long p2, Paint paint) {
    ...
    public void mo4145drawCircle9KIMszo(long center, float radius, Paint paint) {
    ...
    public void mo4146drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
    ...
    public void mo4147drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u240.left = IntOffset.m7001getXimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.top = IntOffset.m7002getYimpl(srcOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u240.right = IntOffset.m7001getXimpl(srcOffset) + ((int) (srcSize >> 32));
        $this$drawImageRect_HPBpro0_u24lambda_u240.bottom = IntOffset.m7002getYimpl(srcOffset) + ((int) (srcSize & 4294967295L));
        ...
        $this$drawImageRect_HPBpro0_u24lambda_u241.left = IntOffset.m7001getXimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.top = IntOffset.m7002getYimpl(dstOffset);
        $this$drawImageRect_HPBpro0_u24lambda_u241.right = IntOffset.m7001getXimpl(dstOffset) + ((int) (dstSize >> 32));
        $this$drawImageRect_HPBpro0_u24lambda_u241.bottom = IntOffset.m7002getYimpl(dstOffset) + ((int) (dstSize & 4294967295L));
    ...
    public void mo4149drawPointsO7TthRY(int pointMode, List<Offset> list, Paint paint) {
        if (!PointMode.m4590equalsimpl0(pointMode, PointMode.Companion.m4594getLinesr_lszbg())) {
            if (!PointMode.m4590equalsimpl0(pointMode, PointMode.Companion.m4596getPolygonr_lszbg())) {
                if (PointMode.m4590equalsimpl0(pointMode, PointMode.Companion.m4595getPointsr_lszbg())) {
    ...
    private final void drawPoints(List<Offset> list, Paint paint) {
        ...
        while (index$iv < size) {
            ...
            long point = ((Offset) item$iv).m4058unboximpl();
    ...
    private final void drawLines(List<Offset> list, Paint paint, int stepBy) {
        ...
        if (list2.size() >= 2) {
            android.graphics.Paint frameworkPaint = paint.asFrameworkPaint();
            int i = 0;
            while (i < list2.size() - 1) {
                long p1 = list2.get(i).m4058unboximpl();
                long p2 = list2.get(i + 1).m4058unboximpl();
                android.graphics.Canvas canvas = this.internalCanvas;
                int bits$iv$iv$iv = (int) (p1 >> 32);
    ...
    public void mo4150drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
    ...
    public void mo4151drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m4195toAndroidVertexModeJOOmi9M(vertices.m4691getVertexModec2xauaI()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.asFrameworkPaint());
    }
}
