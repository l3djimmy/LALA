...
public final class AndroidPath implements Path {
    ...
    public int mo4180getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.Companion.m4571getEvenOddRgk1Os();
        }
        return PathFillType.Companion.m4572getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U  reason: not valid java name */
    public void mo4182setFillTypeoQ8Xj4U(int value) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m4567equalsimpl0(value, PathFillType.Companion.m4571getEvenOddRgk1Os())) {
    ...
    public void mo4179addPathUv8p0NA(Path path, long offset) {
    ...
    public void mo4184translatek4lQ0M(long offset) {
    ...
    public void mo4183transform58bKbWc(float[] matrix) {
        if (this.mMatrix == null) {
            this.mMatrix = new android.graphics.Matrix();
        }
        android.graphics.Matrix matrix2 = this.mMatrix;
        Intrinsics.checkNotNull(matrix2);
        AndroidMatrixConversions_androidKt.m4159setFromEL8BTi8(matrix2, matrix);
        android.graphics.Path path = this.internalPath;
        android.graphics.Matrix matrix3 = this.mMatrix;
        Intrinsics.checkNotNull(matrix3);
        path.transform(matrix3);
    ...
    public boolean mo4181opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        if (PathOperation.m4577equalsimpl0(operation, PathOperation.Companion.m4581getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m4577equalsimpl0(operation, PathOperation.Companion.m4582getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m4577equalsimpl0(operation, PathOperation.Companion.m4583getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m4577equalsimpl0(operation, PathOperation.Companion.m4584getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
