...
public final class TileMode {
    ...
    private static final int Clamp = m4656constructorimpl(0);
    private static final int Repeated = m4656constructorimpl(1);
    private static final int Mirror = m4656constructorimpl(2);
    private static final int Decal = m4656constructorimpl(3);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TileMode m4655boximpl(int i) {
    ...
    public static boolean m4657equalsimpl(int i, Object obj) {
        return (obj instanceof TileMode) && i == ((TileMode) obj).m4661unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m4657equalsimpl(this.value, obj);
    }
    ...
    public final /* synthetic */ int m4661unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m4662getClamp3opZhB0() {
            return TileMode.Clamp;
        }

        /* renamed from: getRepeated-3opZhB0  reason: not valid java name */
        public final int m4665getRepeated3opZhB0() {
            return TileMode.Repeated;
        }

        /* renamed from: getMirror-3opZhB0  reason: not valid java name */
        public final int m4664getMirror3opZhB0() {
            return TileMode.Mirror;
        }

        /* renamed from: getDecal-3opZhB0  reason: not valid java name */
        public final int m4663getDecal3opZhB0() {
    ...
    public static String m4660toStringimpl(int arg0) {
        return m4658equalsimpl0(arg0, Clamp) ? "Clamp" : m4658equalsimpl0(arg0, Repeated) ? "Repeated" : m4658equalsimpl0(arg0, Mirror) ? "Mirror" : m4658equalsimpl0(arg0, Decal) ? "Decal" : "Unknown";
    }
}
