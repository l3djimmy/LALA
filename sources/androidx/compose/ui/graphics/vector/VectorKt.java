...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.Companion.m4642getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.Companion.m4653getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.Companion.m4229getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.Companion.m4324getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.Companion.m4572getNonZeroRgk1Os();
    ...
    public static final boolean m4991rgbEqualOWjLjI(long $this$rgbEqual_u2d_u2dOWjLjI, long other) {
        if (Color.m4295getRedimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4295getRedimpl(other)) {
            if (Color.m4294getGreenimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4294getGreenimpl(other)) {
                if (Color.m4292getBlueimpl($this$rgbEqual_u2d_u2dOWjLjI) == Color.m4292getBlueimpl(other)) {
                    return true;
                }
            }
        }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter $this$tintableWithAlphaMask) {
        return $this$tintableWithAlphaMask instanceof BlendModeColorFilter ? BlendMode.m4200equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).m4233getBlendMode0nO6VwU(), BlendMode.Companion.m4229getSrcIn0nO6VwU()) || BlendMode.m4200equalsimpl0(((BlendModeColorFilter) $this$tintableWithAlphaMask).m4233getBlendMode0nO6VwU(), BlendMode.Companion.m4231getSrcOver0nO6VwU()) : $this$tintableWithAlphaMask == null;
    }
}
