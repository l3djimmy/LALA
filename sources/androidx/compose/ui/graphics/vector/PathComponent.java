...
public final class PathComponent extends VNode {
    ...
    public final int m4978getPathFillTypeRgk1Os() {
        return this.pathFillType;
    }

    /* renamed from: setPathFillType-oQ8Xj4U  reason: not valid java name */
    public final void m4981setPathFillTypeoQ8Xj4U(int value) {
        this.pathFillType = value;
        this.renderPath.mo4182setFillTypeoQ8Xj4U(value);
        invalidate();
    }
    ...
    public final int m4979getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: setStrokeLineCap-BeK7IIE  reason: not valid java name */
    public final void m4982setStrokeLineCapBeK7IIE(int value) {
    ...
    public final int m4980getStrokeLineJoinLxFBmk8() {
        return this.strokeLineJoin;
    }

    /* renamed from: setStrokeLineJoin-Ww9F2mQ  reason: not valid java name */
    public final void m4983setStrokeLineJoinWw9F2mQ(int value) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int fillType = this.renderPath.mo4180getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo4182setFillTypeoQ8Xj4U(fillType);
        }
    ...
    public void draw(DrawScope $this$draw) {
        ...
        Brush it = this.fill;
        if (it != null) {
            DrawScope.m4829drawPathGBMwjPU$default($this$draw, this.renderPath, it, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (it2 != null) {
            ...
            DrawScope.m4829drawPathGBMwjPU$default($this$draw, this.renderPath, it2, this.strokeAlpha, targetStroke, null, 0, 48, null);
        }
    }
