...
public final class ImageVector {
    ...
    */
    ...
    public final float m4971getDefaultWidthD9Ej5fM() {
        return this.defaultWidth;
    }

    /* renamed from: getDefaultHeight-D9Ej5fM  reason: not valid java name */
    public final float m4970getDefaultHeightD9Ej5fM() {
    ...
    public final long m4973getTintColor0d7_KjU() {
        return this.tintColor;
    }

    /* renamed from: getTintBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4972getTintBlendMode0nO6VwU() {
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m4325getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m4229getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f, float f2, float f3, float f4, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f, f2, f3, f4, (i2 & 32) != 0 ? Color.Companion.m4325getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.Companion.m4229getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }
        ...
        public static /* synthetic */ Builder addGroup$default(Builder builder, String str, float f, float f2, float f3, float f4, float f5, float f6, float f7, List list, int i, Object obj) {
            ...
            List<PathNode> emptyPath = (i & 256) != 0 ? VectorKt.getEmptyPath() : list;
            return builder.addGroup(str, f, f2, f3, f4, f5, f6, f7, emptyPath);
        }

        public final Builder addGroup(String name, float rotate, float pivotX, float pivotY, float scaleX, float scaleY, float translationX, float translationY, List<? extends PathNode> list) {
            ensureNotConsumed();
            GroupParams group = new GroupParams(name, rotate, pivotX, pivotY, scaleX, scaleY, translationX, translationY, list, null, 512, null);
        ...
        public final Builder m4975addPathoIyEayM(List<? extends PathNode> list, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
            ensureNotConsumed();
            getCurrentGroup().getChildren().add(new VectorPath(name, list, pathFillType, fill, fillAlpha, stroke, strokeAlpha, strokeLineWidth, strokeLineCap, strokeLineJoin, strokeLineMiter, trimPathStart, trimPathEnd, trimPathOffset, null));
            return this;
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImageVector) && Intrinsics.areEqual(this.name, ((ImageVector) other).name) && Dp.m6878equalsimpl0(this.defaultWidth, ((ImageVector) other).defaultWidth) && Dp.m6878equalsimpl0(this.defaultHeight, ((ImageVector) other).defaultHeight)) {
            if (this.viewportWidth == ((ImageVector) other).viewportWidth) {
                return ((this.viewportHeight > ((ImageVector) other).viewportHeight ? 1 : (this.viewportHeight == ((ImageVector) other).viewportHeight ? 0 : -1)) == 0) && Intrinsics.areEqual(this.root, ((ImageVector) other).root) && Color.m4290equalsimpl0(this.tintColor, ((ImageVector) other).tintColor) && BlendMode.m4200equalsimpl0(this.tintBlendMode, ((ImageVector) other).tintBlendMode) && this.autoMirror == ((ImageVector) other).autoMirror;
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        return (((((((((((((((result * 31) + Dp.m6879hashCodeimpl(this.defaultWidth)) * 31) + Dp.m6879hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m4296hashCodeimpl(this.tintColor)) * 31) + BlendMode.m4201hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
