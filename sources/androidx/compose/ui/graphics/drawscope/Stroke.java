...
public final class Stroke extends DrawStyle {
    ...
    public final int m4909getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m4910getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m4911getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m4912getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof Stroke) {
            if (this.width == ((Stroke) other).width) {
                return ((this.miter > ((Stroke) other).miter ? 1 : (this.miter == ((Stroke) other).miter ? 0 : -1)) == 0) && StrokeCap.m4638equalsimpl0(this.cap, ((Stroke) other).cap) && StrokeJoin.m4648equalsimpl0(this.join, ((Stroke) other).join) && Intrinsics.areEqual(this.pathEffect, ((Stroke) other).pathEffect);
            }
            return false;
        }
        return false;
    ...
    public int hashCode() {
        ...
        int result2 = ((((((result * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4639hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4649hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return result2 + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4640toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m4650toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
