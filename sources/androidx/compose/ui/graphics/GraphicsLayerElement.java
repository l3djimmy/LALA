...
public final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public static /* synthetic */ GraphicsLayerElement m4436copyJVvOYNQ$default(GraphicsLayerElement graphicsLayerElement, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i, int i2, Object obj) {
        int i3;
        long j4;
        ...
        return graphicsLayerElement.m4441copyJVvOYNQ(f21, f12, f13, f14, f15, f16, f17, f18, f19, f20, j5, shape2, z2, renderEffect2, j6, j4, i3);
    }
    ...
    public final long m4437component11SzJe1aQ() {
    ...
    public final long m4438component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU  reason: not valid java name */
    public final long m4439component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI  reason: not valid java name */
    public final int m4440component17NrFUSI() {
    ...
    public final GraphicsLayerElement m4441copyJVvOYNQ(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, long j, Shape shape, boolean z, RenderEffect renderEffect, long j2, long j3, int i) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((((((((((((((((((((((((Float.hashCode(this.scaleX) * 31) + Float.hashCode(this.scaleY)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.translationX)) * 31) + Float.hashCode(this.translationY)) * 31) + Float.hashCode(this.shadowElevation)) * 31) + Float.hashCode(this.rotationX)) * 31) + Float.hashCode(this.rotationY)) * 31) + Float.hashCode(this.rotationZ)) * 31) + Float.hashCode(this.cameraDistance)) * 31) + TransformOrigin.m4677hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + Boolean.hashCode(this.clip)) * 31) + (this.renderEffect == null ? 0 : this.renderEffect.hashCode())) * 31) + Color.m4296hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m4296hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m4374hashCodeimpl(this.compositingStrategy);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("GraphicsLayerElement(scaleX=").append(this.scaleX).append(", scaleY=").append(this.scaleY).append(", alpha=").append(this.alpha).append(", translationX=").append(this.translationX).append(", translationY=").append(this.translationY).append(", shadowElevation=").append(this.shadowElevation).append(", rotationX=").append(this.rotationX).append(", rotationY=").append(this.rotationY).append(", rotationZ=").append(this.rotationZ).append(", cameraDistance=").append(this.cameraDistance).append(", transformOrigin=").append((Object) TransformOrigin.m4678toStringimpl(this.transformOrigin)).append(", shape=");
        sb.append(this.shape).append(", clip=").append(this.clip).append(", renderEffect=").append(this.renderEffect).append(", ambientShadowColor=").append((Object) Color.m4297toStringimpl(this.ambientShadowColor)).append(", spotShadowColor=").append((Object) Color.m4297toStringimpl(this.spotShadowColor)).append(", compositingStrategy=").append((Object) CompositingStrategy.m4375toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final long m4445getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public final long m4442getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m4444getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m4443getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public void update(SimpleGraphicsLayerModifier node) {
        ...
        node.m4623setTransformOrigin__ExYCQ(this.transformOrigin);
        node.setShape(this.shape);
        node.setClip(this.clip);
        node.setRenderEffect(this.renderEffect);
        node.m4620setAmbientShadowColor8_81llA(this.ambientShadowColor);
        node.m4622setSpotShadowColor8_81llA(this.spotShadowColor);
        node.m4621setCompositingStrategyaDBOjCE(this.compositingStrategy);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("transformOrigin", TransformOrigin.m4667boximpl(this.transformOrigin));
        ...
        $this$inspectableProperties.getProperties().set("ambientShadowColor", Color.m4279boximpl(this.ambientShadowColor));
        $this$inspectableProperties.getProperties().set("spotShadowColor", Color.m4279boximpl(this.spotShadowColor));
        $this$inspectableProperties.getProperties().set("compositingStrategy", CompositingStrategy.m4370boximpl(this.compositingStrategy));
    }
}
