...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo4258createShaderuvyYCjk(long j);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.Companion.m4125getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo4236applyToPq9zytI(long size, Paint p, float alpha) {
        Shader shader = this.internalShader;
        if (shader == null || !Size.m4113equalsimpl0(this.createdSize, size)) {
            if (Size.m4119isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.Companion.m4125getUnspecifiedNHjbRc();
            } else {
                Shader it = mo4258createShaderuvyYCjk(size);
                this.internalShader = it;
                shader = it;
                this.createdSize = size;
            }
        }
        if (!Color.m4290equalsimpl0(p.mo4162getColor0d7_KjU(), Color.Companion.m4315getBlack0d7_KjU())) {
            p.mo4168setColor8_81llA(Color.Companion.m4315getBlack0d7_KjU());
        }
