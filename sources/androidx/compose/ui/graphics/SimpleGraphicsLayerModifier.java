...
public final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    */
    ...
    public final long m4619getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }

    /* renamed from: setTransformOrigin-__ExYCQ  reason: not valid java name */
    public final void m4623setTransformOrigin__ExYCQ(long j) {
    ...
    public final long m4616getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: setAmbientShadowColor-8_81llA  reason: not valid java name */
    public final void m4620setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
    }

    /* renamed from: getSpotShadowColor-0d7_KjU  reason: not valid java name */
    public final long m4618getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: setSpotShadowColor-8_81llA  reason: not valid java name */
    public final void m4622setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    /* renamed from: getCompositingStrategy--NrFUSI  reason: not valid java name */
    public final int m4617getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m4621setCompositingStrategyaDBOjCE(int i) {
    ...
    private SimpleGraphicsLayerModifier(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy) {
        ...
        this.layerBlock = new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.ui.graphics.SimpleGraphicsLayerModifier$layerBlock$1
            ...
            public final void invoke2(GraphicsLayerScope $this$null) {
                ...
                $this$null.mo4481setTransformOrigin__ExYCQ(SimpleGraphicsLayerModifier.this.m4619getTransformOriginSzJe1aQ());
                ...
                $this$null.mo4478setAmbientShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m4616getAmbientShadowColor0d7_KjU());
                $this$null.mo4480setSpotShadowColor8_81llA(SimpleGraphicsLayerModifier.this.m4618getSpotShadowColor0d7_KjU());
                $this$null.mo4479setCompositingStrategyaDBOjCE(SimpleGraphicsLayerModifier.this.m4617getCompositingStrategyNrFUSI());
            }
        };
    }
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped$ui_release = DelegatableNodeKt.m5759requireCoordinator64DMado(this, NodeKind.m5898constructorimpl(2)).getWrapped$ui_release();
