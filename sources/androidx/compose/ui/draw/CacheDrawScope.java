...
public final class CacheDrawScope implements Density {
    ...
    public final long m3909getSizeNHjbRc() {
        return this.cacheParams.mo3907getSizeNHjbRc();
    }
    ...
    public final void m3910recordTdoYBX4(GraphicsLayer $this$record_u2dTdoYBX4, final Density density, final LayoutDirection layoutDirection, long size, final Function1<? super ContentDrawScope, Unit> function1) {
        ...
        $this$record_TdoYBX4_u24lambda_u240.mo4841recordJVtK1S4($this$record_u2dTdoYBX4, size, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1$1
    ...
    public final DrawResult onDrawBehind(final Function1<? super DrawScope, Unit> function1) {
        return onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$onDrawBehind$1
            ...
            public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                function1.invoke($this$onDrawWithContent);
    ...
    public final DrawResult onDrawWithContent(Function1<? super ContentDrawScope, Unit> function1) {
        DrawResult it = new DrawResult(function1);
        this.drawResult = it;
        return it;
    }
