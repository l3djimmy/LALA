...
final class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public void update(PainterNode node) {
        boolean intrinsicsChanged = node.getSizeToIntrinsics() != this.sizeToIntrinsics || (this.sizeToIntrinsics && !Size.m4113equalsimpl0(node.getPainter().mo4960getIntrinsicSizeNHjbRc(), this.painter.mo4960getIntrinsicSizeNHjbRc()));
