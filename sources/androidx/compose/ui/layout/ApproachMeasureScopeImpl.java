...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int mo637roundToPxR2X_6o(long j) {
        return this.coordinator.mo637roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo638roundToPx0680j_4(float f) {
        return this.coordinator.mo638roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo639toDpGaN1DYA(long j) {
        return this.coordinator.mo639toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo640toDpu2uoSUM(float f) {
        return this.coordinator.mo640toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo641toDpu2uoSUM(int i) {
        return this.coordinator.mo641toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo642toDpSizekrfVVM(long j) {
        return this.coordinator.mo642toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo643toPxR2X_6o(long j) {
        return this.coordinator.mo643toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo644toPx0680j_4(float f) {
        return this.coordinator.mo644toPx0680j_4(f);
    }
    ...
    public long mo645toSizeXkaWNTQ(long j) {
        return this.coordinator.mo645toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo646toSp0xMU5do(float f) {
        return this.coordinator.mo646toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo647toSpkPz2Gy4(float f) {
        return this.coordinator.mo647toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo648toSpkPz2Gy4(int i) {
        return this.coordinator.mo648toSpkPz2Gy4(i);
    }
    ...
    public long mo5613getLookaheadConstraintsmsEJaDk() {
        Constraints m5805getLookaheadConstraintsDWUhwKw$ui_release = this.coordinator.m5805getLookaheadConstraintsDWUhwKw$ui_release();
        if (m5805getLookaheadConstraintsDWUhwKw$ui_release != null) {
            return m5805getLookaheadConstraintsDWUhwKw$ui_release.m6832unboximpl();
        }
    ...
    public long mo5614getLookaheadSizeYbymL2g() {
    ...
    public LayoutCoordinates getLookaheadScopeCoordinates(Placeable.PlacementScope $this$lookaheadScopeCoordinates) {
        ...
        LayoutNode lookaheadRoot = this.coordinator.getLayoutNode().getLookaheadRoot$ui_release();
    ...
    public MeasureResult layout(final int width, final int height, final Map<AlignmentLine, Integer> map, final Function1<? super RulerScope, Unit> function1, final Function1<? super Placeable.PlacementScope, Unit> function12) {
        ...
        return new MeasureResult(width, height, map, function1, function12, this) { // from class: androidx.compose.ui.layout.ApproachMeasureScopeImpl$layout$1
