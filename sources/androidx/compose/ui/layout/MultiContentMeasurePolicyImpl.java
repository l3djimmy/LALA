...
public final class MultiContentMeasurePolicyImpl implements MeasurePolicy {
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        ...
        return $this$measure_3p2s80s_u24lambda_u240.mo940measure3p2s80s($this$measure_u2d3p2s80s, MeasureScopeWithLayoutNodeKt.getChildrenOfVirtualChildren($this$measure_u2d3p2s80s), constraints);
    }
