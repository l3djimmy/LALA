...
final class ApproachLayoutModifierNodeImpl extends Modifier.Node implements ApproachLayoutModifierNode {
    ...
    public boolean mo334isMeasurementApproachInProgressozmzZPI(long lookaheadSize) {
        return this.isMeasurementApproachInProgress.invoke(IntSize.m7036boximpl(lookaheadSize)).booleanValue();
    }
    ...
    public MeasureResult mo333approachMeasure3p2s80s(ApproachMeasureScope $this$approachMeasure_u2d3p2s80s, Measurable measurable, long constraints) {
        return this.measureBlock.invoke($this$approachMeasure_u2d3p2s80s, measurable, Constraints.m6813boximpl(constraints));
    }
}
