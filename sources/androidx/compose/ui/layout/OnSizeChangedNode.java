...
final class OnSizeChangedNode extends Modifier.Node implements LayoutAwareModifierNode {
    ...
    private long previousSize = IntSize.m7039constructorimpl((Integer.MIN_VALUE << 32) | (Integer.MIN_VALUE & 4294967295L));
    ...
    public final void update(Function1<? super IntSize, Unit> function1) {
        this.onSizeChanged = function1;
        this.previousSize = IntSize.m7039constructorimpl((Integer.MIN_VALUE << 32) | (Integer.MIN_VALUE & 4294967295L));
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo632onRemeasuredozmzZPI(long size) {
        if (!IntSize.m7042equalsimpl0(this.previousSize, size)) {
            this.onSizeChanged.invoke(IntSize.m7036boximpl(size));
