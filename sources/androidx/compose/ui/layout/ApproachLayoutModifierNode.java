...
public interface ApproachLayoutModifierNode extends LayoutModifierNode {
    ...
    default MeasureResult mo328measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        final Placeable $this$measure_3p2s80s_u24lambda_u240 = measurable.mo5637measureBRTryo0(constraints);
    ...
    default int minApproachIntrinsicWidth(ApproachIntrinsicMeasureScope $this$minApproachIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        if (lookaheadDelegate.getHasMeasureResult()) {
            return NodeMeasuringIntrinsics.INSTANCE.minWidth$ui_release(new NodeMeasuringIntrinsics.ApproachMeasureBlock() { // from class: androidx.compose.ui.layout.ApproachLayoutModifierNode$minApproachIntrinsicWidth$1
                ...
                /* renamed from: measure-3p2s80s */
                public final MeasureResult mo5615measure3p2s80s(ApproachMeasureScope $this$ApproachMeasureBlock, Measurable intrinsicMeasurable, long constraints) {
                    return ApproachLayoutModifierNode.this.mo333approachMeasure3p2s80s($this$ApproachMeasureBlock, intrinsicMeasurable, constraints);
                }
