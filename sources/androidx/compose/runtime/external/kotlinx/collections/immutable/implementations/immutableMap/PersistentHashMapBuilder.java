...
public class PersistentHashMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public void putAll(Map<? extends K, ? extends V> map) {
        PersistentHashMap map2 = map instanceof PersistentHashMap ? (PersistentHashMap) map : null;
        if (map2 == null) {
        ...
        if (map2 != null) {
            ...
            TrieNode<K, V> node$runtime_release = map2.getNode$runtime_release();
