...
public final class PersistentOrderedMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    public PersistentOrderedMap<K, V> put(K k, V v) {
        ...
        if (isEmpty) {
            PersistentHashMap newMap = persistentHashMap.put((PersistentHashMap<K, LinkedValue<V>>) k, (K) new LinkedValue<>(v));
            return new PersistentOrderedMap<>(k, k, newMap);
        }
        LinkedValue links = persistentHashMap.get(k);
        if (links != null) {
            if (links.getValue() == v) {
                return this;
            }
            PersistentHashMap newMap2 = this.hashMap.put((PersistentHashMap<K, LinkedValue<V>>) k, (K) links.withValue(v));
            return new PersistentOrderedMap<>(this.firstKey, this.lastKey, newMap2);
        }
        Object lastKey = this.lastKey;
        Object obj = this.hashMap.get(lastKey);
        Intrinsics.checkNotNull(obj);
        LinkedValue lastLinks = (LinkedValue) obj;
        PersistentHashMap newMap3 = this.hashMap.put((PersistentHashMap<K, LinkedValue<V>>) lastKey, (Object) lastLinks.withNext(k)).put((PersistentHashMap) k, (K) new LinkedValue(v, lastKey));
        return new PersistentOrderedMap<>(this.firstKey, k, newMap3);
    }
    ...
    /* compiled from: PersistentOrderedMap.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0001\n\u0002\b\u0005\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u0002H\u0007\u0012\u0004\u0012\u0002H\b0\u0004\"\u0004\b\u0002\u0010\u0007\"\u0004\b\u0003\u0010\bH\u0000¢\u0006\u0002\b\tR\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00050\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedMap/PersistentOrderedMap$Companion;", "", "()V", "EMPTY", "Landroidx/compose/runtime/external/kotlinx/collections/immutable/implementations/persistentOrderedMap/PersistentOrderedMap;", "", "emptyOf", "K", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "emptyOf$runtime_release", "runtime_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    /* loaded from: classes11.dex */
