...
public final class PersistentOrderedSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public PersistentSet<E> add(E e) {
        ...
        Object obj = ((PersistentHashMap<E, Links>) this.hashMap).get(lastElement);
        Intrinsics.checkNotNull(obj);
        Links lastLinks = (Links) obj;
    ...
    public PersistentSet<E> removeAll(Function1<? super E, Boolean> function1) {
        ...
        PersistentSet.Builder<E> builder = $this$mutate$iv.builder();
        PersistentSet.Builder<E> it = builder;
        CollectionsKt.removeAll(it, function1);
        PersistentSet $this$mutate$iv2 = builder.build();
        return $this$mutate$iv2;
    }
