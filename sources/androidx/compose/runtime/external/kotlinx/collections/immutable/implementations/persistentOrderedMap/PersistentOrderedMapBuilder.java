...
public final class PersistentOrderedMapBuilder<K, V> extends AbstractMutableMap<K, V> implements PersistentMap.Builder<K, V> {
    ...
    public PersistentMap<K, V> build() {
        ...
        if (newHashMap == this.map.getHashMap$runtime_release()) {
            CommonFunctionsKt.m3844assert(this.firstKey == this.map.getFirstKey$runtime_release());
            CommonFunctionsKt.m3844assert(this.lastKey == this.map.getLastKey$runtime_release());
    ...
    public V put(K k, V v) {
        ...
        if (links != null) {
            ...
            Object obj = this.hashMapBuilder.get(lastKey);
            Intrinsics.checkNotNull(obj);
            LinkedValue lastLinks = (LinkedValue) obj;
            CommonFunctionsKt.m3844assert(!lastLinks.getHasNext());
