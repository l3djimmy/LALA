...
public final class ReadonlySnapshot extends Snapshot {
    ...
    public Snapshot takeNestedSnapshot(Function1<Object, Unit> function1) {
        ...
        Snapshot result$iv2 = new NestedReadonlySnapshot(getSnapshotId(), getInvalid$runtime_release(), SnapshotKt.mergedReadObserver$default(actualReadObserver, getReadObserver(), false, 4, null), this);
        if (observers$iv != null) {
