...
public final class DerivedSnapshotState<T> extends StateObjectImpl implements DerivedState<T> {
    ...
    public static final class ResultRecord<T> extends StateRecord implements DerivedState.Record<T> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:64:0x0151 A[LOOP:2: B:63:0x014f->B:64:0x0151, LOOP_END] */
        /*
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:53:0x014c A[LOOP:3: B:52:0x014a->B:53:0x014c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:83:0x0239 A[Catch: all -> 0x02b4, TryCatch #1 {, blocks: (B:73:0x020e, B:75:0x0221, B:77:0x0227, B:83:0x0239, B:85:0x024c), top: B:119:0x020e }] */
    /* JADX WARN: Type inference failed for: r3v6 */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private final androidx.compose.runtime.DerivedSnapshotState.ResultRecord<T> currentRecord(androidx.compose.runtime.DerivedSnapshotState.ResultRecord<T> r36, androidx.compose.runtime.snapshots.Snapshot r37, boolean r38, kotlin.jvm.functions.Function0<? extends T> r39) {
        /*
    ...
    public T getValue() {
        ...
        ResultRecord record = (ResultRecord) SnapshotKt.current(this.first, snapshot);
        return (T) currentRecord(record, snapshot, true, this.calculation).getResult();
    }
