...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3704boximpl(Composer composer) {
        return new SkippableUpdater(composer);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m3705constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3706equalsimpl(Composer composer, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual(composer, ((SkippableUpdater) obj).m3711unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3707equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3708hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3709toStringimpl(Composer composer) {
        return "SkippableUpdater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3706equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3708hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3709toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m3711unboximpl() {
    ...
    public static final void m3710updateimpl(Composer arg0, Function1<? super Updater<T>, Unit> function1) {
        arg0.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3730boximpl(Updater.m3731constructorimpl(arg0)));
