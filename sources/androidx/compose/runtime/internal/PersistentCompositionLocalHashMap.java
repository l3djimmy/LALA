...
public final class PersistentCompositionLocalHashMap extends PersistentHashMap<CompositionLocal<Object>, ValueHolder<Object>> implements PersistentCompositionLocalMap {
    ...
    public final /* bridge */ ValueHolder getOrDefault(Object key, ValueHolder defaultValue) {
        return !(key instanceof CompositionLocal) ? defaultValue : getOrDefault((CompositionLocal) key, (ValueHolder<Object>) defaultValue);
    }

    @Override // java.util.Map
    public final /* bridge */ /* synthetic */ Object getOrDefault(Object key, Object defaultValue) {
        return !(key instanceof CompositionLocal) ? defaultValue : getOrDefault((CompositionLocal) key, (ValueHolder) defaultValue);
    }
    ...
    public PersistentCompositionLocalMap putValue(CompositionLocal<Object> compositionLocal, ValueHolder<Object> valueHolder) {
        TrieNode.ModificationResult newNodeResult = getNode$runtime_release().put(compositionLocal.hashCode(), compositionLocal, valueHolder, 0);
