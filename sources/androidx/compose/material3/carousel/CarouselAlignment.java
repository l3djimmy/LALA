...
public final class CarouselAlignment {
    ...
    private static final int Start = m2920constructorimpl(-1);
    private static final int Center = m2920constructorimpl(0);
    private static final int End = m2920constructorimpl(1);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ CarouselAlignment m2919boximpl(int i) {
        return new CarouselAlignment(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2920constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2921equalsimpl(int i, Object obj) {
        return (obj instanceof CarouselAlignment) && i == ((CarouselAlignment) obj).m2925unboximpl();
    }
