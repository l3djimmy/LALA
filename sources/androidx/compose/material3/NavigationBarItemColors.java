...
public final class NavigationBarItemColors {
    ...
    public final long m2314getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2316getSelectedTextColor0d7_KjU() {
        return this.selectedTextColor;
    }

    /* renamed from: getSelectedIndicatorColor-0d7_KjU  reason: not valid java name */
    public final long m2315getSelectedIndicatorColor0d7_KjU() {
        return this.selectedIndicatorColor;
    }

    /* renamed from: getUnselectedIconColor-0d7_KjU  reason: not valid java name */
    public final long m2317getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU  reason: not valid java name */
    public final long m2318getUnselectedTextColor0d7_KjU() {
    ...
    public final NavigationBarItemColors m2310copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2319iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public final long m2320textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
    ...
    public final long m2313getIndicatorColor0d7_KjU$material3_release() {
        return this.selectedIndicatorColor;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof NavigationBarItemColors) && Color.m4290equalsimpl0(this.selectedIconColor, ((NavigationBarItemColors) other).selectedIconColor) && Color.m4290equalsimpl0(this.unselectedIconColor, ((NavigationBarItemColors) other).unselectedIconColor) && Color.m4290equalsimpl0(this.selectedTextColor, ((NavigationBarItemColors) other).selectedTextColor) && Color.m4290equalsimpl0(this.unselectedTextColor, ((NavigationBarItemColors) other).unselectedTextColor) && Color.m4290equalsimpl0(this.selectedIndicatorColor, ((NavigationBarItemColors) other).selectedIndicatorColor) && Color.m4290equalsimpl0(this.disabledIconColor, ((NavigationBarItemColors) other).disabledIconColor) && Color.m4290equalsimpl0(this.disabledTextColor, ((NavigationBarItemColors) other).disabledTextColor)) {
            return true;
        }
        return false;
    }
