...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int initialHour, int initialMinute, boolean is24Hour) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2794boximpl(TimePickerSelectionMode.Companion.m2801getHouryecRtBI()), null, 2, null);
        this.selection$delegate = mutableStateOf$default;
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Boolean.valueOf(initialHour >= 12), null, 2, null);
    ...
    public int mo1809getSelectionyecRtBI() {
        State $this$getValue$iv = this.selection$delegate;
        return ((TimePickerSelectionMode) $this$getValue$iv.getValue()).m2800unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* renamed from: setSelection-6_8s6DQ */
    public void mo1810setSelection6_8s6DQ(int i) {
        MutableState $this$setValue$iv = this.selection$delegate;
        $this$setValue$iv.setValue(TimePickerSelectionMode.m2794boximpl(i));
    }

    @Override // androidx.compose.material3.TimePickerState
    public boolean isAfternoon() {
        State $this$getValue$iv = this.isAfternoon$delegate;
        return ((Boolean) $this$getValue$iv.getValue()).booleanValue();
    }

    @Override // androidx.compose.material3.TimePickerState
    public void setAfternoon(boolean z) {
        MutableState $this$setValue$iv = this.isAfternoon$delegate;
