...
public final class ClockDialNode$pointerInputTapNode$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures$default($this$SuspendingPointerInputModifierNode, null, null, new AnonymousClass1(this.this$0, null), new Function1<Offset, Unit>() { // from class: androidx.compose.material3.ClockDialNode$pointerInputTapNode$1.2
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1935invokek4lQ0M(offset.m4058unboximpl());
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                case 0:
                                    ...
                                    float m4048getXimpl = Offset.m4048getXimpl(this.$it);
                                    float m4049getYimpl = Offset.m4049getYimpl(this.$it);
                                    maxDist = this.this$0.getMaxDist();
                                    z = this.this$0.autoSwitchToMinute;
                                    j = this.this$0.center;
                                    this.label = 1;
                                    m2781onTaprOwcSBo = TimePickerKt.m2781onTaprOwcSBo(analogTimePickerState, m4048getXimpl, m4049getYimpl, maxDist, z, j, this);
                                    if (m2781onTaprOwcSBo != coroutine_suspended) {
                                        break;
                                    } else {
                    ...
                    public final void m1935invokek4lQ0M(long it) {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
        ...
        public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
            return m1934invoked4ec7I(pressGestureScope, offset.m4058unboximpl(), continuation);
        }

        /* renamed from: invoke-d-4ec7I  reason: not valid java name */
        public final Object m1934invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    long it = this.J$0;
                    this.this$0.offsetX = Offset.m4048getXimpl(it);
                    this.this$0.offsetY = Offset.m4049getYimpl(it);
                    return Unit.INSTANCE;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
