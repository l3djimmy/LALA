...
public final class ClockDialNode extends DelegatingNode implements PointerInputModifierNode, CompositionLocalConsumerModifierNode, LayoutAwareModifierNode {
    ...
    private ClockDialNode(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        ...
        this.center = IntOffset.Companion.m7012getZeronOccac();
    ...
    public final float getMaxDist() {
        ...
        return $this$_get_maxDist__u24lambda_u240.mo644toPx0680j_4(f);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo632onRemeasuredozmzZPI(long size) {
        this.center = IntSizeKt.m7050getCenterozmzZPI(size);
    }

    @Override // androidx.compose.ui.node.PointerInputModifierNode
    /* renamed from: onPointerEvent-H0pRuoY */
    public void mo472onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        this.pointerInputTapNode.mo472onPointerEventH0pRuoY(pointerEvent, pass, bounds);
        this.pointerInputDragNode.mo472onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public final void m1932updateNodee8ubxrI(AnalogTimePickerState state, boolean autoSwitchToMinute, int selection) {
        this.state = state;
        this.autoSwitchToMinute = autoSwitchToMinute;
        if (!TimePickerSelectionMode.m2797equalsimpl0(this.selection, selection)) {
            this.selection = selection;
