...
public final class ComposableSingletons$SnackbarHostKt {
    ...
    public static Function3<SnackbarData, Composer, Integer, Unit> f46lambda1 = ComposableLambdaKt.composableLambdaInstance(818736383, false, new Function3<SnackbarData, Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$SnackbarHostKt$lambda-1$1
        ...
        public final void invoke(SnackbarData it, Composer $composer, int $changed) {
            ...
            SnackbarKt.m2579SnackbarsDKtq54(it, null, false, null, 0L, 0L, 0L, 0L, 0L, $composer, $dirty & 14, TypedValues.PositionType.TYPE_POSITION_TYPE);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function3<SnackbarData, Composer, Integer, Unit> m2030getLambda1$material3_release() {
        return f46lambda1;
    }
}
