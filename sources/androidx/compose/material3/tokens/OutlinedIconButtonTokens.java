...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m6873constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m6873constructorimpl((float) 24.0d);
    ...
    public final float m3403getContainerSizeD9Ej5fM() {
    ...
    public final float m3404getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m3405getUnselectedOutlineWidthD9Ej5fM() {
