...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m6873constructorimpl((float) 512.0d);
    ...
    private static final float ContainerWidth = Dp.m6873constructorimpl((float) 328.0d);
    private static final float HeaderContainerHeight = Dp.m6873constructorimpl((float) 120.0d);
    private static final float HeaderContainerWidth = Dp.m6873constructorimpl((float) 328.0d);
    ...
    public final float m3183getContainerElevationD9Ej5fM() {
    ...
    public final float m3186getHeaderContainerHeightD9Ej5fM() {
        return HeaderContainerHeight;
    }

    /* renamed from: getHeaderContainerWidth-D9Ej5fM  reason: not valid java name */
    public final float m3187getHeaderContainerWidthD9Ej5fM() {
