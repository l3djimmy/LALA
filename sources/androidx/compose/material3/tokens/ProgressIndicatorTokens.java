...
public final class ProgressIndicatorTokens {
    ...
    private static final float ActiveThickness = Dp.m6873constructorimpl((float) 4.0d);
    private static final float ActiveTrackSpace = Dp.m6873constructorimpl((float) 4.0d);
    private static final ColorSchemeKeyTokens StopColor = ColorSchemeKeyTokens.Primary;
    private static final float StopShape = Dp.m6873constructorimpl((float) 4.0d);
    private static final float StopSize = Dp.m6873constructorimpl((float) 4.0d);
    ...
    private static final float TrackThickness = Dp.m6873constructorimpl((float) 4.0d);
    private static final float Size = Dp.m6873constructorimpl((float) 48.0d);
    ...
    public final float m3512getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM  reason: not valid java name */
    public final float m3513getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3515getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM  reason: not valid java name */
    public final float m3516getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3517getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* renamed from: getSize-D9Ej5fM  reason: not valid java name */
    public final float m3514getSizeD9Ej5fM() {
        return Size;
    }
}
