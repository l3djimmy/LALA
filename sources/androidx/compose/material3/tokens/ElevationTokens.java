...
public final class ElevationTokens {
    ...
    private static final float Level0 = Dp.m6873constructorimpl((float) AudioStats.AUDIO_AMPLITUDE_NONE);
    private static final float Level1 = Dp.m6873constructorimpl((float) 1.0d);
    private static final float Level2 = Dp.m6873constructorimpl((float) 3.0d);
    private static final float Level3 = Dp.m6873constructorimpl((float) 6.0d);
    private static final float Level4 = Dp.m6873constructorimpl((float) 8.0d);
    private static final float Level5 = Dp.m6873constructorimpl((float) 12.0d);

    private ElevationTokens() {
    }

    /* renamed from: getLevel0-D9Ej5fM  reason: not valid java name */
    public final float m3222getLevel0D9Ej5fM() {
        return Level0;
    }

    /* renamed from: getLevel1-D9Ej5fM  reason: not valid java name */
    public final float m3223getLevel1D9Ej5fM() {
        return Level1;
    }

    /* renamed from: getLevel2-D9Ej5fM  reason: not valid java name */
    public final float m3224getLevel2D9Ej5fM() {
        return Level2;
    }

    /* renamed from: getLevel3-D9Ej5fM  reason: not valid java name */
    public final float m3225getLevel3D9Ej5fM() {
        return Level3;
    }

    /* renamed from: getLevel4-D9Ej5fM  reason: not valid java name */
    public final float m3226getLevel4D9Ej5fM() {
        return Level4;
    }

    /* renamed from: getLevel5-D9Ej5fM  reason: not valid java name */
    public final float m3227getLevel5D9Ej5fM() {
        return Level5;
    }
}
