...
public final class ChipElevation {
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (invalid$iv || it$iv3 == Composer.Companion.getEmpty()) {
            Object value$iv5 = (Function2) new ChipElevation$animateElevation$1$1(interactionSource, interactions, null);
        ...
        if (invalid$iv2 || it$iv5 == Composer.Companion.getEmpty()) {
            ...
            Object value$iv7 = (Function2) new ChipElevation$animateElevation$2$1(animatable, target, enabled, interaction, lastInteraction$delegate, null);
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ChipElevation) && Dp.m6878equalsimpl0(this.elevation, ((ChipElevation) other).elevation) && Dp.m6878equalsimpl0(this.pressedElevation, ((ChipElevation) other).pressedElevation) && Dp.m6878equalsimpl0(this.focusedElevation, ((ChipElevation) other).focusedElevation) && Dp.m6878equalsimpl0(this.hoveredElevation, ((ChipElevation) other).hoveredElevation) && Dp.m6878equalsimpl0(this.disabledElevation, ((ChipElevation) other).disabledElevation)) {
            return true;
        }
        return false;
    }
