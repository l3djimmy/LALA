...
public final class NavigationDrawerItemDefaults {
    ...
    private static final PaddingValues ItemPadding = PaddingKt.m988PaddingValuesYgX7TsA$default(Dp.m6873constructorimpl(12), 0.0f, 2, null);

    private NavigationDrawerItemDefaults() {
    }

    /* renamed from: colors-oq7We08  reason: not valid java name */
    public final NavigationDrawerItemColors m2329colorsoq7We08(long selectedContainerColor, long unselectedContainerColor, long selectedIconColor, long unselectedIconColor, long selectedTextColor, long unselectedTextColor, long selectedBadgeColor, long unselectedBadgeColor, Composer $composer, int $changed, int i) {
        ...
        long unselectedContainerColor2 = (i & 2) != 0 ? Color.Companion.m4324getTransparent0d7_KjU() : unselectedContainerColor;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1574983348, $changed, -1, "androidx.compose.material3.NavigationDrawerItemDefaults.colors (NavigationDrawer.kt:1029)");
        }
