...
public final class TimePickerSelectionMode {
    ...
    private static final int Hour = m2795constructorimpl(0);
    private static final int Minute = m2795constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerSelectionMode m2794boximpl(int i) {
        return new TimePickerSelectionMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2795constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2796equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerSelectionMode) && i == ((TimePickerSelectionMode) obj).m2800unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2797equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2798hashCodeimpl(int i) {
    ...
    public static String m2799toStringimpl(int arg0) {
        return m2797equalsimpl0(arg0, Hour) ? "Hour" : m2797equalsimpl0(arg0, Minute) ? "Minute" : "";
    }
}
