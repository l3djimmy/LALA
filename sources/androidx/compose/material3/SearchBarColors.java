...
public final class SearchBarColors {
    ...
    public final long m2463getDividerColor0d7_KjU() {
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SearchBarColors) && Color.m4290equalsimpl0(this.containerColor, ((SearchBarColors) other).containerColor) && Color.m4290equalsimpl0(this.dividerColor, ((SearchBarColors) other).dividerColor) && Intrinsics.areEqual(this.inputFieldColors, ((SearchBarColors) other).inputFieldColors);
    }

    public int hashCode() {
        int result = Color.m4296hashCodeimpl(this.containerColor);
        return (((result * 31) + Color.m4296hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
