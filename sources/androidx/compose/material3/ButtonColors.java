...
public final class ButtonColors {
    ...
    public final long m1854getContainerColor0d7_KjU() {
        return this.containerColor;
    }

    /* renamed from: getContentColor-0d7_KjU  reason: not valid java name */
    public final long m1855getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getDisabledContainerColor-0d7_KjU  reason: not valid java name */
    public final long m1856getDisabledContainerColor0d7_KjU() {
        return this.disabledContainerColor;
    }

    /* renamed from: getDisabledContentColor-0d7_KjU  reason: not valid java name */
    public final long m1857getDisabledContentColor0d7_KjU() {
        return this.disabledContentColor;
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final ButtonColors m1853copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m1851containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1852contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof ButtonColors) && Color.m4290equalsimpl0(this.containerColor, ((ButtonColors) other).containerColor) && Color.m4290equalsimpl0(this.contentColor, ((ButtonColors) other).contentColor) && Color.m4290equalsimpl0(this.disabledContainerColor, ((ButtonColors) other).disabledContainerColor) && Color.m4290equalsimpl0(this.disabledContentColor, ((ButtonColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
