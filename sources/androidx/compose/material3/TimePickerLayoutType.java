...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m2786constructorimpl(0);
    private static final int Vertical = m2786constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2785boximpl(int i) {
        return new TimePickerLayoutType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2786constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2787equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m2791unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2788equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2789hashCodeimpl(int i) {
    ...
    public static String m2790toStringimpl(int arg0) {
        return m2788equalsimpl0(arg0, Horizontal) ? "Horizontal" : m2788equalsimpl0(arg0, Vertical) ? "Vertical" : "Unknown";
    }
}
