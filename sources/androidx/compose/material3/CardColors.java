...
public final class CardColors {
    ...
    public final long m1875getContentColor0d7_KjU() {
        return this.contentColor;
    }

    /* renamed from: getDisabledContainerColor-0d7_KjU  reason: not valid java name */
    public final long m1876getDisabledContainerColor0d7_KjU() {
        return this.disabledContainerColor;
    }

    /* renamed from: getDisabledContentColor-0d7_KjU  reason: not valid java name */
    public final long m1877getDisabledContentColor0d7_KjU() {
        return this.disabledContentColor;
    }

    /* renamed from: copy-jRlVdoo  reason: not valid java name */
    public final CardColors m1873copyjRlVdoo(long containerColor, long contentColor, long disabledContainerColor, long disabledContentColor) {
    ...
    public final long m1871containerColorvNxB06k$material3_release(boolean enabled) {
    ...
    public final long m1872contentColorvNxB06k$material3_release(boolean enabled) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof CardColors) && Color.m4290equalsimpl0(this.containerColor, ((CardColors) other).containerColor) && Color.m4290equalsimpl0(this.contentColor, ((CardColors) other).contentColor) && Color.m4290equalsimpl0(this.disabledContainerColor, ((CardColors) other).disabledContainerColor) && Color.m4290equalsimpl0(this.disabledContentColor, ((CardColors) other).disabledContentColor)) {
            return true;
        }
        return false;
    }
