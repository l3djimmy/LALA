...
public final class WindowAlignmentMarginPosition {
    ...
    public static final class Horizontal implements MenuPosition.Horizontal {
        ...
        public int mo2940position95KtPRI(IntRect anchorBounds, long windowSize, int menuWidth, LayoutDirection layoutDirection) {
            if (menuWidth >= IntSize.m7044getWidthimpl(windowSize) - (this.margin * 2)) {
                return Alignment.Companion.getCenterHorizontally().align(menuWidth, IntSize.m7044getWidthimpl(windowSize), layoutDirection);
            }
            int x = this.alignment.align(menuWidth, IntSize.m7044getWidthimpl(windowSize), layoutDirection);
            return RangesKt.coerceIn(x, this.margin, (IntSize.m7044getWidthimpl(windowSize) - this.margin) - menuWidth);
        }
    }
    ...
    public static final class Vertical implements MenuPosition.Vertical {
        ...
        public int mo2941positionJVtK1S4(IntRect anchorBounds, long windowSize, int menuHeight) {
            if (menuHeight >= IntSize.m7043getHeightimpl(windowSize) - (this.margin * 2)) {
                return Alignment.Companion.getCenterVertically().align(menuHeight, IntSize.m7043getHeightimpl(windowSize));
            }
            int y = this.alignment.align(menuHeight, IntSize.m7043getHeightimpl(windowSize));
            return RangesKt.coerceIn(y, this.margin, (IntSize.m7043getHeightimpl(windowSize) - this.margin) - menuHeight);
        }
    }
}
