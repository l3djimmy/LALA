...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m2951animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m2950animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ  reason: not valid java name */
    public static final Object m2950animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float target, Interaction from, Interaction to, Continuation<? super Unit> continuation) {
        ...
        if (spec == null) {
            Object snapTo = animatable.snapTo(Dp.m6871boximpl(target), continuation);
            return snapTo == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? snapTo : Unit.INSTANCE;
        }
        animateTo = animatable.animateTo(Dp.m6871boximpl(target), (r12 & 2) != 0 ? animatable.defaultSpringSpec : spec, (r12 & 4) != 0 ? animatable.getVelocity() : null, (r12 & 8) != 0 ? null : null, continuation);
