                ...
                if (!Dp.m6878equalsimpl0(this.$animatable.getTargetValue().m6887unboximpl(), this.$target)) {
                    ...
                    if (!z) {
                        ...
                        if (Dp.m6878equalsimpl0(m6887unboximpl, f)) {
                            focus = new PressInteraction.Press(Offset.Companion.m4064getZeroF1C5BW0(), null);
                        } else {
                        ...
                        this.label = 2;
                        if (ElevationKt.m2950animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
