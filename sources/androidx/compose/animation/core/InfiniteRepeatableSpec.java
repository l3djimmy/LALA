...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    */
    ...
    public final long m417getInitialStartOffsetRmkjzm4() {
    ...
    public boolean equals(Object other) {
        return (other instanceof InfiniteRepeatableSpec) && Intrinsics.areEqual(((InfiniteRepeatableSpec) other).animation, this.animation) && ((InfiniteRepeatableSpec) other).repeatMode == this.repeatMode && StartOffset.m437equalsimpl0(((InfiniteRepeatableSpec) other).initialStartOffset, this.initialStartOffset);
    }

    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m440hashCodeimpl(this.initialStartOffset);
    }
}
