...
final class StartDelayVectorizedAnimationSpec<V extends AnimationVector> implements VectorizedAnimationSpec<V> {
    ...
    public V getVelocityFromNanos(long playTimeNanos, V v, V v2, V v3) {
        return playTimeNanos < this.startDelayNanos ? v3 : this.vectorizedAnimationSpec.getVelocityFromNanos(playTimeNanos - this.startDelayNanos, v, v2, v3);
    }

    @Override // androidx.compose.animation.core.VectorizedAnimationSpec
    public V getValueFromNanos(long playTimeNanos, V v, V v2, V v3) {
        if (playTimeNanos >= this.startDelayNanos) {
            return this.vectorizedAnimationSpec.getValueFromNanos(playTimeNanos - this.startDelayNanos, v, v2, v3);
        }
        return v;
    }
