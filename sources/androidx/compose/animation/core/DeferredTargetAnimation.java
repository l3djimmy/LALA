...
public final class DeferredTargetAnimation<T, V extends AnimationVector> {
    ...
    public final T get_pendingTarget() {
        State $this$getValue$iv = this._pendingTarget$delegate;
        return $this$getValue$iv.getValue();
    }

    private final void set_pendingTarget(T t) {
        MutableState $this$setValue$iv = this._pendingTarget$delegate;
    ...
    public final T updateTarget(T t, CoroutineScope coroutineScope, FiniteAnimationSpec<T> finiteAnimationSpec) {
        ...
        if (animatable == null) {
            Animatable it = new Animatable(t, this.vectorConverter, null, null, 12, null);
            this.animatable = it;
            anim = it;
        } else {
            anim = animatable;
        }
        BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new DeferredTargetAnimation$updateTarget$1(anim, this, t, finiteAnimationSpec, null), 3, null);
