...
public final class AnimationScope<T, V extends AnimationVector> {
    ...
    public AnimationScope(T t, TwoWayConverter<T, V> twoWayConverter, V v, long lastFrameTimeNanos, T t2, long startTimeNanos, boolean isRunning, Function0<Unit> function0) {
