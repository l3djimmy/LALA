...
public final class EasingFunctionsKt {
    ...
    public static final float EaseInOutElastic$lambda$2(float fraction) {
        ...
        if (z) {
            return (float) ((-(((float) Math.pow(2.0d, (fraction * 20.0f) - 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d))) / 2.0d);
        }
        return ((float) ((((float) Math.pow(2.0d, ((-20.0f) * fraction) + 10.0f)) * Math.sin(((20.0f * fraction) - 11.125f) * 1.3962634015954636d)) / 2.0d)) + 1.0f;
    }
