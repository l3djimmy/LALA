    ...
    */
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(androidx.compose.animation.core.VectorizedDurationBasedAnimationSpec r7, androidx.compose.animation.core.RepeatMode r8, long r9, int r11, kotlin.jvm.internal.DefaultConstructorMarker r12) {
        ...
        L9:
            ...
            r9 = 0
            r10 = 2
            long r9 = androidx.compose.animation.core.StartOffset.m435constructorimpl$default(r9, r9, r10, r8)
            r3 = r9
            goto L17
        L16:
            r3 = r9
    ...
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        this(animation, repeatMode, StartOffset.m435constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    private final V repetitionStartVelocity(long playTimeNanos, V v, V v2, V v3) {
        return this.initialOffsetNanos + playTimeNanos > this.durationNanos ? this.animation.getVelocityFromNanos(this.durationNanos - this.initialOffsetNanos, v, v3, v2) : v2;
    }
