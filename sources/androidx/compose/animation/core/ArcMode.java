...
public final class ArcMode {
    ...
    private static final int ArcAbove = m408constructorimpl(5);
    private static final int ArcBelow = m408constructorimpl(4);
    private static final int ArcLinear = m408constructorimpl(0);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ArcMode m407boximpl(int i) {
        return new ArcMode(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m408constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m409equalsimpl(int i, Object obj) {
        return (obj instanceof ArcMode) && i == ((ArcMode) obj).m413unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m410equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m411hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m412toStringimpl(int i) {
    ...
    public final /* synthetic */ int m413unboximpl() {
        return this.value;
    }
