...
public final class VectorizedRepeatableSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    */
    ...
    private final V repetitionStartVelocity(long playTimeNanos, V v, V v2, V v3) {
        return this.initialOffsetNanos + playTimeNanos > this.durationNanos ? getVelocityFromNanos(this.durationNanos - this.initialOffsetNanos, v, v2, v3) : v2;
    }

    @Override // androidx.compose.animation.core.VectorizedAnimationSpec
    public V getValueFromNanos(long playTimeNanos, V v, V v2, V v3) {
        return this.animation.getValueFromNanos(repetitionPlayTimeNanos(playTimeNanos), v, v2, repetitionStartVelocity(playTimeNanos, v, v3, v2));
    }

    @Override // androidx.compose.animation.core.VectorizedAnimationSpec
    public V getVelocityFromNanos(long playTimeNanos, V v, V v2, V v3) {
        return this.animation.getVelocityFromNanos(repetitionPlayTimeNanos(playTimeNanos), v, v2, repetitionStartVelocity(playTimeNanos, v, v3, v2));
    }
