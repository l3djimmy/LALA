...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.Companion.m6808getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    public final int m1395getOverflowgIe3tQ8() {
    ...
    private final MultiParagraph m1394layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        int maxWidth;
        int width;
        layoutIntrinsics(layoutDirection);
        int minWidth = Constraints.m6828getMinWidthimpl(constraints);
        boolean widthMatters = this.softWrap || TextOverflow.m6799equalsimpl0(this.overflow, TextOverflow.Companion.m6809getEllipsisgIe3tQ8());
        ...
        boolean overwriteMaxLines = !this.softWrap && TextOverflow.m6799equalsimpl0(this.overflow, TextOverflow.Companion.m6809getEllipsisgIe3tQ8());
        ...
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.Companion.m6835fitPrioritizingWidthZbe2FdA(0, width, 0, Constraints.m6825getMaxHeightimpl(constraints)), finalMaxLines, this.overflow, (DefaultConstructorMarker) null);
    }

    /* renamed from: layout-NN6Ew-U$default  reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1393layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1396layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U  reason: not valid java name */
    public final TextLayoutResult m1396layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        long j;
        if (prevResult == null) {
            j = constraints;
        } else if (!TextLayoutHelperKt.m1429canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            j = constraints;
        } else {
            TextLayoutInput textLayoutInput = new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().m6306getOverflowgIe3tQ8(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null);
            ...
            return prevResult.m6308copyO0kMr_c(textLayoutInput, ConstraintsKt.m6840constrain4WqzIAM(constraints, IntSize.m7039constructorimpl((width$iv << 32) | (height$iv & 4294967295L))));
        }
        MultiParagraph multiParagraph = m1394layoutTextK40F9xA(constraints, layoutDirection);
        ...
        long size = ConstraintsKt.m6840constrain4WqzIAM(j, IntSize.m7039constructorimpl((width$iv2 << 32) | (height$iv2 & 4294967295L)));
