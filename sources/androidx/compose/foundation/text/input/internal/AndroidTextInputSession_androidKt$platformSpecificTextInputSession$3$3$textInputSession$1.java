...
public final class AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$3$textInputSession$1 implements TextInputSession, ImeEditCommandScope {
    ...
    public long mo1484mapFromTransformedGEjPoXI(long j) {
        return this.$$delegate_0.mo1484mapFromTransformedGEjPoXI(j);
    }

    @Override // androidx.compose.foundation.text.input.internal.ImeEditCommandScope
    /* renamed from: mapToTransformed-GEjPoXI  reason: not valid java name */
    public long mo1485mapToTransformedGEjPoXI(long j) {
        return this.$$delegate_0.mo1485mapToTransformedGEjPoXI(j);
    }
    ...
    public void mo1486onImeActionKlQnJC8(int imeAction) {
