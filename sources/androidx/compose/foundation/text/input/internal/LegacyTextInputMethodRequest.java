...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private Function1<? super ImeAction, Unit> onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest$onImeActionPerformed$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
            m1524invokeKlQnJC8(imeAction.m6508unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-KlQnJC8  reason: not valid java name */
        public final void m1524invokeKlQnJC8(int it) {
        }
    };
    private TextFieldValue state = new TextFieldValue("", TextRange.Companion.m6344getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public final void startInput(TextFieldValue value, LegacyPlatformTextInputServiceAdapter.LegacyPlatformTextInputNode textInputNode, ImeOptions imeOptions, Function1<? super List<? extends EditCommand>, Unit> function1, Function1<? super ImeAction, Unit> function12) {
        this.state = value;
    ...
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        EditorInfo_androidKt.m1497updatepLxbY9I$default(outAttributes, this.state.getText(), this.state.m6587getSelectiond9O1mEE(), this.imeOptions, null, 8, null);
