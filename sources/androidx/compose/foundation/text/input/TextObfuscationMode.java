...
public final class TextObfuscationMode {
    ...
    private static final int Visible = m1472constructorimpl(0);
    private static final int RevealLastTyped = m1472constructorimpl(1);
    private static final int Hidden = m1472constructorimpl(2);

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextObfuscationMode m1471boximpl(int i) {
    ...
    public static boolean m1473equalsimpl(int i, Object obj) {
        return (obj instanceof TextObfuscationMode) && i == ((TextObfuscationMode) obj).m1477unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1474equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1475hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1476toStringimpl(int i) {
