...
public final class SecureTextFieldController {
    ...
    public final void scheduleHide() {
        Object result = this.resetTimerSignal.mo8838trySendJP2dKIU(Unit.INSTANCE);
        if (ChannelResult.m8861isFailureimpl(result)) {
