...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo913measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        int maxIntrinsicWidth = measurable.maxIntrinsicWidth(Constraints.m6825getMaxHeightimpl(constraints));
        if (maxIntrinsicWidth >= Constraints.m6826getMaxWidthimpl(constraints)) {
