...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m1698getOriginalSelectiond9O1mEE() {
    ...
    public final long m1699getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m1700setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final T deselect() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            $this$deselect_u24lambda_u241.setCursor(TextRange.m6334getEndimpl($this$deselect_u24lambda_u241.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    public final T collapseLeftOr(Function1<? super T, Unit> function1) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m6333getCollapsedimpl($this$collapseLeftOr_u24lambda_u244.selection)) {
                ...
                function1.invoke($this$collapseLeftOr_u24lambda_u244);
            } else {
                boolean isLtr = $this$collapseLeftOr_u24lambda_u244.isLtr();
                long j = $this$collapseLeftOr_u24lambda_u244.selection;
                if (isLtr) {
                    $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m6337getMinimpl(j));
                } else {
                    $this$collapseLeftOr_u24lambda_u244.setCursor(TextRange.m6336getMaximpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final T collapseRightOr(Function1<? super T, Unit> function1) {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            if (TextRange.m6333getCollapsedimpl($this$collapseRightOr_u24lambda_u245.selection)) {
                ...
                function1.invoke($this$collapseRightOr_u24lambda_u245);
            } else {
                boolean isLtr = $this$collapseRightOr_u24lambda_u245.isLtr();
                long j = $this$collapseRightOr_u24lambda_u245.selection;
                if (isLtr) {
                    $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m6336getMaximpl(j));
                } else {
                    $this$collapseRightOr_u24lambda_u245.setCursor(TextRange.m6337getMinimpl(j));
                }
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m6334getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m6334getEndimpl(this.selection));
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphStart = StringHelpersKt.findParagraphStart($this$moveCursorPrevByParagraph_u24lambda_u2416.getText$foundation_release(), TextRange.m6337getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection));
            if (paragraphStart == TextRange.m6337getMinimpl($this$moveCursorPrevByParagraph_u24lambda_u2416.selection) && paragraphStart != 0) {
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            ...
            int paragraphEnd = StringHelpersKt.findParagraphEnd($this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release(), TextRange.m6336getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection));
            if (paragraphEnd == TextRange.m6336getMaximpl($this$moveCursorNextByParagraph_u24lambda_u2417.selection) && paragraphEnd != $this$moveCursorNextByParagraph_u24lambda_u2417.getText$foundation_release().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            ...
            $this$selectMovement_u24lambda_u2428.selection = TextRangeKt.TextRange(TextRange.m6339getStartimpl($this$selectMovement_u24lambda_u2428.originalSelection), TextRange.m6334getEndimpl($this$selectMovement_u24lambda_u2428.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return this;
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult $this$getNextWordOffsetForLayout, int currentOffset) {
        while (currentOffset < this.originalText.length()) {
            ...
            if (TextRange.m6334getEndimpl(currentWord) <= currentOffset) {
                ...
                return this.offsetMapping.transformedToOriginal(TextRange.m6334getEndimpl(currentWord));
            }
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult $this$getPrevWordOffset, int currentOffset) {
        while (currentOffset > 0) {
            long currentWord = $this$getPrevWordOffset.m6311getWordBoundaryjx7JFs(charOffset(currentOffset));
            if (TextRange.m6339getStartimpl(currentWord) >= currentOffset) {
                currentOffset--;
            } else {
                return this.offsetMapping.transformedToOriginal(TextRange.m6339getStartimpl(currentWord));
            }
        }
        return 0;
    }
    ...
    private final int jumpByLinesOffset(TextLayoutResult $this$jumpByLinesOffset, int linesAmount) {
        ...
        if ((!isLtr() || it < $this$jumpByLinesOffset.getLineRight(targetLine)) && (isLtr() || it > $this$jumpByLinesOffset.getLineLeft(targetLine))) {
            ...
            return this.offsetMapping.transformedToOriginal($this$jumpByLinesOffset.m6309getOffsetForPositionk4lQ0M(Offset.m4040constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv))));
        }
        return $this$jumpByLinesOffset.getLineEnd(targetLine, true);
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6334getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6337getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6336getMaximpl(this.selection));
    }
