...
public final class SelectableTextAnnotatedStringNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, GlobalPositionAwareModifierNode {
    ...
    public MeasureResult mo328measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        return this.textAnnotatedStringNode.m1694measureNonExtension3p2s80s($this$measure_u2d3p2s80s, measurable, constraints);
    }
    ...
    public final void m1693update7NebLg4(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, Function1<? super TextLayoutResult, Unit> function1, Function1<? super List<Rect>, Unit> function12, SelectionController selectionController, ColorProducer color, TextAutoSize autoSize) {
        this.textAnnotatedStringNode.doInvalidations(this.textAnnotatedStringNode.updateDraw(color, style), this.textAnnotatedStringNode.updateText$foundation_release(text), this.textAnnotatedStringNode.m1695updateLayoutRelatedArgsy0kMQk(style, list, minLines, maxLines, softWrap, fontFamilyResolver, overflow, autoSize), this.textAnnotatedStringNode.updateCallbacks(function1, function12, selectionController, this.onShowTranslation));
        this.selectionController = selectionController;
