...
public final class CanvasKt {
    public static final void Canvas(final Modifier modifier, final Function1<? super DrawScope, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Canvas)40@1873L35:Canvas.kt#71ulvw");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
    ...
    public static final void Canvas(final Modifier modifier, final String contentDescription, final Function1<? super DrawScope, Unit> function1, Composer $composer, final int $changed) {
        ...
        ComposerKt.sourceInformation($composer2, "C(Canvas)P(1)60@3180L48,60@3135L94:Canvas.kt#71ulvw");
        int $dirty = $changed;
        if (($changed & 6) == 0) {
            $dirty |= $composer2.changed(modifier) ? 4 : 2;
        }
        ...
        if ($composer2.shouldExecute(($dirty & 147) != 146, $dirty & 1)) {
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 1782764834, "CC(remember):Canvas.kt#9igjgp");
            boolean invalid$iv = ($dirty & Property.BORDER_BOTTOM_RIGHT_RADIUS) == 32;
            Object it$iv = $composer2.rememberedValue();
            if (invalid$iv || it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.CanvasKt$Canvas$2$1
                    /* JADX INFO: Access modifiers changed from: package-private */
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
