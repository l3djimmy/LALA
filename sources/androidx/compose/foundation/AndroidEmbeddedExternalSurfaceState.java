...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    public AndroidEmbeddedExternalSurfaceState(CoroutineScope scope) {
        super(scope);
        this.surfaceSize = IntSize.Companion.m7049getZeroYbymL2g();
        this.matrix = new Matrix();
    }

    /* renamed from: getSurfaceSize-YbymL2g  reason: not valid java name */
    public final long m484getSurfaceSizeYbymL2g() {
        return this.surfaceSize;
    }

    /* renamed from: setSurfaceSize-ozmzZPI  reason: not valid java name */
    public final void m485setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        int w = width;
        int h = height;
        if (!IntSize.m7042equalsimpl0(this.surfaceSize, IntSize.Companion.m7049getZeroYbymL2g())) {
