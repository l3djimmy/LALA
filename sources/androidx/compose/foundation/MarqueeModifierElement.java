...
final class MarqueeModifierElement extends ModifierNodeElement<MarqueeModifierNode> {
    ...
    private final int m584component2ZbEOnfQ() {
    ...
    private final float m585component6D9Ej5fM() {
        return this.velocity;
    }

    /* renamed from: copy-lWfNwf4$default  reason: not valid java name */
    public static /* synthetic */ MarqueeModifierElement m586copylWfNwf4$default(MarqueeModifierElement marqueeModifierElement, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        float f2 = f;
        return marqueeModifierElement.m587copylWfNwf4(i, i2, i3, i4, marqueeSpacing2, f2);
    }

    /* renamed from: copy-lWfNwf4  reason: not valid java name */
    public final MarqueeModifierElement m587copylWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof MarqueeModifierElement) {
            ...
            return this.iterations == marqueeModifierElement.iterations && MarqueeAnimationMode.m577equalsimpl0(this.animationMode, marqueeModifierElement.animationMode) && this.delayMillis == marqueeModifierElement.delayMillis && this.initialDelayMillis == marqueeModifierElement.initialDelayMillis && Intrinsics.areEqual(this.spacing, marqueeModifierElement.spacing) && Dp.m6878equalsimpl0(this.velocity, marqueeModifierElement.velocity);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((((Integer.hashCode(this.iterations) * 31) + MarqueeAnimationMode.m578hashCodeimpl(this.animationMode)) * 31) + Integer.hashCode(this.delayMillis)) * 31) + Integer.hashCode(this.initialDelayMillis)) * 31) + this.spacing.hashCode()) * 31) + Dp.m6879hashCodeimpl(this.velocity);
    }

    public String toString() {
        return "MarqueeModifierElement(iterations=" + this.iterations + ", animationMode=" + ((Object) MarqueeAnimationMode.m579toStringimpl(this.animationMode)) + ", delayMillis=" + this.delayMillis + ", initialDelayMillis=" + this.initialDelayMillis + ", spacing=" + this.spacing + ", velocity=" + ((Object) Dp.m6884toStringimpl(this.velocity)) + ')';
    }
    ...
    public void update(MarqueeModifierNode node) {
        node.m590updatelWfNwf4(this.iterations, this.animationMode, this.delayMillis, this.initialDelayMillis, this.spacing, this.velocity);
    }
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("animationMode", MarqueeAnimationMode.m574boximpl(this.animationMode));
        ...
        $this$inspectableProperties.getProperties().set("velocity", Dp.m6871boximpl(this.velocity));
    }
}
