...
public final class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m522copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m524copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m524copy8Feqmps(float f, Brush brush, Shape shape) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BorderModifierNodeElement) {
            ...
            return Dp.m6878equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
        }
        return false;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m6879hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m6884toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(BorderModifierNode node) {
        node.m521setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo $this$inspectableProperties) {
        ...
        $this$inspectableProperties.getProperties().set("width", Dp.m6871boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            $this$inspectableProperties.getProperties().set(TypedValues.Custom.S_COLOR, Color.m4279boximpl(((SolidColor) this.brush).m4624getValue0d7_KjU()));
            $this$inspectableProperties.setValue(Color.m4279boximpl(((SolidColor) this.brush).m4624getValue0d7_KjU()));
        } else {
