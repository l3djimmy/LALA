...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1201380429, $changed, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:210)");
        }
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedPages$foundation_release(), ComposableLambdaKt.rememberComposableLambda(1142237095, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$Item$1
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(1142237095, $changed2, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:212)");
                    }
                    ...
                    item.invoke(pagerScopeImpl, Integer.valueOf(localIntervalIndex$iv), $composer2, 0);
                    if (ComposerKt.isTraceInProgress()) {
