...
@DebugMetadata(c = "androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$fling$result$1", f = "SnapFlingBehavior.kt", i = {0}, l = {Property.META_INFO, 151}, m = "invokeSuspend", n = {"remainingScrollOffset"}, s = {"L$0"})
    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            ...
            case 1:
                ...
                remainingScrollOffset = (Ref.FloatRef) this.L$0;
                tryApproach = $result2;
                break;
            case 2:
                ResultKt.throwOnFailure($result);
