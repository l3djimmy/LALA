...
public final class AnchoredDraggableState$anchoredDragScope$1 implements AnchoredDragScope {
    ...
    public final void updateBounds(boolean isMovingForward) {
        float currentAnchorPosition = this.this$0.getAnchors().positionOf(this.this$0.getCurrentValue());
        boolean z = this.this$0.getOffset() == currentAnchorPosition;
        AnchoredDraggableState<T> anchoredDraggableState = this.this$0;
        if (z) {
            float searchStartPosition = anchoredDraggableState.getOffset() + (isMovingForward ? 1.0f : -1.0f);
            Object closestAnchor = this.this$0.getAnchors().closestAnchor(searchStartPosition, isMovingForward);
            T t = closestAnchor;
            if (closestAnchor == null) {
