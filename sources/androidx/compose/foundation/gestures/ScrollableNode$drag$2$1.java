...
@DebugMetadata(c = "androidx.compose.foundation.gestures.ScrollableNode$drag$2$1", f = "Scrollable.kt", i = {}, l = {TIFFConstants.TIFFTAG_SUBIFD}, m = "invokeSuspend", n = {}, s = {})
            ...
            case 0:
                ...
                Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.ScrollableNode$drag$2$1.1
                    ...
                    public final void invoke2(DragEvent.DragDelta it) {
                        NestedScrollScope.this.mo737scrollByWithOverscrollOzD1aCk(scrollingLogic.m781singleAxisOffsetMKHz9U(it.m681getDeltaF1C5BW0()), NestedScrollSource.Companion.m5405getUserInputWNlRxjI());
                    }
                };
                this.label = 1;
