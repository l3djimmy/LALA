...
final class TriStateToggleableNode extends ClickableNode {
    ...
    public final void m1268updateQzZPfjk(ToggleableState state, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function0<Unit> function0) {
        if (this.state != state) {
            this.state = state;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m548updateQzZPfjk(interactionSource, indicationNodeFactory, enabled, (String) null, role, function0);
    }
