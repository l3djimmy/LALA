...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public void update(SelectableNode node) {
        node.m1258updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m6100hashCodeimpl(role.m6102unboximpl()) : 0)) * 31) + this.onClick.hashCode();
    }
}
