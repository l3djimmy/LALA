...
final class ToggleableNode extends ClickableNode {
    ...
    public final void m1267updateQzZPfjk(boolean value, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function1<? super Boolean, Unit> function1) {
        if (this.value != value) {
            this.value = value;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        this.onValueChange = function1;
        super.m548updateQzZPfjk(interactionSource, indicationNodeFactory, enabled, (String) null, role, this._onClick);
    }
