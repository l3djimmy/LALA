...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public void update(ToggleableNode node) {
        node.m1267updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((result4 + (role != null ? Role.m6100hashCodeimpl(role.m6102unboximpl()) : 0)) * 31) + this.onValueChange.hashCode();
    }
}
