...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1269createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        if (((topStart + topEnd) + bottomEnd) + bottomStart == 0.0f) {
            return new Outline.Rectangle(SizeKt.m4138toRectuvyYCjk(size));
        }
        Rect m4138toRectuvyYCjk = SizeKt.m4138toRectuvyYCjk(size);
        ...
        long m4002constructorimpl2 = CornerRadius.m4002constructorimpl((v1$iv$iv2 << 32) | (v2$iv$iv2 & 4294967295L));
        long v1$iv$iv3 = Float.floatToRawIntBits(bottomEnd);
        long v2$iv$iv3 = Float.floatToRawIntBits(bottomEnd);
        long m4002constructorimpl3 = CornerRadius.m4002constructorimpl((v1$iv$iv3 << 32) | (v2$iv$iv3 & 4294967295L));
        long v1$iv$iv4 = Float.floatToRawIntBits(bottomStart);
        long v2$iv$iv4 = Float.floatToRawIntBits(bottomStart);
        return new Outline.Rounded(RoundRectKt.m4100RoundRectZAM2FJo(m4138toRectuvyYCjk, m4002constructorimpl, m4002constructorimpl2, m4002constructorimpl3, CornerRadius.m4002constructorimpl((v1$iv$iv4 << 32) | (v2$iv$iv4 & 4294967295L))));
    }
    ...
    private final long m1273toRadiusBz7bX_o(float $this$toRadius_u2dBz7bX_o) {
