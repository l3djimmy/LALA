...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m1282component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m1283copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m1284copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m1284copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m6878equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m6871boximpl(m1285getValueOverrideD9Ej5fM());
    }

    @Override // androidx.compose.foundation.shape.CornerSize
    /* renamed from: toPx-TmRCtEA */
    public float mo1277toPxTmRCtEA(long shapeSize, Density density) {
        return density.mo644toPx0680j_4(this.size);
    }
    ...
    public float m1285getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
