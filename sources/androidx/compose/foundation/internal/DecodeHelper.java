...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte == 1) {
                ...
                mutableSpanStyle.m837setColor8_81llA(m818decodeColor0d7_KjU());
            } else if (decodeByte == 2) {
                if (dataAvailable() < 5) {
                    break;
                }
                mutableSpanStyle.m838setFontSizeR2X_6o(m821decodeTextUnitXSAIIZE());
                ...
                mutableSpanStyle.m839setFontStylemLjRB2g(FontStyle.m6447boximpl(m819decodeFontStyle_LCdwA()));
            } else if (decodeByte == 5) {
                if (dataAvailable() < 1) {
                    break;
                }
                mutableSpanStyle.m840setFontSynthesistDdu0R4(FontSynthesis.m6458boximpl(m820decodeFontSynthesisGVVA2EU()));
                ...
                mutableSpanStyle.m841setLetterSpacingR2X_6o(m821decodeTextUnitXSAIIZE());
            } else if (decodeByte == 8) {
                if (dataAvailable() < 4) {
                    break;
                }
                mutableSpanStyle.m836setBaselineShift_isdbwI(BaselineShift.m6629boximpl(m816decodeBaselineShifty9eOQZs()));
                ...
                mutableSpanStyle.m835setBackground8_81llA(m818decodeColor0d7_KjU());
    ...
    public final long m818decodeColor0d7_KjU() {
        return Color.m4285constructorimpl(m817decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE  reason: not valid java name */
    public final long m821decodeTextUnitXSAIIZE() {
        long type;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            type = TextUnitType.Companion.m7100getSpUIouoOA();
        } else {
            type = decodeByte == 2 ? TextUnitType.Companion.m7099getEmUIouoOA() : TextUnitType.Companion.m7101getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m7095equalsimpl0(type, TextUnitType.Companion.m7101getUnspecifiedUIouoOA())) {
            return TextUnit.Companion.m7078getUnspecifiedXSAIIZE();
        }
        float value = decodeFloat();
        return TextUnitKt.m7079TextUnitanM5pPY(value, type);
    }
    ...
    public final int m819decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontStyle.Companion.m6457getNormal_LCdwA() : decodeByte == 1 ? FontStyle.Companion.m6456getItalic_LCdwA() : FontStyle.Companion.m6457getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m820decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        return decodeByte == 0 ? FontSynthesis.Companion.m6468getNoneGVVA2EU() : decodeByte == 1 ? FontSynthesis.Companion.m6467getAllGVVA2EU() : decodeByte == 3 ? FontSynthesis.Companion.m6469getStyleGVVA2EU() : decodeByte == 2 ? FontSynthesis.Companion.m6470getWeightGVVA2EU() : FontSynthesis.Companion.m6468getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs  reason: not valid java name */
    private final float m816decodeBaselineShifty9eOQZs() {
        return BaselineShift.m6630constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long m818decodeColor0d7_KjU = m818decodeColor0d7_KjU();
        float x$iv = decodeFloat();
        float y$iv = decodeFloat();
        long v1$iv$iv = Float.floatToRawIntBits(x$iv);
        long v2$iv$iv = Float.floatToRawIntBits(y$iv);
        return new Shadow(m818decodeColor0d7_KjU, Offset.m4040constructorimpl((v1$iv$iv << 32) | (4294967295L & v2$iv$iv)), decodeFloat(), null);
    }
    ...
    private final long m817decodeULongsVKNKU() {
        return ULong.m7515constructorimpl(this.parcel.readLong());
    }
