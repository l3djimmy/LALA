...
public final class LazyGridState implements ScrollableState {
    ...
    public LazyGridState(final int firstVisibleItemIndex, int firstVisibleItemScrollOffset, LazyGridPrefetchStrategy prefetchStrategy) {
        ...
        this.prefetchScope = new LazyGridPrefetchScope() { // from class: androidx.compose.foundation.lazy.grid.LazyGridState$prefetchScope$1
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                LazyGridMeasureResult layoutInfo;
                ...
                try {
                    if (!lazyGridState.getHasLookaheadOccurred$foundation_release()) {
                        ...
                        layoutInfo = (LazyGridMeasureResult) mutableState.getValue();
                    } else {
                        layoutInfo = lazyGridState.getApproachLayoutInfo$foundation_release();
                    }
                    if (layoutInfo != null) {
                        LazyGridMeasureResult it = layoutInfo;
                        List $this$fastForEach$iv = it.getPrefetchInfoRetriever().invoke(Integer.valueOf(lineIndex));
                        int index$iv = 0;
                        ...
                        while (index$iv < size) {
                            ...
                            prefetchHandles.add(lazyGridState2.getPrefetchState$foundation_release().m1170schedulePrefetch0kLqBqw(lineInfo.getFirst().intValue(), lineInfo.getSecond().m6832unboximpl()));
                            index$iv++;
    ...
    public final MutableState<Unit> m1143getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m1142getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
