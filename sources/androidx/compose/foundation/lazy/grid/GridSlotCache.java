...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo1122invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m6813boximpl(constraints));
