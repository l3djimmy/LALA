...
public final class LazyGridItemProviderImpl implements LazyGridItemProvider {
    ...
    public void Item(final int index, Object key, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1493551140, $changed, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item (LazyGridItemProvider.kt:81)");
        }
        LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.rememberComposableLambda(726189336, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl$Item$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke(Composer $composer2, int $changed2) {
                ...
                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(726189336, $changed2, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item.<anonymous> (LazyGridItemProvider.kt:83)");
                    }
                    ...
                    content.getItem().invoke(LazyGridItemScopeImpl.INSTANCE, Integer.valueOf(localIntervalIndex$iv), $composer2, 6);
                    if (ComposerKt.isTraceInProgress()) {
