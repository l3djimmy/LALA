...
public final class LazyStaggeredGridDslKt$itemsIndexed$5 extends Lambda implements Function4<LazyStaggeredGridItemScope, Integer, Composer, Integer, Unit> {
    ...
    public final void invoke(LazyStaggeredGridItemScope $this$items, int index, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(284833944, $dirty, -1, "androidx.compose.foundation.lazy.staggeredgrid.itemsIndexed.<anonymous> (LazyStaggeredGridDsl.kt:444)");
        }
        this.$itemContent.invoke($this$items, Integer.valueOf(index), this.$items.get(index), $composer, Integer.valueOf(($dirty & 14) | ($dirty & Property.BORDER_BOTTOM_RIGHT_RADIUS)));
        if (ComposerKt.isTraceInProgress()) {
