...
final class LazyStaggeredGridSlotCache implements LazyGridStaggeredGridSlotsProvider {
    ...
    public LazyStaggeredGridSlots mo1192invoke0kLqBqw(Density density, long constraints) {
        if (this.cachedSizes != null && Constraints.m6819equalsimpl0(this.cachedConstraints, constraints)) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m6813boximpl(constraints));
