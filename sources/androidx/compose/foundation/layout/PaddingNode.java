...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6873constructorimpl(0) : f, (i & 2) != 0 ? Dp.m6873constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m6873constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m6873constructorimpl(0) : f4, z, null);
    }

    /* renamed from: getStart-D9Ej5fM  reason: not valid java name */
    public final float m1000getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: setStart-0680j_4  reason: not valid java name */
    public final void m1004setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m1005setTop0680j_4(float f) {
        this.top = f;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m999getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: setEnd-0680j_4  reason: not valid java name */
    public final void m1003setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m1002setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo328measure3p2s80s(final MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        int horizontal = $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(this.start) + $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(this.end);
        int vertical = $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(this.top) + $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(this.bottom);
        ...
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope $this$layout) {
                ...
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(PaddingNode.this.m1000getStartD9Ej5fM()), $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(PaddingNode.this.m1001getTopD9Ej5fM()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default($this$layout, placeable2, $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(PaddingNode.this.m1000getStartD9Ej5fM()), $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(PaddingNode.this.m1001getTopD9Ej5fM()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
