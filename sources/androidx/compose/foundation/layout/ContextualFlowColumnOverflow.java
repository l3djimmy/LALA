...
public final class ContextualFlowColumnOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
                ...
                public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                    ...
                    return ComposableLambdaKt.composableLambdaInstance(317361705, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowColumnOverflow$Companion$expandIndicator$seeMoreGetter$1.1
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ComposerKt.sourceInformation($composer, "C524@24616L9:FlowLayoutOverflow.kt#2w3rfo");
                            if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(317361705, $changed, -1, "androidx.compose.foundation.layout.ContextualFlowColumnOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:523)");
                                }
        ...
        public final ContextualFlowColumnOverflow m907expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowColumnOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minColumnsToShowCollapse, float minWidthToShowCollapse, Composer $composer, int $changed, int i) {
            ComposerKt.sourceInformationMarkerStart($composer, -1875330022, "C(expandOrCollapseIndicator)P(1!,3:c#ui.unit.Dp)*564@26786L7,565@26853L1122:FlowLayoutOverflow.kt#2w3rfo");
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1875330022, $changed, -1, "androidx.compose.foundation.layout.ContextualFlowColumnOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:562)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer, -1286151304, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(-1318130763, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowColumnOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ComposerKt.sourceInformation($composer2, "C574@27247L17:FlowLayoutOverflow.kt#2w3rfo");
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-1318130763, $changed2, -1, "androidx.compose.foundation.layout.ContextualFlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:573)");
                                    }
                                    ContextualFlowColumnOverflowScopeImpl scope = new ContextualFlowColumnOverflowScopeImpl(FlowLayoutOverflowState.this);
                ...
                Function1 collapseGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.ContextualFlowColumnOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(-2119675914, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowColumnOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ComposerKt.sourceInformation($composer2, "C581@27524L19:FlowLayoutOverflow.kt#2w3rfo");
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-2119675914, $changed2, -1, "androidx.compose.foundation.layout.ContextualFlowColumnOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:580)");
                                    }
                                    ContextualFlowColumnOverflowScopeImpl scope = new ContextualFlowColumnOverflowScopeImpl(FlowLayoutOverflowState.this);
                                    function33.invoke(scope, $composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
