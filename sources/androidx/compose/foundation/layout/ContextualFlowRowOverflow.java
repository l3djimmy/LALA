...
public final class ContextualFlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
        ...
        public final ContextualFlowRowOverflow expandIndicator(final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3) {
            Function1 seeMoreGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1
                ...
                public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                    final Function3<ContextualFlowRowOverflowScope, Composer, Integer, Unit> function32 = function3;
                    return ComposableLambdaKt.composableLambdaInstance(1850548683, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1.1
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ComposerKt.sourceInformation($composer, "C382@17990L9:FlowLayoutOverflow.kt#2w3rfo");
                            if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(1850548683, $changed, -1, "androidx.compose.foundation.layout.ContextualFlowRowOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:381)");
                                }
        ...
        public final ContextualFlowRowOverflow m910expandOrCollapseIndicatorjt2gSs(final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minRowsToShowCollapse, float minHeightToShowCollapse, Composer $composer, int $changed, int i) {
            ComposerKt.sourceInformationMarkerStart($composer, 1435293820, "C(expandOrCollapseIndicator)P(1!1,3,2:c#ui.unit.Dp)*422@20138L7,423@20206L1109:FlowLayoutOverflow.kt#2w3rfo");
            int minRowsToShowCollapse2 = (i & 4) != 0 ? 1 : minRowsToShowCollapse;
            float minHeightToShowCollapse2 = (i & 8) != 0 ? Dp.m6873constructorimpl(0) : minHeightToShowCollapse;
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1435293820, $changed, -1, "androidx.compose.foundation.layout.ContextualFlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:420)");
            }
            ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC(<get-current>):CompositionLocal.kt#9igjgp");
            Object consume = $composer.consume(CompositionLocalsKt.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd($composer);
            Density $this$expandOrCollapseIndicator__jt2gSs_u24lambda_u240 = (Density) consume;
            int minHeightToShowCollapsePx = $this$expandOrCollapseIndicator__jt2gSs_u24lambda_u240.mo638roundToPx0680j_4(minHeightToShowCollapse2);
            ComposerKt.sourceInformationMarkerStart($composer, 172957149, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            boolean invalid$iv = (((($changed & 896) ^ 384) > 256 && $composer.changed(minRowsToShowCollapse2)) || ($changed & 384) == 256) | $composer.changed(minHeightToShowCollapsePx) | (((($changed & 14) ^ 6) > 4 && $composer.changed(function3)) || ($changed & 6) == 4) | (((($changed & Property.BORDER_BOTTOM_RIGHT_RADIUS) ^ 48) > 32 && $composer.changed(function32)) || ($changed & 48) == 32);
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(897838875, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ComposerKt.sourceInformation($composer2, "C432@20595L17:FlowLayoutOverflow.kt#2w3rfo");
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(897838875, $changed2, -1, "androidx.compose.foundation.layout.ContextualFlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:431)");
                                    }
                                    ContextualFlowRowOverflowScopeImpl scope = new ContextualFlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                ...
                Function1 collapseGetter = new Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(307858874, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ComposerKt.sourceInformation($composer2, "C439@20869L19:FlowLayoutOverflow.kt#2w3rfo");
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(307858874, $changed2, -1, "androidx.compose.foundation.layout.ContextualFlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:438)");
                                    }
                                    ContextualFlowRowOverflowScopeImpl scope = new ContextualFlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                                    function33.invoke(scope, $composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
