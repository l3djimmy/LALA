...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        int width = Constraints.m6824getHasFixedWidthimpl(constraints) ? Constraints.m6826getMaxWidthimpl(constraints) : 0;
        int height = Constraints.m6823getHasFixedHeightimpl(constraints) ? Constraints.m6825getMaxHeightimpl(constraints) : 0;
