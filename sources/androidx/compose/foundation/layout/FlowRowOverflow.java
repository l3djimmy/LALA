...
public final class FlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final class Companion {
                        ...
                        public final void invoke(Composer $composer, int $changed) {
                            ...
                            if ($composer.shouldExecute(($changed & 3) != 2, $changed & 1)) {
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventStart(263270381, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandIndicator.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:104)");
                                }
        ...
        public final FlowRowOverflow m941expandOrCollapseIndicatorjt2gSs(final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, final Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int minRowsToShowCollapse, float minHeightToShowCollapse, Composer $composer, int $changed, int i) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-58693346, $changed, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:140)");
            }
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(2094557836, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(2094557836, $changed2, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:151)");
                                    }
                                    FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                    ...
                    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState state) {
                        ...
                        return ComposableLambdaKt.composableLambdaInstance(-972285589, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.layout.FlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1.1
                            ...
                            public final void invoke(Composer $composer2, int $changed2) {
                                ...
                                if ($composer2.shouldExecute(($changed2 & 3) != 2, $changed2 & 1)) {
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventStart(-972285589, $changed2, -1, "androidx.compose.foundation.layout.FlowRowOverflow.Companion.expandOrCollapseIndicator.<anonymous>.<anonymous>.<anonymous> (FlowLayoutOverflow.kt:158)");
                                    }
                                    FlowRowOverflowScopeImpl scope = new FlowRowOverflowScopeImpl(FlowLayoutOverflowState.this);
                                    function33.invoke(scope, $composer2, 0);
                                    if (ComposerKt.isTraceInProgress()) {
