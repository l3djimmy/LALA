...
public final class WindowInsetsHolder {
    ...
    private WindowInsetsHolder(WindowInsetsCompat insets, View view) {
        ...
        this.displayCutout = Companion.systemInsets(insets, WindowInsetsCompat.Type.displayCutout(), "displayCutout");
        this.ime = Companion.systemInsets(insets, WindowInsetsCompat.Type.ime(), "ime");
        this.mandatorySystemGestures = Companion.systemInsets(insets, WindowInsetsCompat.Type.mandatorySystemGestures(), "mandatorySystemGestures");
        ...
        this.systemBars = Companion.systemInsets(insets, WindowInsetsCompat.Type.systemBars(), "systemBars");
        this.systemGestures = Companion.systemInsets(insets, WindowInsetsCompat.Type.systemGestures(), "systemGestures");
        this.tappableElement = Companion.systemInsets(insets, WindowInsetsCompat.Type.tappableElement(), "tappableElement");
        this.waterfall = WindowInsets_androidKt.ValueInsets((insets == null || (displayCutout = insets.getDisplayCutout()) == null || (insets2 = displayCutout.getWaterfallInsets()) == null) ? Insets.NONE : insets2, "waterfall");
    ...
    public static final class Companion {
        ...
        public final WindowInsetsHolder current(Composer $composer, int $changed) {
            ComposerKt.sourceInformationMarkerStart($composer, -1366542614, "C(current)579@22913L7,582@23005L125,582@22980L150:WindowInsets.android.kt#2w3rfo");
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1366542614, $changed, -1, "androidx.compose.foundation.layout.WindowInsetsHolder.Companion.current (WindowInsets.android.kt:578)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart($composer, 334589666, "CC(remember):WindowInsets.android.kt#9igjgp");
            boolean invalid$iv = $composer.changedInstance(insets) | $composer.changedInstance(view);
            Object it$iv = $composer.rememberedValue();
            if (invalid$iv || it$iv == Composer.Companion.getEmpty()) {
                Object value$iv = (Function1) new Function1<DisposableEffectScope, DisposableEffectResult>() { // from class: androidx.compose.foundation.layout.WindowInsetsHolder$Companion$current$1$1
            ...
            ComposerKt.sourceInformationMarkerEnd($composer);
            EffectsKt.DisposableEffect(insets, (Function1) it$iv, $composer, 0);
            if (ComposerKt.isTraceInProgress()) {
