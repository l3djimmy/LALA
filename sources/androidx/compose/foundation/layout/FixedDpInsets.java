...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.mo638roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        return density.mo638roundToPx0680j_4(this.topDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.mo638roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        return density.mo638roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m6884toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m6884toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m6884toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m6884toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof FixedDpInsets) {
            return Dp.m6878equalsimpl0(this.leftDp, ((FixedDpInsets) other).leftDp) && Dp.m6878equalsimpl0(this.topDp, ((FixedDpInsets) other).topDp) && Dp.m6878equalsimpl0(this.rightDp, ((FixedDpInsets) other).rightDp) && Dp.m6878equalsimpl0(this.bottomDp, ((FixedDpInsets) other).bottomDp);
        }
        return false;
    }

    public int hashCode() {
        int result = Dp.m6879hashCodeimpl(this.leftDp);
        return (((((result * 31) + Dp.m6879hashCodeimpl(this.topDp)) * 31) + Dp.m6879hashCodeimpl(this.rightDp)) * 31) + Dp.m6879hashCodeimpl(this.bottomDp);
    }
}
