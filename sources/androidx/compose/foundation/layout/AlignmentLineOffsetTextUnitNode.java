...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final long m861getBeforeXSAIIZE() {
        return this.before;
    }

    /* renamed from: setBefore--R2X_6o  reason: not valid java name */
    public final void m863setBeforeR2X_6o(long j) {
        this.before = j;
    }

    /* renamed from: getAfter-XSAIIZE  reason: not valid java name */
    public final long m860getAfterXSAIIZE() {
        return this.after;
    }

    /* renamed from: setAfter--R2X_6o  reason: not valid java name */
    public final void m862setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo328measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        MeasureResult m843alignmentLineOffsetMeasuretjqqzMA;
        AlignmentLine alignmentLine = this.alignmentLine;
        long $this$isUnspecified$iv = this.before;
        float f = ((TextUnit.m7065getRawTypeimpl($this$isUnspecified$iv) > 0L ? 1 : (TextUnit.m7065getRawTypeimpl($this$isUnspecified$iv) == 0L ? 0 : -1)) == 0 ? 1 : 0) == 0 ? $this$measure_u2d3p2s80s.mo639toDpGaN1DYA(this.before) : Dp.Companion.m6893getUnspecifiedD9Ej5fM();
        long $this$isUnspecified$iv2 = this.after;
        m843alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m843alignmentLineOffsetMeasuretjqqzMA($this$measure_u2d3p2s80s, alignmentLine, f, !(TextUnit.m7065getRawTypeimpl($this$isUnspecified$iv2) == 0) ? $this$measure_u2d3p2s80s.mo639toDpGaN1DYA(this.after) : Dp.Companion.m6893getUnspecifiedD9Ej5fM(), measurable, constraints);
        return m843alignmentLineOffsetMeasuretjqqzMA;
    }
}
