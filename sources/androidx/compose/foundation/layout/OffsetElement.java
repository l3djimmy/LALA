...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public final float m948getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m949getYD9Ej5fM() {
        return this.y;
    }
    ...
    private OffsetElement(float x, float y, boolean rtlAware, Function1<? super InspectorInfo, Unit> function1) {
        this.x = x;
        this.y = y;
    ...
    public void update(OffsetNode node) {
        node.m958updateMdfbLM(this.x, this.y, this.rtlAware);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6878equalsimpl0(this.x, otherModifierElement.x) && Dp.m6878equalsimpl0(this.y, otherModifierElement.y) && this.rtlAware == otherModifierElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int result = Dp.m6879hashCodeimpl(this.x);
        return (((result * 31) + Dp.m6879hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m6884toStringimpl(this.x)) + ", y=" + ((Object) Dp.m6884toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
