...
public final class RowMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> list, long constraints) {
        return RowColumnMeasurePolicyKt.measure$default(this, Constraints.m6828getMinWidthimpl(constraints), Constraints.m6827getMinHeightimpl(constraints), Constraints.m6826getMaxWidthimpl(constraints), Constraints.m6825getMaxHeightimpl(constraints), $this$measure_u2d3p2s80s.mo638roundToPx0680j_4(this.horizontalArrangement.mo880getSpacingD9Ej5fM()), $this$measure_u2d3p2s80s, list, new Placeable[list.size()], 0, list.size(), null, 0, 3072, null);
    }
    ...
    public long mo906createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing) {
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinWidth(list, height, $this$minIntrinsicWidth.mo638roundToPx0680j_4(this.horizontalArrangement.mo880getSpacingD9Ej5fM()));
    }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMinHeight(list, width, $this$minIntrinsicHeight.mo638roundToPx0680j_4(this.horizontalArrangement.mo880getSpacingD9Ej5fM()));
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends IntrinsicMeasurable> list, int height) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxWidth(list, height, $this$maxIntrinsicWidth.mo638roundToPx0680j_4(this.horizontalArrangement.mo880getSpacingD9Ej5fM()));
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends IntrinsicMeasurable> list, int width) {
        return IntrinsicMeasureBlocks.INSTANCE.HorizontalMaxHeight(list, width, $this$maxIntrinsicHeight.mo638roundToPx0680j_4(this.horizontalArrangement.mo880getSpacingD9Ej5fM()));
    }
}
