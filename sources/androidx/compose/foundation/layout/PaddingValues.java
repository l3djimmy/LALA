...
public interface PaddingValues {
    ...
    float mo943calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateRightPadding-u2uoSUM */
    float mo944calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection);

    /* renamed from: calculateTopPadding-D9Ej5fM */
    float mo945calculateTopPaddingD9Ej5fM();
    ...
    public static final class Absolute implements PaddingValues {
        ...
        private static /* synthetic */ void m1006getBottomD9Ej5fM$annotations() {
        }

        /* renamed from: getLeft-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m1007getLeftD9Ej5fM$annotations() {
        }

        /* renamed from: getRight-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m1008getRightD9Ej5fM$annotations() {
        }

        /* renamed from: getTop-D9Ej5fM$annotations  reason: not valid java name */
        private static /* synthetic */ void m1009getTopD9Ej5fM$annotations() {
        }
        ...
        private Absolute(float left, float top, float right, float bottom) {
            ...
            this.right = right;
            this.bottom = bottom;
            boolean value$iv = (this.left >= 0.0f) & (this.top >= 0.0f) & (this.right >= 0.0f) & (this.bottom >= 0.0f);
            if (value$iv) {
                return;
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof Absolute) && Dp.m6878equalsimpl0(this.left, ((Absolute) other).left) && Dp.m6878equalsimpl0(this.top, ((Absolute) other).top) && Dp.m6878equalsimpl0(this.right, ((Absolute) other).right) && Dp.m6878equalsimpl0(this.bottom, ((Absolute) other).bottom);
        }
        ...
        public String toString() {
            return "PaddingValues.Absolute(left=" + ((Object) Dp.m6884toStringimpl(this.left)) + ", top=" + ((Object) Dp.m6884toStringimpl(this.top)) + ", right=" + ((Object) Dp.m6884toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m6884toStringimpl(this.bottom)) + ')';
        }
    }
}
