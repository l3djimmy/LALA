...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        staggeredGridLayoutManager.updateAllRemainingSpans(layoutState.mLayoutDirection, targetLine);
        boolean z2 = staggeredGridLayoutManager.mShouldReverseLayout;
        ...
        while (true) {
            if (!layoutState.hasMore(state)) {
                i = r8;
                break;
            } else if (!staggeredGridLayoutManager.mLayoutState.mInfinite && staggeredGridLayoutManager.mRemainingSpans.isEmpty()) {
                i = r8;
                break;
            } else {
                ...
                boolean assignSpan = spanIndex == -1 ? r9 : r8;
                if (assignSpan) {
                    currentSpan = lp.mFullSpan ? staggeredGridLayoutManager.mSpans[r8] : staggeredGridLayoutManager.getNextSpan(layoutState);
                ...
                if (layoutState.mLayoutDirection == r9) {
                    start = lp.mFullSpan ? staggeredGridLayoutManager.getMaxEnd(defaultNewViewLine) : currentSpan.getEndLine(defaultNewViewLine);
                    ...
                    end = lp.mFullSpan ? staggeredGridLayoutManager.getMinStart(defaultNewViewLine) : currentSpan.getStartLine(defaultNewViewLine);
                ...
                if (lp.mFullSpan && layoutState.mItemDirection == -1) {
                    if (assignSpan) {
                        staggeredGridLayoutManager.mLaidOutInvalidFullSpan = r9;
                    } else {
                        if (layoutState.mLayoutDirection == r9) {
                            i2 = (staggeredGridLayoutManager.areAllEndsEqual() ? 1 : 0) ^ r9;
                        } else {
                            boolean hasInvalidGap = staggeredGridLayoutManager.areAllStartsEqual();
                            i2 = (hasInvalidGap ? 1 : 0) ^ r9;
                        }
                        if (i2 != 0) {
                            ...
                            if (fullSpanItem3 != null) {
                                fullSpanItem3.mHasUnwantedGapAfter = r9;
                            }
                            staggeredGridLayoutManager.mLaidOutInvalidFullSpan = r9;
                        }
                    }
                }
                staggeredGridLayoutManager.attachViewToSpans(view, lp, layoutState);
                if (staggeredGridLayoutManager.isLayoutRTL() && staggeredGridLayoutManager.mOrientation == r9) {
                    boolean z3 = lp.mFullSpan;
                    OrientationHelper orientationHelper2 = staggeredGridLayoutManager.mSecondaryOrientation;
                    otherEnd = z3 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((staggeredGridLayoutManager.mSpanCount - r9) - currentSpan.mIndex) * staggeredGridLayoutManager.mSizePerSpan);
                    otherStart = otherEnd - staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(view);
                } else {
                    otherStart = lp.mFullSpan ? staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding() : (currentSpan.mIndex * staggeredGridLayoutManager.mSizePerSpan) + staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding();
                    otherEnd = staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(view) + otherStart;
                }
                int otherStart2 = otherStart;
                if (staggeredGridLayoutManager.mOrientation == 1) {
                    currentSpan2 = currentSpan;
                    start2 = otherStart2;
                    staggeredGridLayoutManager.layoutDecoratedWithMargins(view, start2, start3, otherEnd, start4);
                    staggeredGridLayoutManager = this;
                } else {
                    currentSpan2 = currentSpan;
                    staggeredGridLayoutManager = this;
                    staggeredGridLayoutManager.layoutDecoratedWithMargins(view, start3, otherStart2, start4, otherEnd);
                    start2 = otherStart2;
                }
                boolean z4 = lp.mFullSpan;
                ...
                if (z4) {
                    ...
                    staggeredGridLayoutManager.updateRemainingSpans(currentSpan2, layoutState2.mLayoutDirection, targetLine);
                }
                ...
                if (staggeredGridLayoutManager.mLayoutState.mStopInFocusable && view.hasFocusable()) {
                    ...
                    if (z5) {
                        ...
                        z = false;
                        bitSet.set(currentSpan2.mIndex, false);
                    }
                } else {
                    z = false;
                }
        ...
        int i3 = staggeredGridLayoutManager.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = staggeredGridLayoutManager.mPrimaryOrientation;
        if (i3 == -1) {
            int minStart = staggeredGridLayoutManager.getMinStart(orientationHelper3.getStartAfterPadding());
            diff = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding() - minStart;
        } else {
            int maxEnd = staggeredGridLayoutManager.getMaxEnd(orientationHelper3.getEndAfterPadding());
            diff = maxEnd - staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding();
        }
    ...
    public class Span {
        ...
        public int findFirstVisibleItemPosition() {
            ...
            return z ? findOneVisibleChild(arrayList.size() - 1, -1, false) : findOneVisibleChild(0, arrayList.size(), false);
        }
        ...
        public int findLastVisibleItemPosition() {
            boolean z = StaggeredGridLayoutManager.this.mReverseLayout;
            ArrayList<View> arrayList = this.mViews;
            return z ? findOneVisibleChild(0, arrayList.size(), false) : findOneVisibleChild(arrayList.size() - 1, -1, false);
        }
