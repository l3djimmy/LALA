...
public final class Camera2Config {
    ...
    public static CameraXConfig defaultConfig() {
        CameraFactory.Provider cameraFactoryProvider = new CameraFactory.Provider() { // from class: androidx.camera.camera2.Camera2Config$$ExternalSyntheticLambda0
        ...
        CameraDeviceSurfaceManager.Provider surfaceManagerProvider = new CameraDeviceSurfaceManager.Provider() { // from class: androidx.camera.camera2.Camera2Config$$ExternalSyntheticLambda1
        ...
        UseCaseConfigFactory.Provider configFactoryProvider = new UseCaseConfigFactory.Provider() { // from class: androidx.camera.camera2.Camera2Config$$ExternalSyntheticLambda2
    ...
    public static /* synthetic */ CameraDeviceSurfaceManager lambda$defaultConfig$0(Context context, Object cameraManager, Set availableCameraIds) throws InitializationException {
        try {
