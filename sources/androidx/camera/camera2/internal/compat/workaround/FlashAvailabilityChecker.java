...
public final class FlashAvailabilityChecker {
    ...
    public static boolean isFlashAvailable(CameraCharacteristicsProvider provider) {
        return isFlashAvailable(false, provider);
    }

    public static boolean isFlashAvailable(boolean allowRethrowOnError, CameraCharacteristicsProvider provider) {
