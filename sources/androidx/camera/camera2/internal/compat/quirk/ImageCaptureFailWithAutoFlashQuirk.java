...
public class ImageCaptureFailWithAutoFlashQuirk implements Quirk {
    ...
    public static boolean load(CameraCharacteristicsCompat cameraCharacteristics) {
        return BUILD_MODELS_FRONT_CAMERA.contains(Build.MODEL.toLowerCase(Locale.US)) && ((Integer) cameraCharacteristics.get(CameraCharacteristics.LENS_FACING)).intValue() == 0;
    }
}
