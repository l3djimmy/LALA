...
public class FlashAvailabilityBufferUnderflowQuirk implements Quirk {
    ...
    private static void addAffectedDevice(String manufacturer, String model) {
        KNOWN_AFFECTED_MODELS.add(new Pair<>(manufacturer.toLowerCase(Locale.US), model.toLowerCase(Locale.US)));
    }
