...
public class ExtraSupportedSurfaceCombinationsQuirk implements Quirk {
    ...
    public List<SurfaceCombination> getExtraSupportedSurfaceCombinations(String cameraId, int hardwareLevel) {
        if (isSamsungS7()) {
    ...
    private List<SurfaceCombination> getSamsungS7ExtraCombinations(String cameraId) {
    ...
    private List<SurfaceCombination> getLimitedDeviceExtraSupportedFullConfigurations(int hardwareLevel) {
        List<SurfaceCombination> extraCombinations = new ArrayList<>();
        if (hardwareLevel == 0) {
            extraCombinations.add(FULL_LEVEL_YUV_PRIV_YUV_CONFIGURATION);
