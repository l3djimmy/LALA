...
public final class DynamicRangesCompat {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public DynamicRangesCompat(DynamicRangeProfilesCompatImpl impl) {
        this.mImpl = impl;
    }
    ...
    public static DynamicRangesCompat fromCameraCharacteristics(CameraCharacteristicsCompat characteristics) {
        DynamicRangesCompat rangesCompat = null;
        if (Build.VERSION.SDK_INT >= 33) {
            rangesCompat = toDynamicRangesCompat((DynamicRangeProfiles) characteristics.get(CameraCharacteristics.REQUEST_AVAILABLE_DYNAMIC_RANGE_PROFILES));
        }
