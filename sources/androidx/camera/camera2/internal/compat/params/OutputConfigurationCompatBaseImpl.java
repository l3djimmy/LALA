...
class OutputConfigurationCompatBaseImpl implements OutputConfigurationCompat.OutputConfigurationCompatImpl {
    ...
    public void setDynamicRangeProfile(long profile) {
        ((OutputConfigurationParamsApi21) this.mObject).mDynamicRangeProfile = profile;
    }
    ...
    public static final class OutputConfigurationParamsApi21 {
        ...
        private static int getSurfaceGenerationId(Surface surface) {
            try {
                ...
                return ((Integer) getGenerationId.invoke(surface, new Object[0])).intValue();
        ...
        public boolean equals(Object obj) {
            if (obj instanceof OutputConfigurationParamsApi21) {
                ...
                if (this.mConfiguredSize.equals(otherOutputConfig.mConfiguredSize) && this.mConfiguredFormat == otherOutputConfig.mConfiguredFormat && this.mConfiguredGenerationId == otherOutputConfig.mConfiguredGenerationId && this.mIsShared == otherOutputConfig.mIsShared && this.mDynamicRangeProfile == otherOutputConfig.mDynamicRangeProfile && Objects.equals(this.mPhysicalCameraId, otherOutputConfig.mPhysicalCameraId)) {
        ...
        public int hashCode() {
            ...
            int h6 = ((h5 << 5) - h5) ^ (this.mPhysicalCameraId == null ? 0 : this.mPhysicalCameraId.hashCode());
            return ((h6 << 5) - h6) ^ Long.hashCode(this.mDynamicRangeProfile);
        }
    }
}
