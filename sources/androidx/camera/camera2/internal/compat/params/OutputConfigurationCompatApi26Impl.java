...
public class OutputConfigurationCompatApi26Impl extends OutputConfigurationCompatApi24Impl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public OutputConfigurationCompatApi26Impl(int surfaceGroupId, Surface surface) {
    ...
    public void setDynamicRangeProfile(long profile) {
        ((OutputConfigurationParamsApi26) this.mObject).mDynamicRangeProfile = profile;
    }
    ...
    public void removeSurface(Surface surface) {
        ...
        try {
            List<Surface> surfaces = getMutableSurfaceListApi26((OutputConfiguration) getOutputConfiguration());
    ...
    public static final class OutputConfigurationParamsApi26 {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof OutputConfigurationParamsApi26) {
                ...
                return Objects.equals(this.mOutputConfiguration, otherOutputConfig.mOutputConfiguration) && this.mDynamicRangeProfile == otherOutputConfig.mDynamicRangeProfile && Objects.equals(this.mPhysicalCameraId, otherOutputConfig.mPhysicalCameraId);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int h2 = ((h << 5) - h) ^ (this.mPhysicalCameraId == null ? 0 : this.mPhysicalCameraId.hashCode());
            return ((h2 << 5) - h2) ^ Long.hashCode(this.mDynamicRangeProfile);
        }
    }
}
