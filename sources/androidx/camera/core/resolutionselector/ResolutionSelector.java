...
public final class ResolutionSelector {
    ...
    ResolutionSelector(AspectRatioStrategy aspectRatioStrategy, ResolutionStrategy resolutionStrategy, ResolutionFilter resolutionFilter, int allowedResolutionMode) {
    ...
    public static final class Builder {
        ...
        public Builder setAllowedResolutionMode(int mode) {
