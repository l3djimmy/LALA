...
public final class Threads {
    ...
    public static void runOnMainSync(final Runnable runnable) {
        ...
        boolean postResult = getMainHandler().post(new Runnable() { // from class: androidx.camera.core.impl.utils.Threads$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Threads.lambda$runOnMainSync$0(runnable, latch);
            }
        });
    ...
    public static /* synthetic */ void lambda$runOnMainSync$0(Runnable runnable, CountDownLatch latch) {
        try {
            runnable.run();
        } finally {
            latch.countDown();
