...
public final class Futures {
    ...
    public static <I, O> ListenableFuture<O> transform(ListenableFuture<I> input, final Function<? super I, ? extends O> function, Executor executor) {
        ...
        return transformAsync(input, new AsyncFunction<I, O>() { // from class: androidx.camera.core.impl.utils.futures.Futures.1
            ...
            public ListenableFuture<O> apply(I input2) {
                return Futures.immediateFuture(Function.this.apply(input2));
            }
        }, executor);
    }
    ...
    public static <V> ListenableFuture<V> nonCancellationPropagating(final ListenableFuture<V> future) {
        ...
        ListenableFuture<V> output = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.utils.futures.Futures$$ExternalSyntheticLambda0
    ...
    public static /* synthetic */ Object lambda$nonCancellationPropagating$0(ListenableFuture future, CallbackToFutureAdapter.Completer completer) throws Exception {
        propagateTransform(false, future, IDENTITY_FUNCTION, completer, CameraXExecutors.directExecutor());
