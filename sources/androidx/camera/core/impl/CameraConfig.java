...
public interface CameraConfig extends ReadableConfig {
    ...
    default SessionProcessor getSessionProcessor(SessionProcessor valueIfMissing) {
        return (SessionProcessor) retrieveOption(OPTION_SESSION_PROCESSOR, valueIfMissing);
    }
