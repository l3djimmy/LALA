...
public interface UseCaseConfig<T extends UseCase> extends TargetConfig<T>, UseCaseEventConfig, ImageInputConfig {
    ...
    default Range<Integer> getTargetFrameRate(Range<Integer> valueIfMissing) {
    ...
    default boolean isHigResolutionDisabled(boolean valueIfMissing) {
        return ((Boolean) retrieveOption(OPTION_HIGH_RESOLUTION_DISABLED, Boolean.valueOf(valueIfMissing))).booleanValue();
    }
