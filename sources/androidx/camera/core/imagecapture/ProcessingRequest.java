...
public class ProcessingRequest {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ProcessingRequest(CaptureBundle captureBundle, ImageCapture.OutputFileOptions outputFileOptions, Rect cropRect, int rotationDegrees, int jpegQuality, Matrix sensorToBufferTransform, TakePictureCallback callback, ListenableFuture<Void> captureFuture) {
        ...
        for (CaptureStage captureStage : (List) Objects.requireNonNull(captureBundle.getCaptureStages())) {
            this.mStageIds.add(Integer.valueOf(captureStage.getId()));
        }
