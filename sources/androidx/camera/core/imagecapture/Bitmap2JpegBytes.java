...
class Bitmap2JpegBytes implements Operation<In, Packet<byte[]>> {
    ...
    public Packet<byte[]> apply(In in) throws ImageCaptureException {
        ...
        return Packet.of(outputStream.toByteArray(), (Exif) Objects.requireNonNull(packet.getExif()), 256, packet.getSize(), packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
    ...
    public static abstract class In {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static In of(Packet<Bitmap> imagePacket, int jpegQuality) {
