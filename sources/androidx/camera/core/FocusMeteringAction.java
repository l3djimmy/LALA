...
public final class FocusMeteringAction {
    ...
    public static class Builder {
        ...
        public Builder(FocusMeteringAction focusMeteringAction) {
            ...
            this.mMeteringPointsAwb = new ArrayList();
            this.mAutoCancelDurationInMillis = 5000L;
            this.mMeteringPointsAf.addAll(focusMeteringAction.getMeteringPointsAf());
            this.mMeteringPointsAe.addAll(focusMeteringAction.getMeteringPointsAe());
            this.mMeteringPointsAwb.addAll(focusMeteringAction.getMeteringPointsAwb());
        ...
        public Builder removePoints(int meteringMode) {
            if ((meteringMode & 1) != 0) {
