...
public class SurfaceProcessorWithExecutor implements SurfaceProcessorInternal {
    ...
    public void onInputSurface(final SurfaceRequest request) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceProcessorWithExecutor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SurfaceProcessorWithExecutor.this.m178x3d0be2a7(request);
            }
        });
    }
    ...
    public /* synthetic */ void m178x3d0be2a7(SurfaceRequest request) {
        try {
    ...
    public void onOutputSurface(final SurfaceOutput surfaceOutput) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceProcessorWithExecutor$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceProcessorWithExecutor.this.m179x6df3c9b5(surfaceOutput);
            }
        });
    }
    ...
    public /* synthetic */ void m179x6df3c9b5(SurfaceOutput surfaceOutput) {
        try {
    ...
    public ListenableFuture<Void> snapshot(int jpegQuality, int rotationDegrees) {
