...
final class LifecycleCamera implements LifecycleObserver, Camera {
    ...
    public LifecycleCamera(LifecycleOwner lifecycleOwner, CameraUseCaseAdapter cameraUseCaseAdaptor) {
        ...
        boolean isAtLeast = this.mLifecycleOwner.getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED);
    ...
    public boolean isUseCasesCombinationSupported(UseCase... useCases) {
        return this.mCameraUseCaseAdapter.isUseCasesCombinationSupported(useCases);
    }
}
