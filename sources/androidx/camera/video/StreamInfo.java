...
public abstract class StreamInfo {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static StreamInfo of(int id, StreamState streamState) {
        return new AutoValue_StreamInfo(id, streamState, null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static StreamInfo of(int id, StreamState streamState, SurfaceRequest.TransformationInfo inProgressTransformationInfo) {
