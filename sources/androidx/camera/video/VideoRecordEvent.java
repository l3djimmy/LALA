...
public abstract class VideoRecordEvent {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Finalize finalizeWithError(OutputOptions outputOptions, RecordingStats recordingStats, OutputResults outputResults, int error, Throwable cause) {
        Preconditions.checkArgument(error != 0, "An error type is required.");
    ...
    public static final class Finalize extends VideoRecordEvent {
        ...
        Finalize(OutputOptions outputOptions, RecordingStats recordingStats, OutputResults outputResults, int error, Throwable cause) {
            super(outputOptions, recordingStats);
