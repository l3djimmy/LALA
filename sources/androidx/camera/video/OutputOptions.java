...
public abstract class OutputOptions {
    ...
    static abstract class Builder<T extends OutputOptions, B> {
        ...
        public B setFileSizeLimit(long fileSizeLimitBytes) {
            Preconditions.checkArgument(fileSizeLimitBytes >= 0, "The specified file size limit can't be negative.");
            this.mRootInternalBuilder.setFileSizeLimit(fileSizeLimitBytes);
            return this;
        }

        /* JADX WARN: Multi-variable type inference failed */
        public B setDurationLimitMillis(long durationLimitMillis) {
            Preconditions.checkArgument(durationLimitMillis >= 0, "The specified duration limit can't be negative.");
