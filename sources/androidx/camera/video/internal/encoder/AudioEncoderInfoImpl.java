...
public class AudioEncoderInfoImpl extends EncoderInfoImpl implements AudioEncoderInfo {
    ...
    public static AudioEncoderInfoImpl from(AudioEncoderConfig encoderConfig) throws InvalidConfigException {
        return new AudioEncoderInfoImpl(findCodecAndGetCodecInfo(encoderConfig), encoderConfig.getMimeType());
    }
