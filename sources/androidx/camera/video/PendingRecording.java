...
public final class PendingRecording {
    ...
    public PendingRecording(Context context, Recorder recorder, OutputOptions options) {
    ...
    public Recording start(Executor listenerExecutor, Consumer<VideoRecordEvent> listener) {
