                ...
                if (other$iv$iv == -2) {
                    ...
                    if (other$iv$iv2 == -2) {
                        if (endIndex <= index$iv + 2) {
                            ...
                            if (endIndex > index$iv + 1) {
                                byte byte$iv$iv$iv = $this$processUtf16Chars$iv3[index$iv + 1];
                        ...
                        if (other$iv$iv3 == -2) {
                            if (endIndex <= index$iv + 3) {
                                ...
                                if (endIndex > index$iv + 1) {
                                    byte byte$iv$iv$iv2 = $this$processUtf16Chars$iv3[index$iv + 1];
                                    int other$iv$iv$iv$iv2 = 192 & byte$iv$iv$iv2;
                                    byte byte$iv$iv$iv3 = other$iv$iv$iv$iv2 == 128 ? (byte) 1 : (byte) 0;
                                    if (byte$iv$iv$iv3 != 0) {
                                        if (endIndex > index$iv + 2) {
                                            byte byte$iv$iv$iv4 = $this$processUtf16Chars$iv3[index$iv + 2];
