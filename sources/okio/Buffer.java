...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    */
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v$iv < 100000000) {
            if (v$iv < DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM) {
                if (v$iv < 100) {
                    if (v$iv < 10) {
                        width$iv = 1;
                    } else {
        ...
        if (fromIndex$iv != toIndex$iv && (s$iv$iv = this.head) != null) {
            if (size() - fromIndex$iv < fromIndex$iv) {
                ...
                while (offset$iv2 < toIndex$iv) {
                    ...
                    int limit$iv = (int) Math.min(s$iv2.limit, (s$iv2.pos + toIndex$iv2) - offset$iv2);
            ...
            while (offset$iv4 < toIndex$iv3) {
                ...
                int limit$iv2 = (int) Math.min(s$iv4.limit, (s$iv4.pos + toIndex$iv3) - offset$iv4);
                for (int pos$iv2 = (int) ((s$iv4.pos + fromIndex$iv) - offset$iv4); pos$iv2 < limit$iv2; pos$iv2++) {
    ...
    public final ByteString snapshot(int byteCount) {
        ...
        return new C0068SegmentedByteString(segments$iv, directory$iv);
    }
    ...
    public final byte m9048deprecated_getByte(long index) {
        return getByte(index);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m9049deprecated_size() {
        return this.size;
    }
