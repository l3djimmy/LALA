...
public final class TemperatureCache {
    ...
    public List<Hct> getAnalogousColors(int count, int divisions) {
        ...
        double absoluteTotalTempDelta = AudioStats.AUDIO_AMPLITUDE_NONE;
        for (int i = 0; i < 360; i++) {
        ...
        double totalTempDelta = AudioStats.AUDIO_AMPLITUDE_NONE;
    ...
    public double getRelativeTemperature(Hct hct) {
        ...
        if (range == AudioStats.AUDIO_AMPLITUDE_NONE) {
            return 0.5d;
        }
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Comparator<Hct> temperaturesComparator = Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return TemperatureCache.this.m7251xb7a75f35((Hct) obj);
            }
    ...
    public /* synthetic */ Double m7251xb7a75f35(Hct arg) {
