...
public class HctSolver {
    ...
    static double[] nthVertex(double y, int n) {
        ...
        int i = n % 4;
        double coordB = AudioStats.AUDIO_AMPLITUDE_NONE;
    ...
    */
    ...
    static double inverseChromaticAdaptation(double adapted) {
        ...
        double base = Math.max((double) AudioStats.AUDIO_AMPLITUDE_NONE, (27.13d * adaptedAbs) / (400.0d - adaptedAbs));
    ...
    static int findResultByJ(double hueRadians, double chroma, double y) {
        ...
        while (iterationRound < 5) {
            ...
            double alpha = (chroma == AudioStats.AUDIO_AMPLITUDE_NONE || j == AudioStats.AUDIO_AMPLITUDE_NONE) ? 0.0d : chroma / Math.sqrt(jNormalized);
            double d4 = d2;
            double j2 = j;
            ...
            if (linrgb[0] < AudioStats.AUDIO_AMPLITUDE_NONE || linrgb[1] < AudioStats.AUDIO_AMPLITUDE_NONE || linrgb[2] < AudioStats.AUDIO_AMPLITUDE_NONE) {
                return 0;
            }
            double kR = Y_FROM_LINRGB[0];
            double kG = Y_FROM_LINRGB[1];
            ...
            if (fnj <= AudioStats.AUDIO_AMPLITUDE_NONE) {
                return 0;
            }
