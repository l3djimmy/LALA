...
public final class QuantizerWu implements Quantizer {
        ...
        while (true) {
            ...
            if (r < 33) {
                ...
                while (g < i) {
                    ...
                    int lineG = 0;
                    int lineB = 0;
                    double line2 = AudioStats.AUDIO_AMPLITUDE_NONE;
                    int b = 1;
                    while (b < i) {
    ...
    CreateBoxesResult createBoxes(int maxColorCount) {
        ...
        while (true) {
            ...
            int j2 = (temp > AudioStats.AUDIO_AMPLITUDE_NONE ? 1 : (temp == AudioStats.AUDIO_AMPLITUDE_NONE ? 0 : -1));
            if (j2 > 0) {
                i2++;
            } else {
    ...
    MaximizeResult maximize(Box cube, Direction direction, int first, int last, int wholeR, int wholeG, int wholeB, int wholeW) {
        ...
        double max = AudioStats.AUDIO_AMPLITUDE_NONE;
        int cut = -1;
        int i = first;
        while (i < last) {
