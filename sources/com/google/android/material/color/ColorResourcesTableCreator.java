...
public final class ColorResourcesTableCreator {
    ...
    public static class PackageChunk {
        ...
        void writeTo(ByteArrayOutputStream outputStream) throws IOException {
            ...
            outputStream.write(ColorResourcesTableCreator.intToByteArray(TIFFConstants.TIFFTAG_FREEOFFSETS));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + TIFFConstants.TIFFTAG_FREEOFFSETS));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            outputStream.write(ColorResourcesTableCreator.intToByteArray(0));
    ...
    public static byte[] stringToByteArrayUtf8(String value) {
        byte[] rawBytes = value.getBytes(Charset.forName(PdfEncodings.UTF8));
