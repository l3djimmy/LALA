...
public final class CollapsingTextHelper {
    ...
    private final TextPaint textPaint = new TextPaint((int) Property.ALIGN_SELF);
    ...
    private void calculateOffsets(float fraction) {
        ...
        int i = (this.collapsedLetterSpacing > this.expandedLetterSpacing ? 1 : (this.collapsedLetterSpacing == this.expandedLetterSpacing ? 0 : -1));
    ...
    private void calculateBaseOffsets(boolean forceRecalculate) {
        ...
        switch (collapsedAbsGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) {
            case 48:
        ...
        switch (expandedAbsGravity & Property.BORDER_BOTTOM_RIGHT_RADIUS) {
            case 48:
