...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    /* JADX WARN: Type inference failed for: r0v18, types: [android.content.Context, androidx.recyclerview.widget.RecyclerView$LayoutManager, android.view.ContextThemeWrapper, com.google.android.material.datepicker.MaterialCalendar$2] */
    ...
    /* JADX WARN: Type inference failed for: r7v3, types: [int, android.view.View] */
    /* JADX WARN: Type inference failed for: r7v7, types: [int, android.view.View] */
    @Override // androidx.fragment.app.Fragment
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ?? r7 = R.id.mtrl_calendar_year_selector_frame;
        ...
        ?? r72 = R.id.month_navigation_fragment_toggle;
