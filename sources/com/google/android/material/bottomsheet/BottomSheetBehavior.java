...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                int targetState;
                int targetState2;
                int i = (yvel > 0.0f ? 1 : (yvel == 0.0f ? 0 : -1));
                ...
                if (i < 0) {
                    ...
                    if (targetState4 != 0 && Math.abs(xvel) <= Math.abs(yvel)) {
                        ...
                        if (z) {
                            ...
                            int targetState5 = bottomSheetBehavior3.halfExpandedOffset;
                            BottomSheetBehavior bottomSheetBehavior4 = BottomSheetBehavior.this;
                            if (currentTop3 < targetState5) {
                                ...
                                int targetState6 = bottomSheetBehavior4.halfExpandedOffset;
                                if (Math.abs(currentTop3 - targetState6) < Math.abs(currentTop3 - BottomSheetBehavior.this.collapsedOffset)) {
                                    if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                                        targetState = 4;
                                    } else {
                                        targetState = 6;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        setSignificantVelocityThreshold(a.getInt(R.styleable.BottomSheetBehavior_Layout_behavior_significantVelocityThreshold, FontWeights.MEDIUM));
