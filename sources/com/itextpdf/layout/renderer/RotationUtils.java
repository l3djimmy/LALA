...
public final class RotationUtils {
    ...
    public static class PropertiesBackup {
        ...
        public Boolean storeBoolProperty(int property) {
            Boolean value = this.renderer.getPropertyAsBoolean(property);
            if (value != null) {
                this.propertiesBackup.put(Integer.valueOf(property), new PropertyBackup(value, this.renderer.hasOwnProperty(property)));
                this.renderer.setProperty(property, null);
            }
        ...
        public <T> T storeProperty(int property) {
            T value = (T) this.renderer.getProperty(property);
            if (value != null) {
                this.propertiesBackup.put(Integer.valueOf(property), new PropertyBackup(value, this.renderer.hasOwnProperty(property)));
                this.renderer.setProperty(property, null);
            }
        ...
        public void restoreProperty(int property) {
            ...
            if (backup != null) {
                boolean isOwnedByRender = backup.isOwnedByRender();
                AbstractRenderer abstractRenderer = this.renderer;
                if (isOwnedByRender) {
                    abstractRenderer.setProperty(property, backup.getValue());
                } else {
                    abstractRenderer.deleteOwnProperty(property);
                }
            }
        }
