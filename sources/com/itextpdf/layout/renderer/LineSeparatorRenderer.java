...
public class LineSeparatorRenderer extends BlockRenderer {
    ...
    public LayoutResult layout(LayoutContext layoutContext) {
        ...
        this.occupiedArea = new LayoutArea(layoutContext.getArea().getPageNumber(), parentBBox.mo7327clone());
        applyMargins(this.occupiedArea.getBBox(), false);
        Float calculatedWidth2 = retrieveWidth(layoutContext.getArea().getBBox().getWidth());
        if (calculatedWidth2 != null) {
