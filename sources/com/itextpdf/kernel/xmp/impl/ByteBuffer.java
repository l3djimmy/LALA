    ...
    public String getEncoding() {
        if (this.encoding == null) {
            if (this.length < 2) {
                ...
                } else if ((this.buffer[2] & UByte.MAX_VALUE) == 254 && (this.buffer[3] & UByte.MAX_VALUE) == 255) {
                    this.encoding = "UTF-32BE";
                } else {
                    this.encoding = "UTF-32";
                }
            } else {
                int i = this.buffer[0] & UByte.MAX_VALUE;
                byte[] bArr = this.buffer;
                if (i < 128) {
                    if (bArr[1] != 0) {
                        this.encoding = PdfEncodings.UTF8;
                    ...
                    this.encoding = PdfEncodings.UTF8;
                } else if ((this.buffer[0] & UByte.MAX_VALUE) == 254) {
