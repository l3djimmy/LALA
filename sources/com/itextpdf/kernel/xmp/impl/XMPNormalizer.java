...
public class XMPNormalizer {
    ...
    private static void migrateAudioCopyright(XMPMeta xmp, XMPNode dmCopyright) {
        try {
            ...
            try {
                if (dcRightsArray != null && dcRightsArray.hasChildren()) {
                    ...
                    if (xdIndex < 0) {
                        ...
                        xmp.setLocalizedText(XMPConst.NS_DC, PdfConst.Rights, "", XMPConst.X_DEFAULT, firstValue, null);
            ...
            xmp.setLocalizedText(XMPConst.NS_DC, PdfConst.Rights, "", XMPConst.X_DEFAULT, "\n\n" + dmValue, null);
