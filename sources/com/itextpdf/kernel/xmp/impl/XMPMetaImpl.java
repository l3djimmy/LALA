...
public class XMPMetaImpl implements XMPConst, XMPMeta {
    ...
    public void appendArrayItem(String schemaNS, String arrayName, PropertyOptions arrayOptions, String itemValue, PropertyOptions itemOptions) throws XMPException {
        ...
        XMPNode arrayNode2 = XMPNodeUtils.findNode(this.tree, arrayPath, false, null);
        if (arrayNode2 != null) {
            if (!arrayNode2.getOptions().isArray()) {
            ...
            XMPNode arrayNode3 = XMPNodeUtils.findNode(this.tree, arrayPath, true, arrayOptions2);
            if (arrayNode3 == null) {
    ...
    */
    ...
    private Object evaluateNodeValue(int valueType, XMPNode propNode) throws XMPException {
        ...
        switch (valueType) {
            case 1:
                Object value = Boolean.valueOf(XMPUtils.convertToBoolean(rawValue));
                return value;
            case 2:
                Object value2 = Integer.valueOf(XMPUtils.convertToInteger(rawValue));
                return value2;
            case 3:
                Object value3 = Long.valueOf(XMPUtils.convertToLong(rawValue));
                return value3;
            case 4:
                Object value4 = Double.valueOf(XMPUtils.convertToDouble(rawValue));
                return value4;
            case 5:
                Object value5 = XMPUtils.convertToDate(rawValue);
                return value5;
            case 6:
                XMPDateTime dt = XMPUtils.convertToDate(rawValue);
                Object value6 = dt.getCalendar();
                return value6;
            case 7:
                Object value7 = XMPUtils.decodeBase64(rawValue);
                return value7;
            default:
