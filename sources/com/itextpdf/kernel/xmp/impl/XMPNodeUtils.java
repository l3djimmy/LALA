...
public final class XMPNodeUtils implements XMPConst {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setNodeValue(XMPNode node, Object value) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void normalizeLangArray(XMPNode arrayNode) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void detectAltText(XMPNode arrayNode) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object[] chooseLocalizedText(XMPNode arrayNode, String genericLang, String specificLang) throws XMPException {
        if (!arrayNode.getOptions().isArrayAltText()) {
