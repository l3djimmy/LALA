...
public final class KernelExceptionMessageConstant {
    ...
    public static final String BAD_PASSWORD_HASH = "Password hash exceeds 48 bytes and extra bytes are not 0";
    ...
    public static final String INVALID_TYPE_2_FUNCTION_N = "Invalid PDF Type 2 Function object, \"N\" field should exist and must be a number.";
    ...
    public static final String INVALID_TYPE_3_FUNCTION_NULL_BOUNDS = "Invalid PDF Type 3 Function object, \"Bounds\" array should exist and its size should correspond to the size of the \"Functions\" array.";
    public static final String INVALID_TYPE_3_FUNCTION_NULL_ENCODE = "Invalid PDF Type 3 Function object, \"Encode\" array should exist and its size should be 2 times more than the size of the \"Functions\" array.";
    public static final String INVALID_TYPE_3_FUNCTION_NULL_FUNCTIONS = "Invalid PDF Type 3 Function object, \"Functions\" array should exist and can't be empty.";
    ...
    public static final String PAGE_CANNOT_BE_ADDED_TO_DOCUMENT_BECAUSE_IT_BELONGS_TO_ANOTHER_DOCUMENT = "The passed page belongs to document {0} (page {1} of the document) and therefore cannot be added to this document ({2}).";
    ...
    public static final String TOTAL_XOBJECT_SIZE_ONE_PAGE_EXCEEDED_THE_LIMIT = "Pdf contains too many xObject elements on a page and may cause OOM exception. You can increase page size limit by setting custom MemoryLimitsAwareHandler.";
    ...
    public static final String UNSUPPORTED_SECURITY_HANDLER = "Failed to open the document. Security handler {0} is not supported";
    ...
    public static final String XREF_HAS_AN_ENTRY_WITH_TOO_BIG_OFFSET = "Pdf document is to large to use normal cross reference table. Use cross reference streams instead. To enable feature use com.itextpdf.kernel.pdf.WriterProperties#setFullCompressionMode(true). ";
