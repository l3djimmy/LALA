...
class DocFontEncoding extends FontEncoding {
    ...
    public static FontEncoding createDocFontEncoding(PdfObject encoding, CMapToUnicode toUnicode) {
        ...
        if (toUnicode != null) {
            ...
            FontEncoding.fillFontEncoding(fontEncoding2);
        ...
        if (diffs != null) {
            ...
            for (int k = 0; k < diffs.size(); k++) {
                ...
                if (obj.isNumber()) {
                    ...
                    LOGGER.warn(MessageFormatUtil.format(IoLogMessageConstant.DOCFONT_HAS_ILLEGAL_DIFFERENCES, ((PdfName) obj).getValue()));
                } else {
