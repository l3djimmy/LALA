...
public final class Type3Glyph extends PdfCanvas {
    ...
    public Type3Glyph(PdfDocument pdfDocument, float wx, float llx, float lly, float urx, float ury, boolean isColor) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Type3Glyph(PdfStream pdfStream, PdfDocument document) {
