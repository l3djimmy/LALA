...
public class TaggedPdfReaderTool {
    ...
    protected void inspectKid(IStructureNode kid) {
        try {
            ...
            throw new com.itextpdf.io.exceptions.IOException(IoExceptionMessageConstant.UNKNOWN_IO_EXCEPTION, (Throwable) e);
        }
    }
    ...
    protected static String fixTagName(String tag) {
        ...
        for (int k = 0; k < tag.length(); k++) {
            ...
            nameMiddle = (c == '-' || c == '.' || (c >= '0' && c <= '9') || c == 183 || ((c >= 768 && c <= 879) || ((c >= 8255 && c <= 8256) || nameStart))) ? true : true;
            if (k == 0) {
                if (!nameStart) {
                    c = '_';
                }
