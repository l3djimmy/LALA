...
public class PdfSplitter {
    ...
    public List<PdfDocument> extractPageRanges(List<PageRange> pageRanges) {
        ...
        for (PageRange currentPageRange : pageRanges) {
            ...
            this.pdfDocument.copyPagesTo(currentPageRange.getQualifyingPageNums(this.pdfDocument.getNumberOfPages()), currentPdfDocument);
        }
        return splitDocuments;
    }
    ...
    private PageRange getNextRange(int startPage, int endPage, long size) {
        ...
        while (true) {
            ...
            PdfPage page = this.pdfDocument.getPage(currentPage2);
            PdfResourceCounter counter2 = new PdfResourceCounter(page.getPdfObject());
