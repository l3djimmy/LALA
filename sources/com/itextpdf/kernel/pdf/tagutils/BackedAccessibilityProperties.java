...
public class BackedAccessibilityProperties extends AccessibilityProperties {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public BackedAccessibilityProperties(TagTreePointer pointerToBackingElem) {
    ...
    public byte[] getStructureElementId() {
        PdfString value = getBackingElem().getStructureElementId();
        if (value == null) {
            return null;
        }
    ...
    public AccessibilityProperties setStructureElementId(byte[] id) {
        ...
        getBackingElem().setStructureElementId(value);
        return this;
    }
