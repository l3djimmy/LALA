...
class Edge {
    ...
    public static boolean doesE2InsertBeforeE1(Edge e1, Edge e2) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean slopesEqual(Edge e1, Edge e2, boolean useFullRange) {
        if (useFullRange) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void swapPolyIndexes(Edge edge1, Edge edge2) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static long topX(Edge edge, long currentY) {
