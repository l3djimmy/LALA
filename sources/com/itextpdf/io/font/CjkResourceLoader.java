...
public final class CjkResourceLoader {
    ...
    static {
        setCmapLocation(new CMapLocationResource());
    }
    ...
    public static boolean isPredefinedCidFont(String fontName) {
        return registryNames.containsKey(FONTS_PROP) && registryNames.get(FONTS_PROP).contains(fontName);
    }
    ...
    public static CMapCidToCodepoint getCidToCodepointCmap(String cmap) {
        ...
        return (CMapCidToCodepoint) parseCmap(cmap, cidByte);
    }

    public static CMapCodepointToCid getCodepointToCidCmap(String uniMap) {
        return (CMapCodepointToCid) parseCmap(uniMap, new CMapCodepointToCid());
    }

    static void setCmapLocation(CMapLocationResource cmapLocation2) {
        cmapLocation = cmapLocation2;
        try {
            loadRegistry();
        } catch (Exception e) {
        }
    ...
    private static Map<String, Object> readFontProperties(String name) throws IOException {
        ...
        try {
            ...
            fontProperties.put("W", createMetric((String) fontProperties.get("W")));
