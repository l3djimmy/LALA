...
public class Glyph {
    ...
    public int hashCode() {
        int result = (1 * 31) + (this.chars == null ? 0 : Arrays.hashCode(this.chars));
        return (((result * 31) + this.code) * 31) + this.width;
    }
    ...
    public String toString() {
        return MessageFormatUtil.format("[id={0}, chars={1}, uni={2}, width={3}]", toHex(this.code), this.chars != null ? Arrays.toString(this.chars) : "null", toHex(this.unicode), Integer.valueOf(this.width));
    }
