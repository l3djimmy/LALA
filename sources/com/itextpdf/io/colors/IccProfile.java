...
public class IccProfile {
    ...
    public static IccProfile getInstance(byte[] data, int numComponents) {
        ...
        if (nc != numComponents) {
            throw new IOException(IoExceptionMessageConstant.ICC_PROFILE_CONTAINS_COMPONENTS_WHILE_THE_IMAGE_DATA_CONTAINS_COMPONENTS).setMessageParams(Integer.valueOf(nc), Integer.valueOf(numComponents));
        }
        return icc;
    }
    ...
    public static IccProfile getInstance(RandomAccessFileOrArray file) {
        try {
            ...
            throw new IOException(IoExceptionMessageConstant.INVALID_ICC_PROFILE, (Throwable) ex);
        }
    }
    ...
    public static IccProfile getInstance(InputStream stream) {
        try {
            ...
            throw new IOException(IoExceptionMessageConstant.INVALID_ICC_PROFILE, (Throwable) e);
        }
    }
