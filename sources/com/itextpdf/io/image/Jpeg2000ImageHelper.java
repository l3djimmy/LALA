    ...
    private static void processParameters(Jpeg2000ImageData jp2) {
        ...
        try {
            ...
            if (box.length == 12) {
                ...
                if (218793738 != cio_read(4, jpeg2000Stream)) {
            ...
            throw new com.itextpdf.io.exceptions.IOException(IoExceptionMessageConstant.JPEG2000_IMAGE_EXCEPTION, (Throwable) e2);
        }
    }
