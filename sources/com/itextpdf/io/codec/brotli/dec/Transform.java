...
final class Transform {
    ...
    public static int transformDictionaryWord(byte[] dst, int dstOffset, ByteBuffer data, int wordOffset, int len, Transform transform) {
        ...
        if (offset2 == 11 || offset2 == 10) {
            ...
            while (len2 > 0) {
                int tmp2 = dst[uppercaseOffset] & UByte.MAX_VALUE;
                if (tmp2 < 192) {
                    if (tmp2 >= 97 && tmp2 <= 122) {
