...
public final class IoExceptionMessageConstant {
    ...
    public static final String BIT_SAMPLES_ARE_NOT_SUPPORTED_FOR_HORIZONTAL_DIFFERENCING_PREDICTOR = "{0} bit samples are not supported for horizontal differencing predictor.";
    ...
    public static final String BYTES_CAN_BE_ASSIGNED_TO_BYTE_ARRAY_OUTPUT_STREAM_ONLY = "Bytes can be assigned to ByteArrayOutputStream only.";
    public static final String BYTES_CAN_BE_RESET_IN_BYTE_ARRAY_OUTPUT_STREAM_ONLY = "Bytes can be reset in ByteArrayOutputStream only.";
    ...
    public static final String CCITT_COMPRESSION_TYPE_MUST_BE_CCITTG4_CCITTG3_1D_OR_CCITTG3_2D = "CCITT compression type must be CCITTG4, CCITTG3_1D or CCITTG3_2D.";
    ...
    public static final String COMPRESSION_JPEG_IS_ONLY_SUPPORTED_WITH_A_SINGLE_STRIP_THIS_IMAGE_HAS_STRIPS = "Compression jpeg is only supported with a single strip. This image has {0} strips.";
    ...
    public static final String ENCODING_ERROR = "Error during encoding the following code point: {0} in characterset: {1}";
    ...
    public static final String EXPECTED_TRAILING_ZERO_BITS_FOR_BYTE_ALIGNED_LINES = "Expected trailing zero bits for byte-aligned lines";
    ...
    public static final String ICC_PROFILE_CONTAINS_COMPONENTS_WHILE_THE_IMAGE_DATA_CONTAINS_COMPONENTS = "ICC profile contains {0} components, while the image data contains {1} components.";
    ...
    public static final String IMAGE_IS_NOT_A_MASK_YOU_MUST_CALL_IMAGE_DATA_MAKE_MASK = "Image is not a mask. You must call ImageData#makeMask().";
    ...
    public static final String INVALID_CODE_ENCOUNTERED_WHILE_DECODING_2D_GROUP_3_COMPRESSED_DATA = "Invalid code encountered while decoding 2D group 3 compressed data.";
    public static final String INVALID_CODE_ENCOUNTERED_WHILE_DECODING_2D_GROUP_4_COMPRESSED_DATA = "Invalid code encountered while decoding 2D group 4 compressed data.";
    ...
    public static final String INVALID_MAGIC_VALUE_FOR_BMP_FILE_MUST_BE_BM = "Invalid magic value for bmp file. Must be 'BM'";
    ...
    public static final String TRANSPARENCY_LENGTH_MUST_BE_EQUAL_TO_2_WITH_CCITT_IMAGES = "Transparency length must be equal to 2 with CCITT images";
