...
public final class RandomAccessSourceFactory {
    ...
    public IRandomAccessSource createBestSource(String filename) throws IOException {
        ...
        if (!file.canRead()) {
            if (filename.startsWith("file:/") || filename.startsWith("http://") || filename.startsWith("https://") || filename.startsWith("jar:") || filename.startsWith("wsjar:") || filename.startsWith("vfszip:")) {
    ...
    private IRandomAccessSource createByReadingToMemory(String filename) throws IOException {
        ...
        if (stream == null) {
            throw new IOException(MessageFormatUtil.format(IoExceptionMessageConstant.NOT_FOUND_AS_FILE_OR_RESOURCE, filename));
        }
