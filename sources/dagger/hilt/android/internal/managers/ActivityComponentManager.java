...
public class ActivityComponentManager implements GeneratedComponentManager<Object> {
    ...
    public final void initSavedStateHandleHolders() {
        this.activitySavedStateHandleHolder = ((ActivityRetainedComponentManager) this.activityRetainedComponentManager).getSavedStateHandleHolder();
        if (this.activitySavedStateHandleHolder.isInvalid()) {
    ...
    public final void clearSavedStateHandleHolders() {
        if (this.activitySavedStateHandleHolder != null) {
            this.activitySavedStateHandleHolder.clear();
        }
    }
