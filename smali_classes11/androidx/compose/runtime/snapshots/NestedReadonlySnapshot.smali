...
.method public constructor <init>(JLandroidx/compose/runtime/snapshots/SnapshotIdSet;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/snapshots/Snapshot;)V
    ...
    .param p5, "parent"    # Landroidx/compose/runtime/snapshots/Snapshot;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
            "Landroidx/compose/runtime/snapshots/SnapshotIdSet;",
...
.method public takeNestedSnapshot(Lkotlin/jvm/functions/Function1;)Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;
    ...
    .local v1, "writeObserver$iv":Lkotlin/jvm/functions/Function1;
    const/4 v2, 0x1
    ...
    .line 1437
    .local v10, "$i$a$-creatingSnapshot-NestedReadonlySnapshot$takeNestedSnapshot$1":I
    new-instance v11, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;

    .line 1438
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;->getSnapshotId()J

    move-result-wide v12

    .line 1439
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;->getInvalid$runtime_release()Landroidx/compose/runtime/snapshots/SnapshotIdSet;

    move-result-object v14

    .line 1440
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;->getReadObserver$runtime_release()Lkotlin/jvm/functions/Function1;

    move-result-object v15

    move-object/from16 v17, v1

    .end local v1    # "writeObserver$iv":Lkotlin/jvm/functions/Function1;
    .local v17, "writeObserver$iv":Lkotlin/jvm/functions/Function1;
    const/4 v1, 0x0

    move/from16 v18, v2

    .end local v2    # "readonly$iv":Z
    .local v18, "readonly$iv":Z
    const/4 v2, 0x4

    invoke-static {v8, v15, v1, v2, v0}, Landroidx/compose/runtime/snapshots/SnapshotKt;->mergedReadObserver$default(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;ZILjava/lang/Object;)Lkotlin/jvm/functions/Function1;

    move-result-object v15

    .line 1441
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;->getParent()Landroidx/compose/runtime/snapshots/Snapshot;

    move-result-object v16

    .line 1437
    invoke-direct/range {v11 .. v16}, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;-><init>(JLandroidx/compose/runtime/snapshots/SnapshotIdSet;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/snapshots/Snapshot;)V
    ...
    .end local v10    # "$i$a$-creatingSnapshot-NestedReadonlySnapshot$takeNestedSnapshot$1":I
    move-object v0, v11

    check-cast v0, Landroidx/compose/runtime/snapshots/Snapshot;

    .line 2500
    .local v0, "result$iv":Landroidx/compose/runtime/snapshots/Snapshot;
    if-eqz v5, :cond_1
    ...
    invoke-static {v5, v1, v0, v4}, Landroidx/compose/runtime/snapshots/tooling/SnapshotObserverKt;->dispatchCreatedObservers(Landroidx/compose/runtime/external/kotlinx/collections/immutable/PersistentList;Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/Snapshot;Ljava/util/Map;)V

    .line 2501
    :cond_1
    nop

    .end local v0    # "result$iv":Landroidx/compose/runtime/snapshots/Snapshot;
    ...
    .end local v17    # "writeObserver$iv":Lkotlin/jvm/functions/Function1;
    .end local v18    # "readonly$iv":Z
    check-cast v0, Landroidx/compose/runtime/snapshots/NestedReadonlySnapshot;
