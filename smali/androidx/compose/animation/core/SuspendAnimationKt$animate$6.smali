...
.method public final invoke(J)V
    ...
    .line 233
    new-instance v2, Landroidx/compose/animation/core/AnimationScope;

    .line 234
    iget-object v3, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$initialValue:Ljava/lang/Object;

    .line 235
    iget-object v4, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$animation:Landroidx/compose/animation/core/Animation;
    ...
    .line 238
    iget-object v6, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$animation:Landroidx/compose/animation/core/Animation;

    invoke-interface {v6}, Landroidx/compose/animation/core/Animation;->getTargetValue()Ljava/lang/Object;
    ...
    .line 243
    new-instance v6, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6$1;

    iget-object v7, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$this_animate:Landroidx/compose/animation/core/AnimationState;

    invoke-direct {v6, v7}, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6$1;-><init>(Landroidx/compose/animation/core/AnimationState;)V
    ...
    .line 243
    iget v3, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$durationScale:F

    iget-object v4, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$animation:Landroidx/compose/animation/core/Animation;

    iget-object v5, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$this_animate:Landroidx/compose/animation/core/AnimationState;

    iget-object v6, v0, Landroidx/compose/animation/core/SuspendAnimationKt$animate$6;->$block:Lkotlin/jvm/functions/Function1;

    move-object v13, v2

    .local v13, "$this$invoke_u24lambda_u240":Landroidx/compose/animation/core/AnimationScope;
    const/4 v7, 0x0

    .line 245
    .local v7, "$i$a$-apply-SuspendAnimationKt$animate$6$2":I
    nop
    ...
    invoke-static/range {v13 .. v19}, Landroidx/compose/animation/core/SuspendAnimationKt;->access$doAnimationFrameWithScale(Landroidx/compose/animation/core/AnimationScope;JFLandroidx/compose/animation/core/Animation;Landroidx/compose/animation/core/AnimationState;Lkotlin/jvm/functions/Function1;)V

    .line 252
    nop

    .line 243
    .end local v7    # "$i$a$-apply-SuspendAnimationKt$animate$6$2":I
    .end local v13    # "$this$invoke_u24lambda_u240":Landroidx/compose/animation/core/AnimationScope;
    nop
