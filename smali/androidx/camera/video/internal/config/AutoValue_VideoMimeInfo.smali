...
.method synthetic constructor <init>(Ljava/lang/String;ILandroidx/camera/core/impl/EncoderProfilesProxy$VideoProfileProxy;Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo$1;)V
    ...
    .param p2, "x1"    # I
    .param p3, "x2"    # Landroidx/camera/core/impl/EncoderProfilesProxy$VideoProfileProxy;
    .param p4, "x3"    # Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo$1;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 60
    .local v1, "that":Landroidx/camera/video/internal/config/VideoMimeInfo;
    iget-object v3, p0, Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo;->mimeType:Ljava/lang/String;

    invoke-virtual {v1}, Landroidx/camera/video/internal/config/VideoMimeInfo;->getMimeType()Ljava/lang/String;
    ...
    iget v3, p0, Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo;->profile:I

    .line 61
    invoke-virtual {v1}, Landroidx/camera/video/internal/config/VideoMimeInfo;->getProfile()I

    move-result v4

    if-ne v3, v4, :cond_2

    iget-object v3, p0, Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo;->compatibleVideoProfile:Landroidx/camera/core/impl/EncoderProfilesProxy$VideoProfileProxy;

    if-nez v3, :cond_1

    .line 62
    invoke-virtual {v1}, Landroidx/camera/video/internal/config/VideoMimeInfo;->getCompatibleVideoProfile()Landroidx/camera/core/impl/EncoderProfilesProxy$VideoProfileProxy;
    ...
    .line 64
    .end local v1    # "that":Landroidx/camera/video/internal/config/VideoMimeInfo;
    :cond_3
    return v2
.end method
...
.method public hashCode()I
    ...
    .line 71
    iget-object v2, p0, Landroidx/camera/video/internal/config/AutoValue_VideoMimeInfo;->mimeType:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "VideoMimeInfo{mimeType="
