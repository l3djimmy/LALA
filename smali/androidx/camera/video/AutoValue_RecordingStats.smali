...
.method constructor <init>(JJLandroidx/camera/video/AudioStats;)V
    .locals 2
    .param p1, "recordedDurationNanos"    # J
    .param p3, "numBytesRecorded"    # J
    .param p5, "audioStats"    # Landroidx/camera/video/AudioStats;
    ...
    const-string v1, "Null audioStats"
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroidx/camera/video/RecordingStats;

    .line 60
    .local v1, "that":Landroidx/camera/video/RecordingStats;
    iget-wide v3, p0, Landroidx/camera/video/AutoValue_RecordingStats;->recordedDurationNanos:J

    invoke-virtual {v1}, Landroidx/camera/video/RecordingStats;->getRecordedDurationNanos()J
    ...
    .line 61
    invoke-virtual {v1}, Landroidx/camera/video/RecordingStats;->getNumBytesRecorded()J
    ...
    iget-object v3, p0, Landroidx/camera/video/AutoValue_RecordingStats;->audioStats:Landroidx/camera/video/AudioStats;

    .line 62
    invoke-virtual {v1}, Landroidx/camera/video/RecordingStats;->getAudioStats()Landroidx/camera/video/AudioStats;
    ...
    .line 64
    .end local v1    # "that":Landroidx/camera/video/RecordingStats;
    :cond_2
    return v2
.end method
...
.method public hashCode()I
    ...
    .line 71
    iget-wide v2, p0, Landroidx/camera/video/AutoValue_RecordingStats;->recordedDurationNanos:J

    const/16 v4, 0x20

    ushr-long/2addr v2, v4

    iget-wide v5, p0, Landroidx/camera/video/AutoValue_RecordingStats;->recordedDurationNanos:J
    ...
    .line 73
    iget-wide v2, p0, Landroidx/camera/video/AutoValue_RecordingStats;->numBytesRecorded:J

    ushr-long/2addr v2, v4

    iget-wide v4, p0, Landroidx/camera/video/AutoValue_RecordingStats;->numBytesRecorded:J
