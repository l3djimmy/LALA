...
.method private constructor <init>(Landroid/util/Range;IILandroid/util/Range;I)V
    ...
    .line 26
    .local p1, "bitrate":Landroid/util/Range;, "Landroid/util/Range<Ljava/lang/Integer;>;"
    .local p4, "sampleRate":Landroid/util/Range;, "Landroid/util/Range<Ljava/lang/Integer;>;"
...
.method synthetic constructor <init>(Landroid/util/Range;IILandroid/util/Range;ILandroidx/camera/video/AutoValue_AudioSpec$1;)V
    .locals 0
    .param p1, "x0"    # Landroid/util/Range;
    .param p2, "x1"    # I
    .param p3, "x2"    # I
    .param p4, "x3"    # Landroid/util/Range;
    .param p5, "x4"    # I
    .param p6, "x5"    # Landroidx/camera/video/AutoValue_AudioSpec$1;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroidx/camera/video/AudioSpec;

    .line 82
    .local v1, "that":Landroidx/camera/video/AudioSpec;
    iget-object v3, p0, Landroidx/camera/video/AutoValue_AudioSpec;->bitrate:Landroid/util/Range;

    invoke-virtual {v1}, Landroidx/camera/video/AudioSpec;->getBitrate()Landroid/util/Range;
    ...
    iget v3, p0, Landroidx/camera/video/AutoValue_AudioSpec;->sourceFormat:I

    .line 83
    invoke-virtual {v1}, Landroidx/camera/video/AudioSpec;->getSourceFormat()I

    move-result v4

    if-ne v3, v4, :cond_1

    iget v3, p0, Landroidx/camera/video/AutoValue_AudioSpec;->source:I

    .line 84
    invoke-virtual {v1}, Landroidx/camera/video/AudioSpec;->getSource()I

    move-result v4

    if-ne v3, v4, :cond_1

    iget-object v3, p0, Landroidx/camera/video/AutoValue_AudioSpec;->sampleRate:Landroid/util/Range;

    .line 85
    invoke-virtual {v1}, Landroidx/camera/video/AudioSpec;->getSampleRate()Landroid/util/Range;
    ...
    iget v3, p0, Landroidx/camera/video/AutoValue_AudioSpec;->channelCount:I

    .line 86
    invoke-virtual {v1}, Landroidx/camera/video/AudioSpec;->getChannelCount()I
    ...
    .line 88
    .end local v1    # "that":Landroidx/camera/video/AudioSpec;
    :cond_2
    return v2
.end method
...
.method public hashCode()I
    ...
    .line 95
    iget-object v2, p0, Landroidx/camera/video/AutoValue_AudioSpec;->bitrate:Landroid/util/Range;
