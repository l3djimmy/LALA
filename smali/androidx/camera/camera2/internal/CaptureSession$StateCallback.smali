...
.method public onConfigureFailed(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    const-string/jumbo v3, "onConfigureFailed() should not be possible in state: "
...
.method public onConfigured(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    iget-object v1, v1, Landroidx/camera/camera2/internal/CaptureSession;->mCameraEventCallbacks:Landroidx/camera/camera2/impl/CameraEventCallbacks;
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/impl/CameraEventCallbacks$ComboCameraEventCallback;->onEnableSession()Ljava/util/List;

    move-result-object v1

    .line 1041
    .local v1, "list":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureConfig;>;"
    ...
    invoke-virtual {v3, v1}, Landroidx/camera/camera2/internal/CaptureSession;->setupConfiguredSurface(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroidx/camera/camera2/internal/CaptureSession;->issueBurstCaptureRequest(Ljava/util/List;)I

    .line 1046
    .end local v1    # "list":Ljava/util/List;, "Ljava/util/List<Landroidx/camera/core/impl/CaptureConfig;>;"
    :cond_0
    const-string v1, "CaptureSession"
    ...
    iget-object v2, v2, Landroidx/camera/camera2/internal/CaptureSession;->mSessionConfig:Landroidx/camera/core/impl/SessionConfig;
    ...
    const-string/jumbo v3, "onConfigured() should not be possible in state: "
...
.method public onReady(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    const-string/jumbo v3, "onReady() should not be possible in state: "
...
.method public onSessionFinished(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    const-string/jumbo v2, "onSessionFinished()"
    ...
    const-string/jumbo v3, "onSessionFinished() should not be possible in state: "
