...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/camera/camera2/internal/compat/params/DynamicRangeConversions;->DR_TO_PROFILE_MAP:Ljava/util/Map;
    ...
    sget-object v2, Landroidx/camera/camera2/internal/compat/params/DynamicRangeConversions;->PROFILE_TO_DR_MAP:Ljava/util/Map;
    ...
    .line 81
    .local v1, "dolbyVision10BitProfilesOrdered":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    ...
    .line 82
    .local v7, "profile":Ljava/lang/Long;
    ...
    .line 83
    .end local v7    # "profile":Ljava/lang/Long;
    goto :goto_0
    ...
    .line 89
    .local v0, "dolbyVision8BitProfilesOrdered":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    ...
    .line 90
    .local v3, "profile":Ljava/lang/Long;
    sget-object v4, Landroidx/camera/camera2/internal/compat/params/DynamicRangeConversions;->PROFILE_TO_DR_MAP:Ljava/util/Map;
    ...
    .line 91
    .end local v3    # "profile":Ljava/lang/Long;
    goto :goto_1
    ...
    .line 93
    .end local v0    # "dolbyVision8BitProfilesOrdered":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    .end local v1    # "dolbyVision10BitProfilesOrdered":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    return-void
.end method
...
.method public static dynamicRangeToFirstSupportedProfile(Landroidx/camera/core/DynamicRange;Landroid/hardware/camera2/params/DynamicRangeProfiles;)Ljava/lang/Long;
    ...
    .line 120
    .local v0, "orderedProfiles":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Long;>;"
    if-eqz v0, :cond_1
    ...
    .line 122
    .local v1, "supportedList":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Long;>;"
    invoke-interface {v0}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .line 130
    .end local v1    # "supportedList":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Long;>;"
    :cond_1
    const/4 v1, 0x0
