...
.method static create(Ljava/lang/String;Ljava/lang/Class;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/UseCaseConfig;Landroid/util/Size;)Landroidx/camera/camera2/internal/Camera2CameraImpl$UseCaseInfo;
    .locals 6
    .param p0, "useCaseId"    # Ljava/lang/String;
    .param p2, "sessionConfig"    # Landroidx/camera/core/impl/SessionConfig;
    .param p4, "surfaceResolution"    # Landroid/util/Size;
    ...
    .line 1620
    .local p1, "useCaseType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    .end local p0    # "useCaseId":Ljava/lang/String;
    .end local p1    # "useCaseType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local p2    # "sessionConfig":Landroidx/camera/core/impl/SessionConfig;
    .end local p3    # "useCaseConfig":Landroidx/camera/core/impl/UseCaseConfig;, "Landroidx/camera/core/impl/UseCaseConfig<*>;"
    .end local p4    # "surfaceResolution":Landroid/util/Size;
    .local v1, "useCaseId":Ljava/lang/String;
    .local v2, "useCaseType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    .local v5, "surfaceResolution":Landroid/util/Size;
...
.method static from(Landroidx/camera/core/UseCase;)Landroidx/camera/camera2/internal/Camera2CameraImpl$UseCaseInfo;
    ...
    .line 1626
    invoke-static {v0, v1, v2, v3, v4}, Landroidx/camera/camera2/internal/Camera2CameraImpl$UseCaseInfo;->create(Ljava/lang/String;Ljava/lang/Class;Landroidx/camera/core/impl/SessionConfig;Landroidx/camera/core/impl/UseCaseConfig;Landroid/util/Size;)Landroidx/camera/camera2/internal/Camera2CameraImpl$UseCaseInfo;
