...
.method static synthetic lambda$preCapture$3(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/Boolean;
    .locals 1
    .param p0, "input"    # Landroid/hardware/camera2/TotalCaptureResult;
...
.method synthetic lambda$preCapture$2$androidx-camera-camera2-internal-Camera2CapturePipeline$TorchTask(Ljava/lang/Void;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance v3, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda3;

    invoke-direct {v3}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda3;-><init>()V
...
.method public preCapture(Landroid/hardware/camera2/TotalCaptureResult;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/Camera2CameraControlImpl;->isTorchOn()Z
    ...
    .line 571
    const-string/jumbo v0, "Torch already on, not turn on"
    ...
    .line 573
    :cond_0
    const-string/jumbo v0, "Turn on torch"
    ...
    invoke-direct {v0, p0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda0;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;)V
    ...
    new-instance v2, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda1;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;)V

    iget-object v3, p0, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask;->mExecutor:Ljava/util/concurrent/Executor;
    ...
    new-instance v2, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda2;

    invoke-direct {v2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda2;-><init>()V
