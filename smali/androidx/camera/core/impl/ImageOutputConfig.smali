...
.method static constructor <clinit>()V
    ...
    .line 61
    const-string/jumbo v1, "camerax.core.imageOutput.targetAspectRatio"
    ...
    .line 67
    const-string/jumbo v1, "camerax.core.imageOutput.targetRotation"
    ...
    .line 73
    const-string/jumbo v1, "camerax.core.imageOutput.appTargetRotation"
    ...
    .line 79
    const-string/jumbo v1, "camerax.core.imageOutput.mirrorMode"
    ...
    .line 85
    const-string/jumbo v1, "camerax.core.imageOutput.targetResolution"
    ...
    .line 90
    const-string/jumbo v1, "camerax.core.imageOutput.defaultResolution"
    ...
    .line 95
    const-string/jumbo v1, "camerax.core.imageOutput.maxResolution"
    ...
    .line 100
    const-string/jumbo v1, "camerax.core.imageOutput.supportedResolutions"
    ...
    .line 105
    const-class v0, Landroidx/camera/core/resolutionselector/ResolutionSelector;

    .line 106
    const-string/jumbo v1, "camerax.core.imageOutput.resolutionSelector"
    ...
    .line 112
    const-string/jumbo v1, "camerax.core.imageOutput.customOrderedResolutions"
...
.method public static validateConfig(Landroidx/camera/core/impl/ImageOutputConfig;)V
    .locals 5
    .param p0, "config"    # Landroidx/camera/core/impl/ImageOutputConfig;
    ...
    .line 357
    .local v0, "hasTargetAspectRatio":Z
    const/4 v1, 0x0
    ...
    .line 361
    .local v2, "hasTargetResolution":Z
    :goto_0
    if-eqz v0, :cond_2
    ...
    const-string v3, "Cannot use both setTargetResolution and setTargetAspectRatio on the same config."
    ...
    const-string v4, "Cannot use setTargetResolution or setTargetAspectRatio with setResolutionSelector on the same config."
...
.method public getCustomOrderedResolutions(Ljava/util/List;)Ljava/util/List;
    ...
    .line 329
    .local p1, "valueIfMissing":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    ...
    .line 330
    .local v0, "list":Ljava/util/List;, "Ljava/util/List<Landroid/util/Size;>;"
    if-eqz v0, :cond_0
...
.method public getResolutionSelector(Landroidx/camera/core/resolutionselector/ResolutionSelector;)Landroidx/camera/core/resolutionselector/ResolutionSelector;
    .locals 1
    .param p1, "valueIfMissing"    # Landroidx/camera/core/resolutionselector/ResolutionSelector;
