...
.method public build()Landroidx/camera/core/ImageCapture;
    ...
    .line 1910
    .local v1, "imageCaptureConfig":Landroidx/camera/core/impl/ImageCaptureConfig;
    ...
    .line 1917
    .local v3, "imageCapture":Landroidx/camera/core/ImageCapture;
    invoke-virtual {p0}, Landroidx/camera/core/ImageCapture$Builder;->getMutableConfig()Landroidx/camera/core/impl/MutableConfig;
    ...
    .line 1919
    .local v2, "targetResolution":Landroid/util/Size;
    if-eqz v2, :cond_1
    ...
    .line 1920
    invoke-virtual {v3, v4}, Landroidx/camera/core/ImageCapture;->setCropAspectRatio(Landroid/util/Rational;)V
    ...
    sget-object v5, Landroidx/camera/core/impl/ImageCaptureConfig;->OPTION_IO_EXECUTOR:Landroidx/camera/core/impl/Config$Option;
    ...
    .line 1924
    invoke-interface {v4, v5, v6}, Landroidx/camera/core/impl/MutableConfig;->retrieveOption(Landroidx/camera/core/impl/Config$Option;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Ljava/util/concurrent/Executor;

    const-string/jumbo v5, "The IO executor can\'t be null"
    ...
    sget-object v5, Landroidx/camera/core/impl/ImageCaptureConfig;->OPTION_FLASH_MODE:Landroidx/camera/core/impl/Config$Option;

    invoke-interface {v4, v5}, Landroidx/camera/core/impl/MutableConfig;->containsOption(Landroidx/camera/core/impl/Config$Option;)Z
    ...
    invoke-interface {v4, v5}, Landroidx/camera/core/impl/MutableConfig;->retrieveOption(Landroidx/camera/core/impl/Config$Option;)Ljava/lang/Object;
    ...
    .line 1930
    .local v4, "flashMode":Ljava/lang/Integer;
    if-eqz v4, :cond_2
    ...
    const-string/jumbo v7, "The flash mode is not allowed to set: "
    ...
    .line 1937
    .end local v4    # "flashMode":Ljava/lang/Integer;
    :cond_3
    :goto_1
    return-object v3
.end method
...
.method public setSoftwareJpegEncoderRequested(Z)Landroidx/camera/core/ImageCapture$Builder;
    .locals 3
    .param p1, "requestSoftwareJpeg"    # Z
